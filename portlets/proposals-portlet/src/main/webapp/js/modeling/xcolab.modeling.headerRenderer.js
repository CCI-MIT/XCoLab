...
(function() {
	...
	DefaultHeaderRenderer.prototype.renderEdit = function(container) {
		...
		container.append('<div class="model_name_description"><h2 class="model_name"></h2><p class="model_description"> <a href="https://www.climateinteractive.org/"></a></p></div><div class="act_left">' +
	...
	DefaultHeaderRenderer.prototype.renderView = function(container) {
		this.container = container;
		container.append("<div class='model_name_description'><h2 class='model_name'></h2><p class='model_description'><a href='https://www.climateinteractive.org/'></a></p></div><div class='act_left'><div class='acthead-l'>Actions</div></div>" +
