...
public class ProposalDetailsController {
    ...
    public String showProposalDetails(@RequestParam(value="planId") Long proposalId, 
            @RequestParam Long contestId, @RequestParam(required = false) Long phaseId, Model model) 
        ...
        model.addAttribute("proposal", new ProposalWrapper(proposal));
