...
public class ProposalVersionsJsonController {
    ...
    public void getProposalVersionIndex(ResourceRequest request, ResourceResponse response,
    ...
    public void getProposalVersions(ResourceRequest request, ResourceResponse response,
