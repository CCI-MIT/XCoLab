...
public class ContestMassActionMethods {
    ...
    private static void deleteContestPhases(Long contestId) throws Exception {
        Contest contest = ContestLocalServiceUtil.getContest(contestId);
    ...
    private static void deleteContestAndPhases(Long contestId) throws Exception {
        deleteContestPhases(contestId);
        ContestLocalServiceUtil.deleteContest(contestId);
    }

    public static void deleteContest(List<Long> contestList, Object deletePhasesObj, PortletRequest request) throws Exception {
