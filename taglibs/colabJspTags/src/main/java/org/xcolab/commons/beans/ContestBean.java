package org.xcolab.commons.beans;
...
public class ContestBean {
    ...
    private List<org.xcolab.wrapper.ContestPhaseWrapper> phases;
    private List<org.xcolab.wrapper.ContestPhaseWrapper> visiblePhases;
    private org.xcolab.wrapper.ContestPhaseWrapper activePhase;

    private List<ContestTeamRoleWrapper> contestTeamMembersByRole;

    private Contest contest;

    public ContestBean(Contest contest) {
    ...
    public org.xcolab.wrapper.ContestPhaseWrapper getLastPhase() throws PortalException, SystemException {
        org.xcolab.wrapper.ContestPhaseWrapper last = null;
        for (org.xcolab.wrapper.ContestPhaseWrapper ph : getPhases()) {
    ...
    public org.xcolab.wrapper.ContestPhaseWrapper getActivePhase() throws PortalException, SystemException {
        if (activePhase == null) {
            ContestPhase phase = ContestLocalServiceUtil.getActivePhase(contest);
            if (phase == null) return null;
            activePhase = new org.xcolab.wrapper.ContestPhaseWrapper(phase);
        }
        return activePhase;
    }
    ...
    public Long getVotingPhasePK() throws PortalException, SystemException {
        org.xcolab.wrapper.ContestPhaseWrapper lastVotingPhase = null;
        for (org.xcolab.wrapper.ContestPhaseWrapper ph : getPhases()) {
    ...
    public boolean isContestCompleted(org.xcolab.wrapper.ContestPhaseWrapper contestPhase) {
        ContestPhaseType type;
        ContestPhase activePhase;
        try {
            activePhase = ContestLocalServiceUtil.getActivePhase(this.contest);
            type = new org.xcolab.wrapper.ContestPhaseWrapper(activePhase).getContestPhaseTypeObject();
    ...
    public List<org.xcolab.wrapper.ContestPhaseWrapper> getPhases() throws SystemException, PortalException {
        if (phases == null) {
            phases = new ArrayList<org.xcolab.wrapper.ContestPhaseWrapper>();
            for (ContestPhase phase : ContestLocalServiceUtil.getAllPhases(contest)) {
                phases.add(new org.xcolab.wrapper.ContestPhaseWrapper(phase));
            }
        }
        return phases;
    }

    public List<org.xcolab.wrapper.ContestPhaseWrapper> getVisiblePhases() throws SystemException, PortalException {
        if (visiblePhases == null) {
            visiblePhases = new ArrayList<org.xcolab.wrapper.ContestPhaseWrapper>();
            for (ContestPhase phase : ContestLocalServiceUtil.getVisiblePhases(contest)) {
                visiblePhases.add(new org.xcolab.wrapper.ContestPhaseWrapper(phase));
            }
        }
