package org.xcolab.service.search.config;
...
public class MicrometerConfig implements Filter {
            ...
            FilterChain chain) throws IOException, ServletException
    {
        ...
        Metrics.counter("search-service","endpoint",req.getRequestURI(), "function", function, "method", req.getMethod(), "Arguments", args).increment();
