...
public class Proposal2PhaseController {
    ...
    public IProposal2Phase createProposal2Phase(@RequestBody IProposal2Phase proposal2Phase) {
    ...
    public boolean updateProposal2Phase(@RequestBody IProposal2Phase proposal2Phase) throws NotFoundException {
    ...
    public boolean deleteProposal2Phase(@RequestBody IProposal2Phase proposal2Phase) throws NotFoundException {
