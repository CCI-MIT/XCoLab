...
ALTER TABLE email__outgoing_email CHANGE emailSubject email_subject varchar(255) NOT NULL COMMENT '  ';
ALTER TABLE email__outgoing_email CHANGE emailBody email_body text NOT NULL COMMENT '      ';
ALTER TABLE email__outgoing_email CHANGE emailTo email_to varchar(255) NOT NULL;
ALTER TABLE email__outgoing_email CHANGE emailFrom email_from varchar(255) NOT NULL;
...
ALTER TABLE email__outgoing_email CHANGE emailBodyHash email_body_hash varchar(255) NOT NULL;
