...
public class ActivitiesController {
    ...
    public ActivityEntry getActivityEntry(@PathVariable long activityEntryId) throws NotFoundException {
    ...
    public ActivitySubscription getActivitySubscription(@PathVariable long activitySubscriptionId) throws NotFoundException {
    ...
    public boolean deleteActivitySubscription(@PathVariable long pk)
        ...
        return activitySubscriptionDao.delete(pk);
    }
    ...
    public boolean deleteIfSubscribed(@RequestParam(required = false) Long receiverId,
        ...
        return activitySubscriptionDao.deleteSubscription(receiverId, classNameId, classPK, type, extraInfo);
    }
