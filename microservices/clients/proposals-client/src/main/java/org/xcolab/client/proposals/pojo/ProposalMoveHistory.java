...
public class ProposalMoveHistory implements Serializable {
    ...
    private static final long serialVersionUID = 1005815874;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ProposalMoveHistory other = (ProposalMoveHistory) obj;
        if (id_ == null) {
            if (other.id_ != null)
                return false;
        }
