...
public class PointType implements Serializable {
    ...
    private static final long serialVersionUID = 1472144204;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((percentageofparent == null) ? 0 : percentageofparent.hashCode());
        result = prime * result + ((distributionstrategy == null) ? 0 : distributionstrategy.hashCode());
        result = prime * result + ((receiverlimitationstrategy == null) ? 0 : receiverlimitationstrategy.hashCode());
