...
public class PlanSectionDefinition implements Serializable {

    public static final TypeProvider<PlanSectionDefinition> TYPES =
            new TypeProvider<>(PlanSectionDefinition.class,
                    new ParameterizedTypeReference<List<PlanSectionDefinition>>() {
                    });

    private static final long serialVersionUID = 1825499346;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PlanSectionDefinition other = (PlanSectionDefinition) obj;
        if (id_ == null) {
            if (other.id_ != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PlanSectionDefinition (");

        sb.append(id_);
        sb.append(", ").append(type_);
        sb.append(", ").append(admintitle);
        sb.append(", ").append(title);
        sb.append(", ").append(defaulttext);
        sb.append(", ").append(helptext);
        sb.append(", ").append(characterlimit);
        sb.append(", ").append(focusareaid);
        sb.append(", ").append(tier);
        sb.append(", ").append(allowedcontesttypeids);
        sb.append(", ").append(allowedvalues);
        sb.append(", ").append(additionalids);
        sb.append(", ").append(locked);
        sb.append(", ").append(contestintegrationrelevance);
