...
public class ContestPhase implements Serializable {

    public static final TypeProvider<ContestPhase> TYPES =
            new TypeProvider<>(ContestPhase.class,
                    new ParameterizedTypeReference<List<ContestPhase>>() {
                    });

    private static final long serialVersionUID = -238278114;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((fellowscreeningactive == null) ? 0 : fellowscreeningactive.hashCode());
        result = prime * result + ((contestphaseautopromote == null) ? 0 : contestphaseautopromote.hashCode());
        result = prime * result + ((contestphasedescriptionoverride == null) ? 0 : contestphasedescriptionoverride.hashCode());
        result = prime * result + ((phaseactiveoverride == null) ? 0 : phaseactiveoverride.hashCode());
        result = prime * result + ((phaseinactiveoverride == null) ? 0 : phaseinactiveoverride.hashCode());
        ...
        result = prime * result + ((phasebufferenddated == null) ? 0 : phasebufferenddated.hashCode());
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ContestPhase (");

        sb.append(contestphasepk);
        sb.append(", ").append(contestpk);
        sb.append(", ").append(contestphasetype);
        sb.append(", ").append(contestscheduleid);
        sb.append(", ").append(fellowscreeningactive);
        sb.append(", ").append(contestphaseautopromote);
        sb.append(", ").append(contestphasedescriptionoverride);
        sb.append(", ").append(phaseactiveoverride);
        sb.append(", ").append(phaseinactiveoverride);
        sb.append(", ").append(phasestartdate);
        sb.append(", ").append(phaseenddate);
        sb.append(", ").append(phasebufferenddated);
