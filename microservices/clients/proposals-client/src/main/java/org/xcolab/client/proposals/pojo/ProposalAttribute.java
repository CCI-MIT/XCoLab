...
public class ProposalAttribute implements Serializable {

    private static final long serialVersionUID = -491990963;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ProposalAttribute other = (ProposalAttribute) obj;
        if (id_ == null) {
            if (other.id_ != null)
                return false;
        }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((versionwhencreated == null) ? 0 : versionwhencreated.hashCode());
