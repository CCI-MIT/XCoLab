...
public class PointsDistributionConfiguration implements Serializable {
    ...
    private static final long serialVersionUID = -1145420102;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PointsDistributionConfiguration other = (PointsDistributionConfiguration) obj;
        if (id_ == null) {
            if (other.id_ != null)
                return false;
        }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((targetsubproposalid == null) ? 0 : targetsubproposalid.hashCode());
        result = prime * result + ((targetplansectiondefinitionid == null) ? 0 : targetplansectiondefinitionid.hashCode());
