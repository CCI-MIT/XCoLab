...
public class ProposalVersion implements Serializable {

    private static final long serialVersionUID = -606354337;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ProposalVersion other = (ProposalVersion) obj;
        if (proposalid == null) {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((updateadditionalid == null) ? 0 : updateadditionalid.hashCode());
        return result;
    }
