...
public class ProposalSupporter implements Serializable {
    ...
    private static final long serialVersionUID = -224876945;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ProposalSupporter other = (ProposalSupporter) obj;
        if (proposalid == null) {
