...
public class ContestPhase implements Serializable {
    ...
    public String getContestPhaseLinkUrl() {
        try {
            ...
            link += ContestClient.getContestType(contest.getContestTypeId()).getFriendlyUrlStringContests();
            link += "/%d/%s/phase/%d";
            return String.format(link, contest.getContestYear(), contest.getContestUrlName(), this.getContestPhasePK());
