...
/**
 * Provides the local service utility for ContestPhaseColumn. This utility wraps
 * {@link com.ext.portlet.service.impl.ContestPhaseColumnLocalServiceImpl} and is the
...
public class ContestPhaseColumnLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ContestPhaseColumn deleteContestPhaseColumn(
        long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteContestPhaseColumn(id);
    }
    ...
    */
    public static com.ext.portlet.model.ContestPhaseColumn deleteContestPhaseColumn(
        com.ext.portlet.model.ContestPhaseColumn contestPhaseColumn)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteContestPhaseColumn(contestPhaseColumn);
    }
    ...
    */
    ...
    public static ContestPhaseColumnLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof ContestPhaseColumnLocalService) {
                _service = (ContestPhaseColumnLocalService) invokableLocalService;
            } else {
                _service = new ContestPhaseColumnLocalServiceClp(invokableLocalService);
            }
