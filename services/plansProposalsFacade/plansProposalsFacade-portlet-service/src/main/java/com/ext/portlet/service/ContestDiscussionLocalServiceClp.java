 ...
 * @generated
 */
public class ContestDiscussionLocalServiceClp
    ...
    public com.ext.portlet.model.ContestDiscussion addContestDiscussion(
        ...
        return (com.ext.portlet.model.ContestDiscussion) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.model.ContestDiscussion createContestDiscussion(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { DiscussionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.ContestDiscussion deleteContestDiscussion(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { DiscussionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.ContestDiscussion fetchContestDiscussion(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { DiscussionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.ContestDiscussion getContestDiscussion(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { DiscussionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.ext.portlet.model.ContestDiscussion> getContestDiscussions(
        ...
        return (java.util.List<com.ext.portlet.model.ContestDiscussion>) ClpSerializer.translateOutput(returnObj);
    }
