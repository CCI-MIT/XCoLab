...
public class PlanColumnSettingsLocalServiceClp
    ...
    public PlanColumnSettingsLocalServiceClp(
        ...
        _methodName1 = "createPlanColumnSettings";

        _methodParameterTypes1 = new String[] { "long" };

        _methodName2 = "deletePlanColumnSettings";

        _methodParameterTypes2 = new String[] { "long" };

        _methodName3 = "deletePlanColumnSettings";
        ...
        _methodName10 = "fetchPlanColumnSettings";

        _methodParameterTypes10 = new String[] { "long" };

        _methodName11 = "getPlanColumnSettings";
        ...
        _methodName13 = "getPlanColumnSettingses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getPlanColumnSettingsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updatePlanColumnSettings";
        ...
        _methodName19 = "findByPlanUserSettingsIdColumnName";
    ...
    public com.ext.portlet.model.PlanColumnSettings createPlanColumnSettings(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { planColumnSettingsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
