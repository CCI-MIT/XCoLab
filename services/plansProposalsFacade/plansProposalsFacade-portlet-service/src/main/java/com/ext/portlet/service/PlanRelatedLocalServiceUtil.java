...
/**
 * Provides the local service utility for PlanRelated. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanRelatedLocalServiceImpl} and is the
...
public class PlanRelatedLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanRelated deletePlanRelated(
        com.ext.portlet.service.persistence.PlanRelatedPK planRelatedPK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanRelated(planRelatedPK);
    }
    ...
    */
    public static com.ext.portlet.model.PlanRelated deletePlanRelated(
        com.ext.portlet.model.PlanRelated planRelated)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanRelated(planRelated);
    }
    ...
    */
    ...
    public static PlanRelatedLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof PlanRelatedLocalService) {
                _service = (PlanRelatedLocalService) invokableLocalService;
            } else {
                _service = new PlanRelatedLocalServiceClp(invokableLocalService);
            }
