...
/**
 * Provides the remote service utility for BalloonStatsEntry. This utility wraps
 * {@link com.ext.portlet.service.impl.BalloonStatsEntryServiceImpl} and is the
    ...
    */
    ...
    public static BalloonStatsEntryService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof BalloonStatsEntryService) {
                _service = (BalloonStatsEntryService) invokableService;
            } else {
                _service = new BalloonStatsEntryServiceClp(invokableService);
            }
