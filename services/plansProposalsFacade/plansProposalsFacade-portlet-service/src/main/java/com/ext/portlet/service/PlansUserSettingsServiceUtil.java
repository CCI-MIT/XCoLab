...
/**
 * Provides the remote service utility for PlansUserSettings. This utility wraps
 * {@link com.ext.portlet.service.impl.PlansUserSettingsServiceImpl} and is the
    ...
    */
    ...
    public static PlansUserSettingsService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlansUserSettingsService) {
                _service = (PlansUserSettingsService) invokableService;
            } else {
                _service = new PlansUserSettingsServiceClp(invokableService);
            }
