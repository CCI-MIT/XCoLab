...
/**
 * The utility for the discussion message flag local service. This utility wraps {@link com.ext.portlet.discussions.service.impl.DiscussionMessageFlagLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class DiscussionMessageFlagLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.discussions.service.impl.DiscussionMessageFlagLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteDiscussionMessageFlag(long pk)
    ...
    */
    ...
    public static com.ext.portlet.discussions.model.DiscussionMessageFlag fetchDiscussionMessageFlag(
    ...
    */
    ...
    public static DiscussionMessageFlagLocalService getService() {
        if (_service == null) {
            ...
            _service = new DiscussionMessageFlagLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(DiscussionMessageFlagLocalServiceUtil.class,
                "_service");
            MethodCache.remove(DiscussionMessageFlagLocalService.class);
        }
