...
/**
 * Provides the local service interface for ModelOutputChartOrder. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ModelOutputChartOrderLocalServiceUtil
...
public interface ModelOutputChartOrderLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ModelOutputChartOrderLocalServiceUtil} to access the model output chart order local service. Add custom service methods to {@link com.ext.portlet.service.impl.ModelOutputChartOrderLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
