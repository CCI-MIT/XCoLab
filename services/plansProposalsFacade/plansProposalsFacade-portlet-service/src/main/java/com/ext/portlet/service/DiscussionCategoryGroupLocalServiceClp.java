...
public class DiscussionCategoryGroupLocalServiceClp
    ...
    public DiscussionCategoryGroupLocalServiceClp(
        ...
        _methodName19 = "createDiscussionCategoryGroup";

        _methodParameterTypes19 = new String[] { "java.lang.String" };

        _methodName20 = "getCategoryById";

        _methodParameterTypes20 = new String[] { "long" };

        _methodName21 = "getThreadById";
        ...
        _methodName25 = "getCommentThread";

        _methodParameterTypes25 = new String[] {
                "com.ext.portlet.model.DiscussionCategoryGroup"
            };

        _methodName26 = "addComment";
        ...
        _methodName27 = "getCommentsCount";

        _methodParameterTypes27 = new String[] { "long" };

        _methodName28 = "getCommentsCount";

        _methodParameterTypes28 = new String[] {
                "com.ext.portlet.model.DiscussionCategoryGroup"
            };

        _methodName29 = "copyEverything";
    ...
    public java.util.List<com.ext.portlet.model.DiscussionCategory> getCategories(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    ...
                    new Object[] { ClpSerializer.translateInput(dcg) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public int getCommentsCount(long discussionId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName27,
                    _methodParameterTypes27, new Object[] { discussionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
