...
/**
 * Provides the remote service utility for ModelGlobalPreference. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelGlobalPreferenceServiceImpl} and is the
    ...
    */
    ...
    public static ModelGlobalPreferenceService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ModelGlobalPreferenceService) {
                _service = (ModelGlobalPreferenceService) invokableService;
            } else {
                _service = new ModelGlobalPreferenceServiceClp(invokableService);
            }
