...
/**
 * Provides the remote service utility for MessagingIgnoredRecipients. This utility wraps
 * {@link com.ext.portlet.service.impl.MessagingIgnoredRecipientsServiceImpl} and is the
    ...
    */
    ...
    public static MessagingIgnoredRecipientsService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof MessagingIgnoredRecipientsService) {
                _service = (MessagingIgnoredRecipientsService) invokableService;
            } else {
                _service = new MessagingIgnoredRecipientsServiceClp(invokableService);
            }
