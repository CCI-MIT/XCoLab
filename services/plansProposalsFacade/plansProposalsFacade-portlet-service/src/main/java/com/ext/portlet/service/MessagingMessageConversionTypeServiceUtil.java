...
/**
 * Provides the remote service utility for MessagingMessageConversionType. This utility wraps
 * {@link com.ext.portlet.service.impl.MessagingMessageConversionTypeServiceImpl} and is the
    ...
    */
    ...
    public static MessagingMessageConversionTypeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof MessagingMessageConversionTypeService) {
                _service = (MessagingMessageConversionTypeService) invokableService;
            } else {
                _service = new MessagingMessageConversionTypeServiceClp(invokableService);
            }
