 ...
 * @generated
 */
public class ImpactDefaultSeriesDataLocalServiceClp
    ...
    public com.ext.portlet.model.ImpactDefaultSeriesData addImpactDefaultSeriesData(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(impactDefaultSeriesData)
                    });
        } catch (Throwable t) {
    ...
    public com.ext.portlet.model.ImpactDefaultSeriesData createImpactDefaultSeriesData(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(impactDefaultSeriesDataPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
