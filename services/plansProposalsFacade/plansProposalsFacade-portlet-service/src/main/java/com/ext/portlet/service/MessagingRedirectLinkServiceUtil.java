...
/**
 * Provides the remote service utility for MessagingRedirectLink. This utility wraps
 * {@link com.ext.portlet.service.impl.MessagingRedirectLinkServiceImpl} and is the
    ...
    */
    ...
    public static MessagingRedirectLinkService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof MessagingRedirectLinkService) {
                _service = (MessagingRedirectLinkService) invokableService;
            } else {
                _service = new MessagingRedirectLinkServiceClp(invokableService);
            }
