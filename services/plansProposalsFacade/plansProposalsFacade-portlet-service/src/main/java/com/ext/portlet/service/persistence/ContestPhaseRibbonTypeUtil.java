...
public class ContestPhaseRibbonTypeUtil {
    ...
    public static ContestPhaseRibbonType update(
        ...
        throws SystemException {
        return getPersistence().update(contestPhaseRibbonType);
    }
    ...
    public static ContestPhaseRibbonType update(
        ...
        return getPersistence().update(contestPhaseRibbonType, serviceContext);
    }
    ...
    */
    ...
    public static com.ext.portlet.model.ContestPhaseRibbonType updateImpl(
        ...
        return getPersistence().updateImpl(contestPhaseRibbonType);
    }
