...
public class ProposalContestPhaseAttributeTypeLocalServiceClp
    ...
    public ProposalContestPhaseAttributeTypeLocalServiceClp(
        ...
        _methodName1 = "createProposalContestPhaseAttributeType";

        _methodParameterTypes1 = new String[] { "java.lang.String" };

        _methodName2 = "deleteProposalContestPhaseAttributeType";

        _methodParameterTypes2 = new String[] { "java.lang.String" };

        _methodName3 = "deleteProposalContestPhaseAttributeType";
        ...
        _methodName10 = "fetchProposalContestPhaseAttributeType";

        _methodParameterTypes10 = new String[] { "java.lang.String" };

        _methodName11 = "getProposalContestPhaseAttributeType";
        ...
        _methodName13 = "getProposalContestPhaseAttributeTypes";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getProposalContestPhaseAttributeTypesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateProposalContestPhaseAttributeType";
