...
/**
 * Provides the local service utility for ModelInputGroup. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelInputGroupLocalServiceImpl} and is the
...
public class ModelInputGroupLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ModelInputGroup deleteModelInputGroup(
        long modelInputGroupPK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteModelInputGroup(modelInputGroupPK);
    }
    ...
    */
    public static com.ext.portlet.model.ModelInputGroup deleteModelInputGroup(
        com.ext.portlet.model.ModelInputGroup modelInputGroup)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteModelInputGroup(modelInputGroup);
    }
    ...
    */
    ...
    public static ModelInputGroupLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof ModelInputGroupLocalService) {
                _service = (ModelInputGroupLocalService) invokableLocalService;
            } else {
                _service = new ModelInputGroupLocalServiceClp(invokableLocalService);
            }
