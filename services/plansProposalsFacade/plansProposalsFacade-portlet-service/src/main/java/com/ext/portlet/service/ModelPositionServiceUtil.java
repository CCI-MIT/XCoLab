...
/**
 * Provides the remote service utility for ModelPosition. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelPositionServiceImpl} and is the
    ...
    */
    ...
    public static ModelPositionService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ModelPositionService) {
                _service = (ModelPositionService) invokableService;
            } else {
                _service = new ModelPositionServiceClp(invokableService);
            }
