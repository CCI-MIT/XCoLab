...
/**
 * Provides the local service utility for PlanItem. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanItemLocalServiceImpl} and is the
...
public class PlanItemLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanItem deletePlanItem(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanItem(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanItem deletePlanItem(
        com.ext.portlet.model.PlanItem planItem)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanItem(planItem);
    }
    ...
    */
    ...
    public static PlanItemLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof PlanItemLocalService) {
                _service = (PlanItemLocalService) invokableLocalService;
            } else {
                _service = new PlanItemLocalServiceClp(invokableLocalService);
            }
