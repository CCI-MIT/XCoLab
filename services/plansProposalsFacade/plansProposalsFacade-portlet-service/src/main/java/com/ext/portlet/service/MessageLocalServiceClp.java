...
public class MessageLocalServiceClp implements MessageLocalService {
    ...
    public MessageLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _addMessageMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                "addMessage", com.ext.portlet.model.Message.class);
        ...
        _deleteMessageMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
                "deleteMessage", com.ext.portlet.model.Message.class);
        ...
        _updateMessageMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateMessage", com.ext.portlet.model.Message.class);
    ...
    public com.ext.portlet.model.Message addMessage(
        ...
        return (com.ext.portlet.model.Message) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.ext.portlet.model.Message> getMessages(
        ...
        return (java.util.List<com.ext.portlet.model.Message>) ClpSerializer.translateOutput(returnObj);
    }
