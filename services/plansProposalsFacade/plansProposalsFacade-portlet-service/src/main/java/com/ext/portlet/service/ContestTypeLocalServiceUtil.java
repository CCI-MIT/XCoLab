...
/**
 * Provides the local service utility for ContestType. This utility wraps
 * {@link com.ext.portlet.service.impl.ContestTypeLocalServiceImpl} and is the
 ...
 * @see com.ext.portlet.service.impl.ContestTypeLocalServiceImpl
 * @generated
 */
public class ContestTypeLocalServiceUtil {
    private static ContestTypeLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.service.impl.ContestTypeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.ext.portlet.model.ContestType addContestType(
        com.ext.portlet.model.ContestType contestType)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addContestType(contestType);
    }
    ...
    */
    public static com.ext.portlet.model.ContestType createContestType(long id) {
        return getService().createContestType(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ContestType deleteContestType(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteContestType(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ContestType deleteContestType(
        com.ext.portlet.model.ContestType contestType)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteContestType(contestType);
    }
    ...
    */
    ...
    public static com.ext.portlet.model.ContestType fetchContestType(long id)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchContestType(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ContestType getContestType(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.ext.portlet.model.ContestType> getContestTypes(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getContestTypes(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getContestTypesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getContestTypesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ContestType updateContestType(
        com.ext.portlet.model.ContestType contestType)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateContestType(contestType);
    }
    ...
    */
    ...
    public static java.lang.String getProposalNamesOrString(
        java.util.List<java.lang.Long> contestTypeIds) {
        return getService().getProposalNamesOrString(contestTypeIds);
    }

    public static java.lang.String getProposalNamesAndString(
        java.util.List<java.lang.Long> contestTypeIds) {
        return getService().getProposalNamesAndString(contestTypeIds);
    }
    ...
    public static ContestTypeLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ContestTypeLocalService.class.getName());

            if (invokableLocalService instanceof ContestTypeLocalService) {
                _service = (ContestTypeLocalService) invokableLocalService;
            } else {
                _service = new ContestTypeLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ContestTypeLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ContestTypeLocalService service) {
    }
}
