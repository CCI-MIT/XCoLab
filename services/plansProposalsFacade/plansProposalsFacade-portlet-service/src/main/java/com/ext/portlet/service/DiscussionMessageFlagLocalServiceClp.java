...
public class DiscussionMessageFlagLocalServiceClp
    ...
    public DiscussionMessageFlagLocalServiceClp(
        ...
        _methodName1 = "createDiscussionMessageFlag";

        _methodParameterTypes1 = new String[] { "long" };

        _methodName2 = "deleteDiscussionMessageFlag";

        _methodParameterTypes2 = new String[] { "long" };

        _methodName3 = "deleteDiscussionMessageFlag";
        ...
        _methodName10 = "fetchDiscussionMessageFlag";

        _methodParameterTypes10 = new String[] { "long" };

        _methodName11 = "getDiscussionMessageFlag";
        ...
        _methodName13 = "getDiscussionMessageFlags";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getDiscussionMessageFlagsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateDiscussionMessageFlag";
        ...
        _methodName19 = "findMessageFlags";

        _methodParameterTypes19 = new String[] { "java.lang.Long" };

        _methodName20 = "createFlag";
