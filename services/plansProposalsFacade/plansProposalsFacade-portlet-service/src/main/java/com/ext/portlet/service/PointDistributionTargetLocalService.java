...
/**
 * Provides the local service interface for PointDistributionTarget. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PointDistributionTargetLocalServiceUtil
...
public interface PointDistributionTargetLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PointDistributionTargetLocalServiceUtil} to access the point distribution target local service. Add custom service methods to {@link com.ext.portlet.service.impl.PointDistributionTargetLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
