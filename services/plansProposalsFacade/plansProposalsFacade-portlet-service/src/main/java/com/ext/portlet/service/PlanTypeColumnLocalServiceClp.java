...
public class PlanTypeColumnLocalServiceClp implements PlanTypeColumnLocalService {
    ...
    public PlanTypeColumnLocalServiceClp(
    ...
    public com.ext.portlet.model.PlanTypeColumn addPlanTypeColumn(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(planTypeColumn) });
        } catch (Throwable t) {
        ...
        return (com.ext.portlet.model.PlanTypeColumn) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.model.PlanTypeColumn createPlanTypeColumn(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { planTypeColumnId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.PlanTypeColumn deletePlanTypeColumn(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { planTypeColumnId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.PlanTypeColumn fetchPlanTypeColumn(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { planTypeColumnId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.PlanTypeColumn getPlanTypeColumn(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { planTypeColumnId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
