...
/**
 * The utility for the discussion category local service. This utility wraps {@link com.ext.portlet.service.impl.DiscussionCategoryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class DiscussionCategoryLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteDiscussionCategory(long pk)
