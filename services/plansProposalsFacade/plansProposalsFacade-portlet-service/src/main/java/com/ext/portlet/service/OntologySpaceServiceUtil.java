...
/**
 * Provides the remote service utility for OntologySpace. This utility wraps
 * {@link com.ext.portlet.service.impl.OntologySpaceServiceImpl} and is the
    ...
    */
    ...
    public static OntologySpaceService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof OntologySpaceService) {
                _service = (OntologySpaceService) invokableService;
            } else {
                _service = new OntologySpaceServiceClp(invokableService);
            }
