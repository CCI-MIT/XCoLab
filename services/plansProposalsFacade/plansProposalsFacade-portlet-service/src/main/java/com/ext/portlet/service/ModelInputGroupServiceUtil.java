...
/**
 * Provides the remote service utility for ModelInputGroup. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelInputGroupServiceImpl} and is the
    ...
    */
    ...
    public static ModelInputGroupService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ModelInputGroupService) {
                _service = (ModelInputGroupService) invokableService;
            } else {
                _service = new ModelInputGroupServiceClp(invokableService);
            }
