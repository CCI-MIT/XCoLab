...
/**
 * Provides the remote service utility for Proposal2Phase. This utility wraps
 * {@link com.ext.portlet.service.impl.Proposal2PhaseServiceImpl} and is the
    ...
    */
    ...
    public static Proposal2PhaseService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof Proposal2PhaseService) {
                _service = (Proposal2PhaseService) invokableService;
            } else {
                _service = new Proposal2PhaseServiceClp(invokableService);
            }
