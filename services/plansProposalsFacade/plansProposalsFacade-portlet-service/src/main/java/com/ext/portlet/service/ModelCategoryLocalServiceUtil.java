...
/**
 * The utility for the model category local service. This utility wraps {@link com.ext.portlet.service.impl.ModelCategoryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
