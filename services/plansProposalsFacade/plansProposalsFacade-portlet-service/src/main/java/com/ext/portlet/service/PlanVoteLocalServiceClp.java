...
public class PlanVoteLocalServiceClp implements PlanVoteLocalService {
    ...
    public PlanVoteLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.ext.portlet.model.PlanVote addPlanVote(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(planVote) });
        } catch (Throwable t) {
    ...
    public com.ext.portlet.model.PlanVote createPlanVote(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(planVotePK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
