...
/**
 * The utility for the message recipient status local service. This utility wraps {@link com.ext.portlet.messaging.service.impl.MessageRecipientStatusLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class MessageRecipientStatusLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.messaging.service.impl.MessageRecipientStatusLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    ...
    public static com.ext.portlet.messaging.model.MessageRecipientStatus fetchMessageRecipientStatus(
        long messageRecipientId)
        throws com.liferay.portal.kernel.exception.SystemException {
