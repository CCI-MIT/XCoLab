...
/**
 * Provides the remote service utility for OntologyTermEntity. This utility wraps
 * {@link com.ext.portlet.service.impl.OntologyTermEntityServiceImpl} and is the
    ...
    */
    ...
    public static OntologyTermEntityService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof OntologyTermEntityService) {
                _service = (OntologyTermEntityService) invokableService;
            } else {
                _service = new OntologyTermEntityServiceClp(invokableService);
            }
