...
/**
 * Provides the remote service utility for PlanTypeAttribute. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanTypeAttributeServiceImpl} and is the
    ...
    */
    ...
    public static PlanTypeAttributeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanTypeAttributeService) {
                _service = (PlanTypeAttributeService) invokableService;
            } else {
                _service = new PlanTypeAttributeServiceClp(invokableService);
            }
