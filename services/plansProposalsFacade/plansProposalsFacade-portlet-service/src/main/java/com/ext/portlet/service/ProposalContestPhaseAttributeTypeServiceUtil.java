...
/**
 * Provides the remote service utility for ProposalContestPhaseAttributeType. This utility wraps
 * {@link com.ext.portlet.service.impl.ProposalContestPhaseAttributeTypeServiceImpl} and is the
    ...
    */
    ...
    public static ProposalContestPhaseAttributeTypeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ProposalContestPhaseAttributeTypeService) {
                _service = (ProposalContestPhaseAttributeTypeService) invokableService;
            } else {
                _service = new ProposalContestPhaseAttributeTypeServiceClp(invokableService);
            }
