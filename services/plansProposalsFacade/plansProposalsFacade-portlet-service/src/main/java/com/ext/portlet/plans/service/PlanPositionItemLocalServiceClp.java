...
public class PlanPositionItemLocalServiceClp
    ...
    public PlanPositionItemLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _addPlanPositionItemMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                "addPlanPositionItem",
                com.ext.portlet.plans.model.PlanPositionItem.class);

        _createPlanPositionItemMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
                "createPlanPositionItem",
                com.ext.portlet.plans.service.persistence.PlanPositionItemPK.class);
    ...
    public com.ext.portlet.plans.model.PlanPositionItem addPlanPositionItem(
        ...
        return (com.ext.portlet.plans.model.PlanPositionItem) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.plans.model.PlanPositionItem fetchPlanPositionItem(
        com.ext.portlet.plans.service.persistence.PlanPositionItemPK planPositionItemPK)
        throws com.liferay.portal.kernel.exception.SystemException {
        Object returnObj = null;
    ...
    public java.util.List<com.ext.portlet.plans.model.PlanPositionItem> getPlanPositionItems(
        ...
        return (java.util.List<com.ext.portlet.plans.model.PlanPositionItem>) ClpSerializer.translateOutput(returnObj);
    }
