...
/**
 * Provides the remote service utility for PlanTemplateSection. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanTemplateSectionServiceImpl} and is the
    ...
    */
    ...
    public static PlanTemplateSectionService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanTemplateSectionService) {
                _service = (PlanTemplateSectionService) invokableService;
            } else {
                _service = new PlanTemplateSectionServiceClp(invokableService);
            }
