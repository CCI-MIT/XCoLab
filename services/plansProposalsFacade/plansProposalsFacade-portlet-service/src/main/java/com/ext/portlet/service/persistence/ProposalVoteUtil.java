...
public class ProposalVoteUtil {
    ...
    */
    public static com.ext.portlet.model.ProposalVote findByProposalIdUserId(
        ...
        throws com.ext.portlet.NoSuchProposalVoteException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().findByProposalIdUserId(proposalId, userId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ProposalVote fetchByProposalIdUserId(
        long proposalId, long userId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().fetchByProposalIdUserId(proposalId, userId);
    }
    ...
    */
    public static com.ext.portlet.model.ProposalVote fetchByProposalIdUserId(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .fetchByProposalIdUserId(proposalId, userId,
            retrieveFromCache);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ProposalVote removeByProposalIdUserId(
        long proposalId, long userId)
        throws com.ext.portlet.NoSuchProposalVoteException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().removeByProposalIdUserId(proposalId, userId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int countByProposalIdUserId(long proposalId, long userId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().countByProposalIdUserId(proposalId, userId);
    }
