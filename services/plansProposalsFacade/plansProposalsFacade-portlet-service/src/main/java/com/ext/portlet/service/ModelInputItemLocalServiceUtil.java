...
/**
 * Provides the local service utility for ModelInputItem. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelInputItemLocalServiceImpl} and is the
...
public class ModelInputItemLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ModelInputItem deleteModelInputItem(
        long modelInputItemPK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteModelInputItem(modelInputItemPK);
    }
    ...
    */
    public static com.ext.portlet.model.ModelInputItem deleteModelInputItem(
        com.ext.portlet.model.ModelInputItem modelInputItem)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteModelInputItem(modelInputItem);
    }
    ...
    */
    ...
    public static ModelInputItemLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof ModelInputItemLocalService) {
                _service = (ModelInputItemLocalService) invokableLocalService;
            } else {
                _service = new ModelInputItemLocalServiceClp(invokableLocalService);
            }
