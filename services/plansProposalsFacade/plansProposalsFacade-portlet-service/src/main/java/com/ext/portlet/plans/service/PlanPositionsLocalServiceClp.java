...
public class PlanPositionsLocalServiceClp implements PlanPositionsLocalService {
    ...
    public PlanPositionsLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _fetchPlanPositionsMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
                "fetchPlanPositions", java.lang.Long.class);

        _getPlanPositionsMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
                "getPlanPositions", java.lang.Long.class);
        ...
        _updatePlanPositionsMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
                "updatePlanPositions",
                com.ext.portlet.plans.model.PlanPositions.class, boolean.class);
    ...
    public com.ext.portlet.plans.model.PlanPositions addPlanPositions(
        ...
        return (com.ext.portlet.plans.model.PlanPositions) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.ext.portlet.plans.model.PlanPositions> getPlanPositionses(
        ...
        return (java.util.List<com.ext.portlet.plans.model.PlanPositions>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.plans.model.PlanPositions getCurrentForPlan(
        ...
        try {
            ...
            if (t instanceof com.ext.portlet.plans.NoSuchPlanPositionsException) {
                throw (com.ext.portlet.plans.NoSuchPlanPositionsException) t;
            }
