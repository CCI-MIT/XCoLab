...
/**
 * Provides the local service interface for PlanTypeColumn. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PlanTypeColumnLocalServiceUtil
...
public interface PlanTypeColumnLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PlanTypeColumnLocalServiceUtil} to access the plan type column local service. Add custom service methods to {@link com.ext.portlet.service.impl.PlanTypeColumnLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
