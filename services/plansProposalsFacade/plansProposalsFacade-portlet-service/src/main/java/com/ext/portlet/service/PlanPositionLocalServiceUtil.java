...
/**
 * The utility for the plan position local service. This utility wraps {@link com.ext.portlet.service.impl.PlanPositionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
