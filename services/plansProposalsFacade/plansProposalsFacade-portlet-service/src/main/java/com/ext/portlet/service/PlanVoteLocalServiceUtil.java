...
/**
 * Provides the local service utility for PlanVote. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanVoteLocalServiceImpl} and is the
...
public class PlanVoteLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanVote deletePlanVote(
        com.ext.portlet.service.persistence.PlanVotePK planVotePK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanVote(planVotePK);
    }
    ...
    */
    public static com.ext.portlet.model.PlanVote deletePlanVote(
        com.ext.portlet.model.PlanVote planVote)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanVote(planVote);
    }
    ...
    */
    ...
    public static PlanVoteLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof PlanVoteLocalService) {
                _service = (PlanVoteLocalService) invokableLocalService;
            } else {
                _service = new PlanVoteLocalServiceClp(invokableLocalService);
            }
