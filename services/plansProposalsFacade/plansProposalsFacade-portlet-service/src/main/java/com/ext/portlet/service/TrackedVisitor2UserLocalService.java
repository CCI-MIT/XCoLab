...
/**
 * Provides the local service interface for TrackedVisitor2User. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TrackedVisitor2UserLocalServiceUtil
...
public interface TrackedVisitor2UserLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TrackedVisitor2UserLocalServiceUtil} to access the tracked visitor2 user local service. Add custom service methods to {@link com.ext.portlet.service.impl.TrackedVisitor2UserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
