...
/**
 * The utility for the plan template section local service. This utility wraps {@link com.ext.portlet.plans.service.impl.PlanTemplateSectionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class PlanTemplateSectionLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.plans.service.impl.PlanTemplateSectionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    ...
    public static com.ext.portlet.plans.model.PlanTemplateSection fetchPlanTemplateSection(
        com.ext.portlet.plans.service.persistence.PlanTemplateSectionPK planTemplateSectionPK)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static PlanTemplateSectionLocalService getService() {
        if (_service == null) {
            ...
            _service = new PlanTemplateSectionLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(PlanTemplateSectionLocalServiceUtil.class,
                "_service");
            MethodCache.remove(PlanTemplateSectionLocalService.class);
        }
