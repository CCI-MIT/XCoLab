...
public class PlanTypeColumnLocalServiceClp implements PlanTypeColumnLocalService {
    private ClassLoaderProxy _classLoaderProxy;
    private MethodKey _addPlanTypeColumnMethodKey0;
    private MethodKey _createPlanTypeColumnMethodKey1;
    private MethodKey _deletePlanTypeColumnMethodKey2;
    private MethodKey _deletePlanTypeColumnMethodKey3;
    private MethodKey _dynamicQueryMethodKey4;
    private MethodKey _dynamicQueryMethodKey5;
    private MethodKey _dynamicQueryMethodKey6;
    private MethodKey _dynamicQueryCountMethodKey7;
    private MethodKey _fetchPlanTypeColumnMethodKey8;
    private MethodKey _getPlanTypeColumnMethodKey9;
    private MethodKey _getPersistedModelMethodKey10;
    private MethodKey _getPlanTypeColumnsMethodKey11;
    private MethodKey _getPlanTypeColumnsCountMethodKey12;
    private MethodKey _updatePlanTypeColumnMethodKey13;
    private MethodKey _updatePlanTypeColumnMethodKey14;
    private MethodKey _getBeanIdentifierMethodKey15;
    private MethodKey _setBeanIdentifierMethodKey16;

    public PlanTypeColumnLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        _classLoaderProxy = classLoaderProxy;

        _addPlanTypeColumnMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                "addPlanTypeColumn",
        ...
        _getPlanTypeColumnsMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
                "getPlanTypeColumns", int.class, int.class);

        _getPlanTypeColumnsCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
                "getPlanTypeColumnsCount");

        _updatePlanTypeColumnMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
                "updatePlanTypeColumn",
                com.ext.portlet.plans.model.PlanTypeColumn.class);

        _updatePlanTypeColumnMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
                "updatePlanTypeColumn",
                com.ext.portlet.plans.model.PlanTypeColumn.class, boolean.class);
    ...
    public com.ext.portlet.plans.model.PlanTypeColumn addPlanTypeColumn(
        ...
        MethodHandler methodHandler = new MethodHandler(_addPlanTypeColumnMethodKey0,
                ClpSerializer.translateInput(planTypeColumn));
    ...
    public void deletePlanTypeColumn(
        com.ext.portlet.plans.model.PlanTypeColumn planTypeColumn)
        throws com.liferay.portal.kernel.exception.SystemException {
        MethodHandler methodHandler = new MethodHandler(_deletePlanTypeColumnMethodKey3,
                ClpSerializer.translateInput(planTypeColumn));
    ...
    public java.util.List<com.ext.portlet.plans.model.PlanTypeColumn> getPlanTypeColumns(
        ...
        MethodHandler methodHandler = new MethodHandler(_getPlanTypeColumnsMethodKey11,
                start, end);
    ...
    public int getPlanTypeColumnsCount()
        ...
        MethodHandler methodHandler = new MethodHandler(_getPlanTypeColumnsCountMethodKey12);
    ...
    public com.ext.portlet.plans.model.PlanTypeColumn updatePlanTypeColumn(
        ...
        MethodHandler methodHandler = new MethodHandler(_updatePlanTypeColumnMethodKey13,
                ClpSerializer.translateInput(planTypeColumn));
    ...
    public com.ext.portlet.plans.model.PlanTypeColumn updatePlanTypeColumn(
        ...
        MethodHandler methodHandler = new MethodHandler(_updatePlanTypeColumnMethodKey14,
                ClpSerializer.translateInput(planTypeColumn), merge);
