...
/**
 * Provides the remote service utility for PlanSectionDefinition. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanSectionDefinitionServiceImpl} and is the
    ...
    */
    ...
    public static PlanSectionDefinitionService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanSectionDefinitionService) {
                _service = (PlanSectionDefinitionService) invokableService;
            } else {
                _service = new PlanSectionDefinitionServiceClp(invokableService);
            }
