...
public class ModelDiscussionLocalServiceClp
    implements ModelDiscussionLocalService {
    private ClassLoaderProxy _classLoaderProxy;
    private MethodKey _addModelDiscussionMethodKey0;
    private MethodKey _createModelDiscussionMethodKey1;
    private MethodKey _deleteModelDiscussionMethodKey2;
    private MethodKey _deleteModelDiscussionMethodKey3;
    private MethodKey _dynamicQueryMethodKey4;
    private MethodKey _dynamicQueryMethodKey5;
    private MethodKey _dynamicQueryMethodKey6;
    private MethodKey _dynamicQueryCountMethodKey7;
    private MethodKey _fetchModelDiscussionMethodKey8;
    private MethodKey _getModelDiscussionMethodKey9;
    private MethodKey _getPersistedModelMethodKey10;
    private MethodKey _getModelDiscussionsMethodKey11;
    private MethodKey _getModelDiscussionsCountMethodKey12;
    private MethodKey _updateModelDiscussionMethodKey13;
    private MethodKey _updateModelDiscussionMethodKey14;
    private MethodKey _getBeanIdentifierMethodKey15;
    private MethodKey _setBeanIdentifierMethodKey16;

    public ModelDiscussionLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        _classLoaderProxy = classLoaderProxy;

        _addModelDiscussionMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                "addModelDiscussion",
        ...
        _getModelDiscussionsMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
                "getModelDiscussions", int.class, int.class);

        _getModelDiscussionsCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
                "getModelDiscussionsCount");

        _updateModelDiscussionMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateModelDiscussion",
                com.ext.portlet.models.model.ModelDiscussion.class);

        _updateModelDiscussionMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateModelDiscussion",
                com.ext.portlet.models.model.ModelDiscussion.class,
                boolean.class);
    ...
    public com.ext.portlet.models.model.ModelDiscussion addModelDiscussion(
        ...
        MethodHandler methodHandler = new MethodHandler(_addModelDiscussionMethodKey0,
                ClpSerializer.translateInput(modelDiscussion));
    ...
    public void deleteModelDiscussion(
        com.ext.portlet.models.model.ModelDiscussion modelDiscussion)
        throws com.liferay.portal.kernel.exception.SystemException {
        MethodHandler methodHandler = new MethodHandler(_deleteModelDiscussionMethodKey3,
                ClpSerializer.translateInput(modelDiscussion));
    ...
    public java.util.List<com.ext.portlet.models.model.ModelDiscussion> getModelDiscussions(
        ...
        MethodHandler methodHandler = new MethodHandler(_getModelDiscussionsMethodKey11,
                start, end);
        ...
        return (java.util.List<com.ext.portlet.models.model.ModelDiscussion>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public int getModelDiscussionsCount()
        ...
        MethodHandler methodHandler = new MethodHandler(_getModelDiscussionsCountMethodKey12);
    ...
    public com.ext.portlet.models.model.ModelDiscussion updateModelDiscussion(
        ...
        MethodHandler methodHandler = new MethodHandler(_updateModelDiscussionMethodKey13,
                ClpSerializer.translateInput(modelDiscussion));
    ...
    public com.ext.portlet.models.model.ModelDiscussion updateModelDiscussion(
        ...
        MethodHandler methodHandler = new MethodHandler(_updateModelDiscussionMethodKey14,
                ClpSerializer.translateInput(modelDiscussion), merge);
