...
/**
 * Provides the remote service utility for PlanPositions. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanPositionsServiceImpl} and is the
    ...
    */
    ...
    public static PlanPositionsService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanPositionsService) {
                _service = (PlanPositionsService) invokableService;
            } else {
                _service = new PlanPositionsServiceClp(invokableService);
            }
