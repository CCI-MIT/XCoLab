 ...
 * @generated
 */
public class ImpactTemplateFocusAreaListLocalServiceClp
    ...
    public ImpactTemplateFocusAreaListLocalServiceClp(
    ...
    public com.ext.portlet.model.ImpactTemplateFocusAreaList createImpactTemplateFocusAreaList(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { focusAreaListId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.ImpactTemplateFocusAreaList deleteImpactTemplateFocusAreaList(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { focusAreaListId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.ImpactTemplateFocusAreaList fetchImpactTemplateFocusAreaList(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { focusAreaListId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.ImpactTemplateFocusAreaList getImpactTemplateFocusAreaList(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { focusAreaListId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.ext.portlet.model.ImpactTemplateFocusAreaList> getImpactTemplateFocusAreaLists(
        ...
        return (java.util.List<com.ext.portlet.model.ImpactTemplateFocusAreaList>) ClpSerializer.translateOutput(returnObj);
    }
