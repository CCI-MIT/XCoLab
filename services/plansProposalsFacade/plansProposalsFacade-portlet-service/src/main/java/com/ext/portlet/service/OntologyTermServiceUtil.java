...
/**
 * Provides the remote service utility for OntologyTerm. This utility wraps
 * {@link com.ext.portlet.service.impl.OntologyTermServiceImpl} and is the
    ...
    */
    ...
    public static OntologyTermService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof OntologyTermService) {
                _service = (OntologyTermService) invokableService;
            } else {
                _service = new OntologyTermServiceClp(invokableService);
            }
