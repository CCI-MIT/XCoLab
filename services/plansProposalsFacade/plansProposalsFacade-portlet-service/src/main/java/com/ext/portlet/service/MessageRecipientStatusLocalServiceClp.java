...
public class MessageRecipientStatusLocalServiceClp
    ...
    public MessageRecipientStatusLocalServiceClp(
        ...
        _methodName19 = "countByMessageId";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "findByMessageId";
        ...
        _methodName22 = "findArchivedMessagesForUser";

        _methodParameterTypes22 = new String[] { "long", "int", "int" };

        _methodName23 = "countInboxMessagesForUser";

        _methodParameterTypes23 = new String[] { "long" };

        _methodName24 = "findInboxMessagesForUser";
    ...
    public com.ext.portlet.model.MessageRecipientStatus createMessageRecipientStatus(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { messageRecipientId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessageRecipientStatus deleteMessageRecipientStatus(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { messageRecipientId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessageRecipientStatus fetchMessageRecipientStatus(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { messageRecipientId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessageRecipientStatus getMessageRecipientStatus(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { messageRecipientId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessageRecipientStatus findByMessageRecipient(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName25,
                    _methodParameterTypes25, new Object[] { userid, messageid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
