...
/**
 * The utility for the plans filter position local service. This utility wraps {@link com.ext.portlet.service.impl.PlansFilterPositionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
