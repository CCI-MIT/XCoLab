...
public class OntologyTermEntityLocalServiceClp
    ...
    public OntologyTermEntityLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _addOntologyTermEntityMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                ...
                com.ext.portlet.model.OntologyTermEntity.class);
        ...
        _updateOntologyTermEntityMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateOntologyTermEntity",
                com.ext.portlet.model.OntologyTermEntity.class, boolean.class);
        ...
        _storeMethodKey18 = new MethodKey(_classLoaderProxy.getClassName(),
                "store", com.ext.portlet.model.OntologyTermEntity.class);

        _removeMethodKey19 = new MethodKey(_classLoaderProxy.getClassName(),
                "remove", com.ext.portlet.model.OntologyTermEntity.class);
    }
    ...
    public com.ext.portlet.model.OntologyTermEntity addOntologyTermEntity(
        ...
        return (com.ext.portlet.model.OntologyTermEntity) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.ext.portlet.model.OntologyTermEntity> getOntologyTermEntities(
        ...
        return (java.util.List<com.ext.portlet.model.OntologyTermEntity>) ClpSerializer.translateOutput(returnObj);
    }
