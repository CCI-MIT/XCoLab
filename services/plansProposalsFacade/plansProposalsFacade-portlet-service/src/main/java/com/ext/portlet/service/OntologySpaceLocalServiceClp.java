...
public class OntologySpaceLocalServiceClp implements OntologySpaceLocalService {
    ...
    public OntologySpaceLocalServiceClp(
    ...
    public com.ext.portlet.model.OntologySpace addOntologySpace(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(ontologySpace) });
        } catch (Throwable t) {
    ...
    public void store(com.ext.portlet.model.OntologySpace space)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName20,
                ...
                new Object[] { ClpSerializer.translateInput(space) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
