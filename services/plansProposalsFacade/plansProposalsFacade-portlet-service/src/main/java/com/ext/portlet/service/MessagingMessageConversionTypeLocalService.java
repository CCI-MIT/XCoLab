...
/**
 * Provides the local service interface for MessagingMessageConversionType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MessagingMessageConversionTypeLocalServiceUtil
...
public interface MessagingMessageConversionTypeLocalService
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MessagingMessageConversionTypeLocalServiceUtil} to access the messaging message conversion type local service. Add custom service methods to {@link com.ext.portlet.service.impl.MessagingMessageConversionTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
