...
/**
 * Provides the remote service utility for AnalyticsUserEvent. This utility wraps
 * {@link com.ext.portlet.service.impl.AnalyticsUserEventServiceImpl} and is the
    ...
    */
    ...
    public static AnalyticsUserEventService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof AnalyticsUserEventService) {
                _service = (AnalyticsUserEventService) invokableService;
            } else {
                _service = new AnalyticsUserEventServiceClp(invokableService);
            }
