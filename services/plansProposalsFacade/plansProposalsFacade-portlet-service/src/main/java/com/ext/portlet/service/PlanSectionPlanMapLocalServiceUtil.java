...
/**
 * Provides the local service utility for PlanSectionPlanMap. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanSectionPlanMapLocalServiceImpl} and is the
...
public class PlanSectionPlanMapLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanSectionPlanMap deletePlanSectionPlanMap(
        com.ext.portlet.service.persistence.PlanSectionPlanMapPK planSectionPlanMapPK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanSectionPlanMap(planSectionPlanMapPK);
    }
    ...
    */
    public static com.ext.portlet.model.PlanSectionPlanMap deletePlanSectionPlanMap(
        com.ext.portlet.model.PlanSectionPlanMap planSectionPlanMap)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanSectionPlanMap(planSectionPlanMap);
    }
    ...
    */
    ...
    public static PlanSectionPlanMapLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof PlanSectionPlanMapLocalService) {
                _service = (PlanSectionPlanMapLocalService) invokableLocalService;
            } else {
                _service = new PlanSectionPlanMapLocalServiceClp(invokableLocalService);
            }
