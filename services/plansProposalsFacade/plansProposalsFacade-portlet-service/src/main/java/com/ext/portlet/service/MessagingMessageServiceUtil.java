...
/**
 * Provides the remote service utility for MessagingMessage. This utility wraps
 * {@link com.ext.portlet.service.impl.MessagingMessageServiceImpl} and is the
    ...
    */
    ...
    public static MessagingMessageService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof MessagingMessageService) {
                _service = (MessagingMessageService) invokableService;
            } else {
                _service = new MessagingMessageServiceClp(invokableService);
            }
