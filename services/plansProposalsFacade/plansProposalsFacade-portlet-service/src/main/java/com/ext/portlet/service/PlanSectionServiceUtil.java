...
/**
 * Provides the remote service utility for PlanSection. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanSectionServiceImpl} and is the
    ...
    */
    ...
    public static PlanSectionService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanSectionService) {
                _service = (PlanSectionService) invokableService;
            } else {
                _service = new PlanSectionServiceClp(invokableService);
            }
