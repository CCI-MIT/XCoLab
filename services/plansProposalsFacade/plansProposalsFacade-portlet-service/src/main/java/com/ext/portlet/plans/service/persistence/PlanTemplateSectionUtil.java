...
public class PlanTemplateSectionUtil {
    ...
    public static PlanTemplateSection update(
        ...
        return getPersistence()
                   .update(planTemplateSection, merge, serviceContext);
    }
    ...
    */
    ...
    public static PlanTemplateSectionPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (PlanTemplateSectionPersistence) PortletBeanLocatorUtil.locate(com.ext.portlet.plans.service.ClpSerializer.getServletContextName(),
