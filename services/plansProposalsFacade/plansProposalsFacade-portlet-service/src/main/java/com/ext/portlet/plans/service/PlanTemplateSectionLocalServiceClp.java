...
public class PlanTemplateSectionLocalServiceClp
    ...
    public PlanTemplateSectionLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _addPlanTemplateSectionMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                ...
                com.ext.portlet.plans.model.PlanTemplateSection.class);

        _createPlanTemplateSectionMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
                "createPlanTemplateSection",
                com.ext.portlet.plans.service.persistence.PlanTemplateSectionPK.class);
    ...
    public com.ext.portlet.plans.model.PlanTemplateSection addPlanTemplateSection(
        ...
        return (com.ext.portlet.plans.model.PlanTemplateSection) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.ext.portlet.plans.model.PlanTemplateSection> getPlanTemplateSections(
        ...
        return (java.util.List<com.ext.portlet.plans.model.PlanTemplateSection>) ClpSerializer.translateOutput(returnObj);
    }
