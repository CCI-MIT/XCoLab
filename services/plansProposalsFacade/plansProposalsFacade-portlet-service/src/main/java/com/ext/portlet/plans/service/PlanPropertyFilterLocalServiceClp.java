...
public class PlanPropertyFilterLocalServiceClp
    ...
    public java.util.List<com.ext.portlet.plans.model.PlanPropertyFilter> getPlanPropertyFilters(
        ...
        return (java.util.List<com.ext.portlet.plans.model.PlanPropertyFilter>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.plans.model.PlanPropertyFilter getByPlanPlanUserSettingsIdPropertyName(
        ...
        try {
            ...
            if (t instanceof com.ext.portlet.plans.NoSuchPlanPropertyFilterException) {
                throw (com.ext.portlet.plans.NoSuchPlanPropertyFilterException) t;
            }
