...
/**
 * Provides the remote service utility for ModelInputItem. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelInputItemServiceImpl} and is the
    ...
    */
    ...
    public static ModelInputItemService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ModelInputItemService) {
                _service = (ModelInputItemService) invokableService;
            } else {
                _service = new ModelInputItemServiceClp(invokableService);
            }
