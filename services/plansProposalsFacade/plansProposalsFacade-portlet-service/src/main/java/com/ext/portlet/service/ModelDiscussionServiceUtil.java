...
/**
 * Provides the remote service utility for ModelDiscussion. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelDiscussionServiceImpl} and is the
    ...
    */
    ...
    public static ModelDiscussionService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ModelDiscussionService) {
                _service = (ModelDiscussionService) invokableService;
            } else {
                _service = new ModelDiscussionServiceClp(invokableService);
            }
