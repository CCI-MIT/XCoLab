...
public class ModelPositionUtil {
    ...
    */
    public static com.ext.portlet.models.model.ModelPosition create(long id) {
    ...
    */
    public static com.ext.portlet.models.model.ModelPosition remove(long id)
    ...
    */
    ...
    public static ModelPositionPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (ModelPositionPersistence) PortletBeanLocatorUtil.locate(com.ext.portlet.models.service.ClpSerializer.getServletContextName(),
