...
/**
 * The utility for the model discussion local service. This utility wraps {@link com.ext.portlet.service.impl.ModelDiscussionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ModelDiscussionLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteModelDiscussion(long modelDiscussionId)
    ...
    */
    ...
    public static ModelDiscussionLocalService getService() {
        if (_service == null) {
            ...
            _service = new ModelDiscussionLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(ModelDiscussionLocalServiceUtil.class,
                "_service");
            MethodCache.remove(ModelDiscussionLocalService.class);
        }
