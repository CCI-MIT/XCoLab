...
/**
 * Provides the local service utility for ModelDiscussion. This utility wraps
 * {@link com.ext.portlet.service.impl.ModelDiscussionLocalServiceImpl} and is the
 ...
 * @see com.ext.portlet.service.impl.ModelDiscussionLocalServiceImpl
 * @generated
 */
public class ModelDiscussionLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.service.impl.ModelDiscussionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.ext.portlet.model.ModelDiscussion addModelDiscussion(
    ...
    */
    public static com.ext.portlet.model.ModelDiscussion createModelDiscussion(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ModelDiscussion deleteModelDiscussion(
        long modelDiscussionId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteModelDiscussion(modelDiscussionId);
    }
    ...
    */
    public static com.ext.portlet.model.ModelDiscussion deleteModelDiscussion(
        com.ext.portlet.model.ModelDiscussion modelDiscussion)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteModelDiscussion(modelDiscussion);
    }
    ...
    */
    ...
    public static com.ext.portlet.model.ModelDiscussion fetchModelDiscussion(
        long modelDiscussionId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchModelDiscussion(modelDiscussionId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ModelDiscussion getModelDiscussion(
        long modelDiscussionId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.ext.portlet.model.ModelDiscussion> getModelDiscussions(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.ModelDiscussion updateModelDiscussion(
        com.ext.portlet.model.ModelDiscussion modelDiscussion)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    public static ModelDiscussionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ModelDiscussionLocalService.class.getName());

            if (invokableLocalService instanceof ModelDiscussionLocalService) {
                _service = (ModelDiscussionLocalService) invokableLocalService;
            } else {
                _service = new ModelDiscussionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ModelDiscussionLocalServiceUtil.class,
                "_service");
        }
