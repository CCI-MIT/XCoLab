...
/**
 * The utility for the plans user settings local service. This utility wraps {@link com.ext.portlet.service.impl.PlansUserSettingsLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class PlansUserSettingsLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deletePlansUserSettings(long planUserSettingsId)
