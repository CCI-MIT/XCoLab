...
/**
 * Provides the remote service utility for MessagingMessageRecipient. This utility wraps
 * {@link com.ext.portlet.service.impl.MessagingMessageRecipientServiceImpl} and is the
    ...
    */
    ...
    public static MessagingMessageRecipientService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof MessagingMessageRecipientService) {
                _service = (MessagingMessageRecipientService) invokableService;
            } else {
                _service = new MessagingMessageRecipientServiceClp(invokableService);
            }
