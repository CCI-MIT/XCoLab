...
/**
 * The utility for the contest debate local service. This utility wraps {@link com.ext.portlet.service.impl.ContestDebateLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
