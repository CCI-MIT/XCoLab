...
/**
 * Provides the remote service utility for ProposalAttributeType. This utility wraps
 * {@link com.ext.portlet.service.impl.ProposalAttributeTypeServiceImpl} and is the
    ...
    */
    ...
    public static ProposalAttributeTypeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ProposalAttributeTypeService) {
                _service = (ProposalAttributeTypeService) invokableService;
            } else {
                _service = new ProposalAttributeTypeServiceClp(invokableService);
            }
