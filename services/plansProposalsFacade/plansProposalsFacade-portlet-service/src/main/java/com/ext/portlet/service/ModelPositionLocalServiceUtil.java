...
/**
 * The utility for the model position local service. This utility wraps {@link com.ext.portlet.service.impl.ModelPositionLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
