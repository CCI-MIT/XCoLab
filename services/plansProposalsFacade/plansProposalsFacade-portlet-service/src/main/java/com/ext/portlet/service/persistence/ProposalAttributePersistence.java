...
public interface ProposalAttributePersistence extends BasePersistence<ProposalAttribute> {
    ...
    * @throws SystemException if a system exception occurred
    */
    public com.ext.portlet.model.ProposalAttribute findByProposalId_VersionGreaterEqual_VersionWhenCreatedLesserEqual_NameAdditionalId(
        long proposalId, int version, int versionWhenCreated,
    ...
    * @throws SystemException if a system exception occurred
    */
    public com.ext.portlet.model.ProposalAttribute fetchByProposalId_VersionGreaterEqual_VersionWhenCreatedLesserEqual_NameAdditionalId(
        long proposalId, int version, int versionWhenCreated,
        java.lang.String name, long additionalId)
        throws com.liferay.portal.kernel.exception.SystemException;
