...
/**
 * Provides the local service interface for Users_Roles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Users_RolesLocalServiceUtil
...
public interface Users_RolesLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Users_RolesLocalServiceUtil} to access the users_ roles local service. Add custom service methods to {@link com.ext.portlet.service.impl.Users_RolesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
