 ...
 * @generated
 */
public class TrackedVisitLocalServiceClp implements TrackedVisitLocalService {
    ...
    public com.ext.portlet.model.TrackedVisit addTrackedVisit(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(trackedVisit) });
        } catch (Throwable t) {
    ...
    public java.util.List<com.ext.portlet.model.TrackedVisit> getTrackedVisits(
        ...
        return (java.util.List<com.ext.portlet.model.TrackedVisit>) ClpSerializer.translateOutput(returnObj);
    }
