...
public class PlanColumnSettingsLocalServiceClp
    ...
    public PlanColumnSettingsLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _fetchPlanColumnSettingsMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
                "fetchPlanColumnSettings", java.lang.Long.class);

        _getPlanColumnSettingsMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
                "getPlanColumnSettings", java.lang.Long.class);
    ...
    public com.ext.portlet.plans.model.PlanColumnSettings addPlanColumnSettings(
        ...
        return (com.ext.portlet.plans.model.PlanColumnSettings) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.plans.model.PlanColumnSettings createPlanColumnSettings(
        ...
        MethodHandler methodHandler = new MethodHandler(_createPlanColumnSettingsMethodKey1,
                ClpSerializer.translateInput(planColumnSettingsId));
    ...
    public java.util.List<com.ext.portlet.plans.model.PlanColumnSettings> getPlanColumnSettingses(
        ...
        return (java.util.List<com.ext.portlet.plans.model.PlanColumnSettings>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.plans.model.PlanColumnSettings findByPlanUserSettingsIdColumnName(
        ...
        try {
            ...
            if (t instanceof com.ext.portlet.plans.NoSuchPlanColumnSettingsException) {
                throw (com.ext.portlet.plans.NoSuchPlanColumnSettingsException) t;
            }
