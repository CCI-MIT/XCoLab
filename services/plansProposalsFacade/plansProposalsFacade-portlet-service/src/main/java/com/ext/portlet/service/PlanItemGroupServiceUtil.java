...
/**
 * Provides the remote service utility for PlanItemGroup. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanItemGroupServiceImpl} and is the
    ...
    */
    ...
    public static PlanItemGroupService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanItemGroupService) {
                _service = (PlanItemGroupService) invokableService;
            } else {
                _service = new PlanItemGroupServiceClp(invokableService);
            }
