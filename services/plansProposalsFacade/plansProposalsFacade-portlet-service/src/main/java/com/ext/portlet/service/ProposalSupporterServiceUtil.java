...
/**
 * Provides the remote service utility for ProposalSupporter. This utility wraps
 * {@link com.ext.portlet.service.impl.ProposalSupporterServiceImpl} and is the
    ...
    */
    ...
    public static ProposalSupporterService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ProposalSupporterService) {
                _service = (ProposalSupporterService) invokableService;
            } else {
                _service = new ProposalSupporterServiceClp(invokableService);
            }
