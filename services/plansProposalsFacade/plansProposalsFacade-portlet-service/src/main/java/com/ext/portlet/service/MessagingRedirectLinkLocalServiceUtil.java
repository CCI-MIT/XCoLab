...
/**
 * Provides the local service utility for MessagingRedirectLink. This utility wraps
 * {@link com.ext.portlet.service.impl.MessagingRedirectLinkLocalServiceImpl} and is the
...
public class MessagingRedirectLinkLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.MessagingRedirectLink deleteMessagingRedirectLink(
        long redirectId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteMessagingRedirectLink(redirectId);
    }
    ...
    */
    public static com.ext.portlet.model.MessagingRedirectLink deleteMessagingRedirectLink(
        com.ext.portlet.model.MessagingRedirectLink messagingRedirectLink)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteMessagingRedirectLink(messagingRedirectLink);
    }
    ...
    */
    ...
    public static MessagingRedirectLinkLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof MessagingRedirectLinkLocalService) {
                _service = (MessagingRedirectLinkLocalService) invokableLocalService;
            } else {
                _service = new MessagingRedirectLinkLocalServiceClp(invokableLocalService);
            }
