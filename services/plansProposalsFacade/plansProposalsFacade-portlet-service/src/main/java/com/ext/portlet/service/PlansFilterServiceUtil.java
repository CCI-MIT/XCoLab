...
/**
 * Provides the remote service utility for PlansFilter. This utility wraps
 * {@link com.ext.portlet.service.impl.PlansFilterServiceImpl} and is the
    ...
    */
    ...
    public static PlansFilterService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlansFilterService) {
                _service = (PlansFilterService) invokableService;
            } else {
                _service = new PlansFilterServiceClp(invokableService);
            }
