...
/**
 * Provides the local service interface for ModelPosition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ModelPositionLocalServiceUtil
...
public interface ModelPositionLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ModelPositionLocalServiceUtil} to access the model position local service. Add custom service methods to {@link com.ext.portlet.service.impl.ModelPositionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
