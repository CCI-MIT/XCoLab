...
/**
 * The utility for the messaging user preferences local service. This utility wraps {@link com.ext.portlet.service.impl.MessagingUserPreferencesLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
