...
public class PlanTypeUtil {
    ...
    */
    public static void cacheResult(com.ext.portlet.model.PlanType planType) {
    ...
    */
    public static com.ext.portlet.model.PlanType create(long planTypeId) {
    ...
    */
    public static com.ext.portlet.model.PlanType remove(long planTypeId)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanType findByPrimaryKey(
        long planTypeId)
        throws com.ext.portlet.NoSuchPlanTypeException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanType fetchByPrimaryKey(
        long planTypeId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.ext.portlet.model.PlanType> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static PlanTypePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (PlanTypePersistence) PortletBeanLocatorUtil.locate(com.ext.portlet.service.ClpSerializer.getServletContextName(),
