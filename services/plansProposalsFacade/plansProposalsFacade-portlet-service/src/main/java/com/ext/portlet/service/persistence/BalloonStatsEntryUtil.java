...
public class BalloonStatsEntryUtil {
    ...
    public static BalloonStatsEntry update(
        ...
        throws SystemException {
        return getPersistence().update(balloonStatsEntry, merge);
    }
    ...
    public static BalloonStatsEntry update(
        ...
        return getPersistence().update(balloonStatsEntry, merge, serviceContext);
    }
    ...
    */
    ...
    public static com.ext.portlet.model.BalloonStatsEntry updateImpl(
        ...
        return getPersistence().updateImpl(balloonStatsEntry, merge);
    }
