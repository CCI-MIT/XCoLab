...
public class ProposalMoveHistoryLocalServiceUtil {
    ...
    */
    ...
    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getBySourceProposalId(
        long srcProposalId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getBySourceProposalId(srcProposalId);
    }

    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getBySourceContestId(
        long srcContestId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getBySourceContestId(srcContestId);
    }

    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getBySourcePhaseId(
        long srcPhaseId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getBySourcePhaseId(srcPhaseId);
    }

    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getByTargetProposalId(
        long targetProposalId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getByTargetProposalId(targetProposalId);
    }

    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getByTargetContestId(
        long targetContestId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getByTargetContestId(targetContestId);
    }

    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getByTargetPhaseId(
        long targetPhaseId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getByTargetPhaseId(targetPhaseId);
    }

    public static java.util.List<com.ext.portlet.model.ProposalMoveHistory> getBySourceProposalIdContestId(
        long srcProposalId, long srcContestId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .getBySourceProposalIdContestId(srcProposalId, srcContestId);
    }

    public static com.ext.portlet.model.ProposalMoveHistory getByTargetProposalIdContestId(
        long targetProposalId, long targetContestId)
        throws com.ext.portlet.NoSuchProposalMoveHistoryException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .getByTargetProposalIdContestId(targetProposalId,
            targetContestId);
    }
