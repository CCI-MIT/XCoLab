...
public class PlanDescriptionUtil {
    ...
    */
    public static com.ext.portlet.plans.model.PlanDescription create(long id) {
    ...
    */
    public static com.ext.portlet.plans.model.PlanDescription remove(long id)
    ...
    */
    ...
    public static PlanDescriptionPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (PlanDescriptionPersistence) PortletBeanLocatorUtil.locate(com.ext.portlet.plans.service.ClpSerializer.getServletContextName(),
