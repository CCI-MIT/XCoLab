...
/**
 * Provides the remote service utility for PlanPropertyFilter. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanPropertyFilterServiceImpl} and is the
    ...
    */
    ...
    public static PlanPropertyFilterService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanPropertyFilterService) {
                _service = (PlanPropertyFilterService) invokableService;
            } else {
                _service = new PlanPropertyFilterServiceClp(invokableService);
            }
