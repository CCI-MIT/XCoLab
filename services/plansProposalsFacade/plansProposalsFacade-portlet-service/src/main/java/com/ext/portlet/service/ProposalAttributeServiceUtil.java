...
/**
 * Provides the remote service utility for ProposalAttribute. This utility wraps
 * {@link com.ext.portlet.service.impl.ProposalAttributeServiceImpl} and is the
    ...
    */
    ...
    public static ProposalAttributeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ProposalAttributeService) {
                _service = (ProposalAttributeService) invokableService;
            } else {
                _service = new ProposalAttributeServiceClp(invokableService);
            }
