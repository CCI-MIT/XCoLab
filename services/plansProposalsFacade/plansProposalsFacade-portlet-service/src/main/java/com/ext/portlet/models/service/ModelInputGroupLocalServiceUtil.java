...
/**
 * The utility for the model input group local service. This utility wraps {@link com.ext.portlet.models.service.impl.ModelInputGroupLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.ext.portlet.models.service.impl.ModelInputGroupLocalServiceImpl
 * @generated
 */
public class ModelInputGroupLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.models.service.impl.ModelInputGroupLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    ...
    public static com.ext.portlet.models.model.ModelInputGroup fetchModelInputGroup(
        long modelInputGroupPK)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static java.util.List<com.ext.portlet.models.model.ModelInputItem> getInputItems(
        com.ext.portlet.models.model.ModelInputGroup group) {
        return getService().getInputItems(group);
    }

    public static com.ext.portlet.models.model.ModelInputGroup getParent(
        com.ext.portlet.models.model.ModelInputGroup group) {
