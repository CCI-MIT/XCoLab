...
/**
 * Provides the remote service utility for ProposalVote. This utility wraps
 * {@link com.ext.portlet.service.impl.ProposalVoteServiceImpl} and is the
    ...
    */
    ...
    public static ProposalVoteService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ProposalVoteService) {
                _service = (ProposalVoteService) invokableService;
            } else {
                _service = new ProposalVoteServiceClp(invokableService);
            }
