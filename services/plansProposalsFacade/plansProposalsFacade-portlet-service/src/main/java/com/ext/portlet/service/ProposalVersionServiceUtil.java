...
/**
 * The utility for the proposal version remote service. This utility wraps {@link com.ext.portlet.service.impl.ProposalVersionServiceImpl} and is the primary access point for service operations in application layer code running on a remote server.
 *
 * <p>
    ...
    public static ProposalVersionService getService() {
        if (_service == null) {
            ...
            ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
                    ProposalVersionService.class.getName(), portletClassLoader);

            _service = new ProposalVersionServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(ProposalVersionServiceUtil.class,
                "_service");
            MethodCache.remove(ProposalVersionService.class);
        }
