...
/**
 * Provides the local service utility for PlanType. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanTypeLocalServiceImpl} and is the
...
public class PlanTypeLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanType deletePlanType(long planTypeId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanType(planTypeId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.PlanType deletePlanType(
        com.ext.portlet.model.PlanType planType)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePlanType(planType);
    }
    ...
    */
    ...
    public static PlanTypeLocalService getService() {
        if (_service == null) {
            ...
            if (invokableLocalService instanceof PlanTypeLocalService) {
                _service = (PlanTypeLocalService) invokableLocalService;
            } else {
                _service = new PlanTypeLocalServiceClp(invokableLocalService);
            }
