...
/**
 * The utility for the contest phase type local service. This utility wraps {@link com.ext.portlet.service.impl.ContestPhaseTypeLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ContestPhaseTypeLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteContestPhaseType(long id)
    ...
    */
    ...
    public static ContestPhaseTypeLocalService getService() {
        if (_service == null) {
            ...
            _service = new ContestPhaseTypeLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(ContestPhaseTypeLocalServiceUtil.class,
                "_service");
            MethodCache.remove(ContestPhaseTypeLocalService.class);
        }
