...
/**
 * The utility for the model output chart order local service. This utility wraps {@link com.ext.portlet.service.impl.ModelOutputChartOrderLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
