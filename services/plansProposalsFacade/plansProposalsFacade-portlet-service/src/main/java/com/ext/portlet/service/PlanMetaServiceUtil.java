...
/**
 * Provides the remote service utility for PlanMeta. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanMetaServiceImpl} and is the
    ...
    */
    ...
    public static PlanMetaService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanMetaService) {
                _service = (PlanMetaService) invokableService;
            } else {
                _service = new PlanMetaServiceClp(invokableService);
            }
