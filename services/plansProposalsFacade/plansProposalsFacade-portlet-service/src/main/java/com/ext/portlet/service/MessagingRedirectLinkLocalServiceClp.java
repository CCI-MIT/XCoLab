 ...
 * @generated
 */
public class MessagingRedirectLinkLocalServiceClp
    ...
    public MessagingRedirectLinkLocalServiceClp(
    ...
    public com.ext.portlet.model.MessagingRedirectLink addMessagingRedirectLink(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(messagingRedirectLink)
                    });
        } catch (Throwable t) {
        ...
        return (com.ext.portlet.model.MessagingRedirectLink) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.ext.portlet.model.MessagingRedirectLink createMessagingRedirectLink(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { redirectId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessagingRedirectLink deleteMessagingRedirectLink(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { redirectId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessagingRedirectLink fetchMessagingRedirectLink(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { redirectId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.MessagingRedirectLink getMessagingRedirectLink(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { redirectId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.ext.portlet.model.MessagingRedirectLink> getMessagingRedirectLinks(
        ...
        return (java.util.List<com.ext.portlet.model.MessagingRedirectLink>) ClpSerializer.translateOutput(returnObj);
    }
