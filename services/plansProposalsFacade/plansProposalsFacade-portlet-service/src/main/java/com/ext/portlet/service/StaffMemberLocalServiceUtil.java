 ...
 * {@link com.ext.portlet.service.impl.StaffMemberLocalServiceImpl} and is the
 ...
 * @see com.ext.portlet.service.impl.StaffMemberLocalServiceImpl
 * @generated
 */
public class StaffMemberLocalServiceUtil {
    private static StaffMemberLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.ext.portlet.service.impl.StaffMemberLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.ext.portlet.model.StaffMember addStaffMember(
    ...
    */
    public static com.ext.portlet.model.StaffMember createStaffMember(long id) {
        return getService().createStaffMember(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.StaffMember deleteStaffMember(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteStaffMember(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.StaffMember deleteStaffMember(
        com.ext.portlet.model.StaffMember staffMember)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static com.ext.portlet.model.StaffMember fetchStaffMember(long id)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchStaffMember(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.StaffMember getStaffMember(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getStaffMember(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.ext.portlet.model.StaffMember> getStaffMembers(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.ext.portlet.model.StaffMember updateStaffMember(
        com.ext.portlet.model.StaffMember staffMember)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static StaffMemberLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StaffMemberLocalService.class.getName());

            if (invokableLocalService instanceof StaffMemberLocalService) {
                _service = (StaffMemberLocalService) invokableLocalService;
            } else {
                _service = new StaffMemberLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StaffMemberLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StaffMemberLocalService service) {
    }
}
