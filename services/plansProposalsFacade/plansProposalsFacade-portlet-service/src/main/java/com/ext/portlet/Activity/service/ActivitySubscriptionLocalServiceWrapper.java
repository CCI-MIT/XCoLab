...
public class ActivitySubscriptionLocalServiceWrapper
    ...
    */
    ...
    public void addActivityInterpreter(
        ...
        _activitySubscriptionLocalService.addActivityInterpreter(interpreter);
    }

    public com.ext.portlet.Activity.ICollabActivityInterpreter getInterpreterForClass(
        java.lang.String className) {
        return _activitySubscriptionLocalService.getInterpreterForClass(className);
    }

    public com.ext.portlet.Activity.ICollabActivityInterpreter getInterpreterForClass(
        java.lang.Long classNameId) {
        return _activitySubscriptionLocalService.getInterpreterForClass(classNameId);
    }
