...
/**
 * Provides the remote service utility for PlanType. This utility wraps
 * {@link com.ext.portlet.service.impl.PlanTypeServiceImpl} and is the
    ...
    */
    ...
    public static PlanTypeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof PlanTypeService) {
                _service = (PlanTypeService) invokableService;
            } else {
                _service = new PlanTypeServiceClp(invokableService);
            }
