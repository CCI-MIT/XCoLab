...
public class PlanTypeAttributeLocalServiceClp
    ...
    public PlanTypeAttributeLocalServiceClp(
    ...
    public com.ext.portlet.model.PlanTypeAttribute createPlanTypeAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { planTypeAttributeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.PlanTypeAttribute deletePlanTypeAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { planTypeAttributeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.ext.portlet.model.PlanTypeAttribute fetchPlanTypeAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    ...
                    new Object[] { planTypeAttributeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
