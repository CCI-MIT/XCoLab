...
/**
 * Provides the remote service utility for ContestPhaseRibbonType. This utility wraps
 * {@link com.ext.portlet.service.impl.ContestPhaseRibbonTypeServiceImpl} and is the
    ...
    */
    ...
    public static ContestPhaseRibbonTypeService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ContestPhaseRibbonTypeService) {
                _service = (ContestPhaseRibbonTypeService) invokableService;
            } else {
                _service = new ContestPhaseRibbonTypeServiceClp(invokableService);
            }
