...
/**
 * Provides the remote service utility for FocusArea. This utility wraps
 * {@link com.ext.portlet.service.impl.FocusAreaServiceImpl} and is the
    ...
    */
    ...
    public static FocusAreaService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof FocusAreaService) {
                _service = (FocusAreaService) invokableService;
            } else {
                _service = new FocusAreaServiceClp(invokableService);
            }
