...
/**
 * Provides the remote service utility for ContestDebate. This utility wraps
 * {@link com.ext.portlet.service.impl.ContestDebateServiceImpl} and is the
    ...
    */
    ...
    public static ContestDebateService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof ContestDebateService) {
                _service = (ContestDebateService) invokableService;
            } else {
                _service = new ContestDebateServiceClp(invokableService);
            }
