...
/**
 * The utility for the message local service. This utility wraps {@link com.ext.portlet.service.impl.MessageLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class MessageLocalServiceUtil {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteMessage(com.ext.portlet.model.Message message)
        throws com.liferay.portal.kernel.exception.SystemException {
