...
/**
 * Provides the remote service utility for LandingPage. This utility wraps
 * {@link com.ext.portlet.service.impl.LandingPageServiceImpl} and is the
    ...
    */
    ...
    public static LandingPageService getService() {
        if (_service == null) {
            ...
            if (invokableService instanceof LandingPageService) {
                _service = (LandingPageService) invokableService;
            } else {
                _service = new LandingPageServiceClp(invokableService);
            }
