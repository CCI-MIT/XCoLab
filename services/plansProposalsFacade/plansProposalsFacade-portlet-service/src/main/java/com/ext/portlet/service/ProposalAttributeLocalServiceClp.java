...
public class ProposalAttributeLocalServiceClp
    implements ProposalAttributeLocalService {
    private ClassLoaderProxy _classLoaderProxy;
    private MethodKey _addProposalAttributeMethodKey0;
    private MethodKey _createProposalAttributeMethodKey1;
    private MethodKey _deleteProposalAttributeMethodKey2;
    private MethodKey _deleteProposalAttributeMethodKey3;
    private MethodKey _dynamicQueryMethodKey4;
    private MethodKey _dynamicQueryMethodKey5;
    private MethodKey _dynamicQueryMethodKey6;
    private MethodKey _dynamicQueryCountMethodKey7;
    private MethodKey _fetchProposalAttributeMethodKey8;
    private MethodKey _getProposalAttributeMethodKey9;
    private MethodKey _getPersistedModelMethodKey10;
    private MethodKey _getProposalAttributesMethodKey11;
    private MethodKey _getProposalAttributesCountMethodKey12;
    private MethodKey _updateProposalAttributeMethodKey13;
    private MethodKey _updateProposalAttributeMethodKey14;
    private MethodKey _getBeanIdentifierMethodKey15;
    private MethodKey _setBeanIdentifierMethodKey16;

    public ProposalAttributeLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        _classLoaderProxy = classLoaderProxy;

        _addProposalAttributeMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                "addProposalAttribute",
        ...
        _getProposalAttributesMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
                "getProposalAttributes", int.class, int.class);

        _getProposalAttributesCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
                "getProposalAttributesCount");

        _updateProposalAttributeMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateProposalAttribute",
                com.ext.portlet.model.ProposalAttribute.class);

        _updateProposalAttributeMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateProposalAttribute",
                com.ext.portlet.model.ProposalAttribute.class, boolean.class);
    ...
    public com.ext.portlet.model.ProposalAttribute addProposalAttribute(
        ...
        MethodHandler methodHandler = new MethodHandler(_addProposalAttributeMethodKey0,
                ClpSerializer.translateInput(proposalAttribute));
    ...
    public void deleteProposalAttribute(
        com.ext.portlet.model.ProposalAttribute proposalAttribute)
        throws com.liferay.portal.kernel.exception.SystemException {
        MethodHandler methodHandler = new MethodHandler(_deleteProposalAttributeMethodKey3,
                ClpSerializer.translateInput(proposalAttribute));
    ...
    public java.util.List<com.ext.portlet.model.ProposalAttribute> getProposalAttributes(
        ...
        MethodHandler methodHandler = new MethodHandler(_getProposalAttributesMethodKey11,
                start, end);
    ...
    public int getProposalAttributesCount()
        ...
        MethodHandler methodHandler = new MethodHandler(_getProposalAttributesCountMethodKey12);
    ...
    public com.ext.portlet.model.ProposalAttribute updateProposalAttribute(
        ...
        MethodHandler methodHandler = new MethodHandler(_updateProposalAttributeMethodKey13,
                ClpSerializer.translateInput(proposalAttribute));
    ...
    public com.ext.portlet.model.ProposalAttribute updateProposalAttribute(
        ...
        MethodHandler methodHandler = new MethodHandler(_updateProposalAttributeMethodKey14,
                ClpSerializer.translateInput(proposalAttribute), merge);
