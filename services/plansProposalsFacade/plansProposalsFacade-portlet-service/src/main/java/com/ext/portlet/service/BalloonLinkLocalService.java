...
/**
 * Provides the local service interface for BalloonLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BalloonLinkLocalServiceUtil
...
public interface BalloonLinkLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BalloonLinkLocalServiceUtil} to access the balloon link local service. Add custom service methods to {@link com.ext.portlet.service.impl.BalloonLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
