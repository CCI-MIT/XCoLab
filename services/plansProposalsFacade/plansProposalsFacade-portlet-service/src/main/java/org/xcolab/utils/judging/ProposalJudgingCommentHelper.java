...
public class ProposalJudgingCommentHelper {
    ...
    public String getScreeningComment() throws NoSuchProposalContestPhaseAttributeException, SystemException {
        ...
        if (fellowAction != JudgingSystemActions.FellowAction.NO_DECISION &&
            ...
            String fellowRejectionText = ProposalContestPhaseAttributeClient.
    ...
    public String getAdvancingComment() throws SystemException {
            ProposalContestPhaseAttribute advanceDecisionAttribute = ProposalContestPhaseAttributeClient.
            ...
            if (advanceDecision != JudgingSystemActions.AdvanceDecision.NO_DECISION) {
                String advanceDecisionText = ProposalContestPhaseAttributeClient.
    ...
    public String getPromotionComment(boolean isWrapWithTemplate) {
        try {
            String proposalName = ProposalAttributeClient
                    ...
                    .getStringValue();
            String contestName = ContestClient.getContest(contestPhase.getContestPK())
                    .getContestShortName();
            ...
            if (fellowAction == JudgingSystemActions.FellowAction.PASS_TO_JUDGES) {
                    String reviewText = ProposalContestPhaseAttributeClient.
                            getProposalContestPhaseAttribute(proposal.getProposalId(),
                                    contestPhase.getContestPhasePK(),
                ...
                String fellowReviewText = ProposalContestPhaseAttributeClient
    ...
    private boolean persistAttribute(String attributeName, String stringValue) {
        ...
        ProposalContestPhaseAttributeClient.updateProposalContestPhaseAttribute(attribute);
    ...
    private ProposalContestPhaseAttribute getProposalContestPhaseAttributeCreateIfNotExists(String attributeName) {
        ...
        return ProposalContestPhaseAttributeClient.getOrCreateProposalContestPhaseAttribute(proposal.getProposalId(), contestPhase.getContestPhasePK(), attributeName, 0l, 0l, "");
    }
