...
/**
 * The base implementation of the plan attribute filter local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanAttributeFilterLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanAttributeFilterLocalServiceBaseImpl
    implements PlanAttributeFilterLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanAttributeFilterLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanAttributeFilterLocalServiceUtil} to access the plan attribute filter local service.
     */
    ...
    public PlanAttributeFilter addPlanAttributeFilter(
        ...
        planAttributeFilter = planAttributeFilterPersistence.update(planAttributeFilter,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planAttributeFilter);
    ...
    public void deletePlanAttributeFilter(Long planAttributeFilterId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(planAttributeFilter);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanAttributeFilter updatePlanAttributeFilter(
        PlanAttributeFilter planAttributeFilter) throws SystemException {
        return updatePlanAttributeFilter(planAttributeFilter, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanAttributeFilter",
            planAttributeFilterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanAttributeFilter");
    }
