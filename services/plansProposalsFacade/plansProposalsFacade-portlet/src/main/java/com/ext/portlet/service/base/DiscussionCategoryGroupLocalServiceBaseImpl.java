...
/**
 * Provides the base implementation for the discussion category group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.DiscussionCategoryGroupLocalServiceImpl}.
 * </p>
 *
...
public abstract class DiscussionCategoryGroupLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements DiscussionCategoryGroupLocalService,
        IdentifiableBean {
    ...
    private DiscussionCategoryGroupLocalServiceClpInvoker _clpInvoker = new DiscussionCategoryGroupLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.DiscussionCategoryGroupLocalServiceUtil} to access the discussion category group local service.
     */
    ...
    @Override
    public DiscussionCategoryGroup deleteDiscussionCategoryGroup(long id)
        throws PortalException, SystemException {
        return discussionCategoryGroupPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public DiscussionCategoryGroup deleteDiscussionCategoryGroup(
        DiscussionCategoryGroup discussionCategoryGroup)
        throws SystemException {
        return discussionCategoryGroupPersistence.remove(discussionCategoryGroup);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DiscussionCategoryGroup.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.DiscussionCategoryGroup",
