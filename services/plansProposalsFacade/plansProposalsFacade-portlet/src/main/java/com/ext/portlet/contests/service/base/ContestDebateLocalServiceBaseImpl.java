...
/**
 * The base implementation of the contest debate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.contests.service.impl.ContestDebateLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContestDebateLocalServiceBaseImpl
    implements ContestDebateLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ContestDebateLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.contests.service.ContestDebateLocalServiceUtil} to access the contest debate local service.
     */
    ...
    public ContestDebate addContestDebate(ContestDebate contestDebate)
        ...
        contestDebate = contestDebatePersistence.update(contestDebate, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(contestDebate);
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestDebatePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public ContestDebate updateContestDebate(ContestDebate contestDebate)
        throws SystemException {
        return updateContestDebate(contestDebate, true);
    }
    ...
    public ContestDebate updateContestDebate(ContestDebate contestDebate,
        ...
        contestDebate = contestDebatePersistence.update(contestDebate, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.contests.model.ContestDebate",
            contestDebateLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.contests.model.ContestDebate");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestDebatePersistence.getDataSource();
