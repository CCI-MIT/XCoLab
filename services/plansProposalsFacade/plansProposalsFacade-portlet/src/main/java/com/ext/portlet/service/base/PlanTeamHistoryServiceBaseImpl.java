...
/**
 * Provides the base implementation for the plan team history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanTeamHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanTeamHistoryServiceImpl
 * @see com.ext.portlet.service.PlanTeamHistoryServiceUtil
 * @generated
 */
public abstract class PlanTeamHistoryServiceBaseImpl extends BaseServiceImpl
    implements PlanTeamHistoryService, IdentifiableBean {
    ...
    private PlanTeamHistoryServiceClpInvoker _clpInvoker = new PlanTeamHistoryServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanTeamHistoryServiceUtil} to access the plan team history remote service.
     */
