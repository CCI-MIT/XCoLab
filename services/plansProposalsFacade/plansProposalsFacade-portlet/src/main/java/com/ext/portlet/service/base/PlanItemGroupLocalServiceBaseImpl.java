...
/**
 * Provides the base implementation for the plan item group local service.
 *
 * <p>
...
public abstract class PlanItemGroupLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanItemGroupLocalService,
        IdentifiableBean {
    ...
    private PlanItemGroupLocalServiceClpInvoker _clpInvoker = new PlanItemGroupLocalServiceClpInvoker();
    ...
    public PlanItemGroup addPlanItemGroup(PlanItemGroup planItemGroup)
        ...
        return planItemGroupPersistence.update(planItemGroup);
    }
    ...
    @Override
    public PlanItemGroup deletePlanItemGroup(long planId)
        throws PortalException, SystemException {
        return planItemGroupPersistence.remove(planId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanItemGroup deletePlanItemGroup(PlanItemGroup planItemGroup)
        throws SystemException {
        return planItemGroupPersistence.remove(planItemGroup);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanItemGroup.class,
