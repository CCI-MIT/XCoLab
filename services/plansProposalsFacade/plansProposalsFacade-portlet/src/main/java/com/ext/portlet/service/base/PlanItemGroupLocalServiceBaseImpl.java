...
/**
 * The base implementation of the plan item group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanItemGroupLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanItemGroupLocalServiceBaseImpl
    implements PlanItemGroupLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanItemGroupLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanItemGroupLocalServiceUtil} to access the plan item group local service.
     */
     ...
     */
    public PlanItemGroup addPlanItemGroup(PlanItemGroup planItemGroup)
        throws SystemException {
        planItemGroup.setNew(true);

        planItemGroup = planItemGroupPersistence.update(planItemGroup, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planItemGroup);
     ...
     */
    public PlanItemGroup createPlanItemGroup(long planId) {
        return planItemGroupPersistence.create(planId);
    }
    ...
    public void deletePlanItemGroup(long planId)
        ...
        PlanItemGroup planItemGroup = planItemGroupPersistence.remove(planId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planItemGroup);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deletePlanItemGroup(PlanItemGroup planItemGroup)
        throws SystemException {
        planItemGroupPersistence.remove(planItemGroup);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return planItemGroupPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planItemGroupPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public PlanItemGroup fetchPlanItemGroup(long planId)
        throws SystemException {
        return planItemGroupPersistence.fetchByPrimaryKey(planId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public PlanItemGroup getPlanItemGroup(long planId)
        throws PortalException, SystemException {
        return planItemGroupPersistence.findByPrimaryKey(planId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planItemGroupPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<PlanItemGroup> getPlanItemGroups(int start, int end)
        throws SystemException {
        return planItemGroupPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getPlanItemGroupsCount() throws SystemException {
        return planItemGroupPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public PlanItemGroup updatePlanItemGroup(PlanItemGroup planItemGroup)
        throws SystemException {
        return updatePlanItemGroup(planItemGroup, true);
    }
    ...
    public PlanItemGroup updatePlanItemGroup(PlanItemGroup planItemGroup,
        ...
        planItemGroup = planItemGroupPersistence.update(planItemGroup, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanItemGroup",
            planItemGroupLocalService);
    }
