...
/**
 * Provides the base implementation for the plan model run remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanModelRunServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanModelRunServiceImpl
 * @see com.ext.portlet.service.PlanModelRunServiceUtil
 * @generated
 */
public abstract class PlanModelRunServiceBaseImpl extends BaseServiceImpl
    implements PlanModelRunService, IdentifiableBean {
...
>>>>>>> First steps toward lr6.2 (proposals/plansProposalFacade deploy and seem to work)
    ...
    private PlanModelRunServiceClpInvoker _clpInvoker = new PlanModelRunServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanModelRunServiceUtil} to access the plan model run remote service.
     */
