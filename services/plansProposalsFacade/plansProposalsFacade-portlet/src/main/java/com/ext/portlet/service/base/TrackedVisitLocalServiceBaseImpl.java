...
import com.ext.portlet.service.TrackedVisitLocalService;
...
/**
 * Provides the base implementation for the tracked visit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.TrackedVisitLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TrackedVisitLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements TrackedVisitLocalService,
        IdentifiableBean {
    ...
    private TrackedVisitLocalServiceClpInvoker _clpInvoker = new TrackedVisitLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.TrackedVisitLocalServiceUtil} to access the tracked visit local service.
     */
    ...
    @Override
    public TrackedVisit addTrackedVisit(TrackedVisit trackedVisit)
        throws SystemException {
        trackedVisit.setNew(true);

        return trackedVisitPersistence.update(trackedVisit);
    }
     ...
     */
    @Override
    public TrackedVisit createTrackedVisit(long id) {
        return trackedVisitPersistence.create(id);
    }
    ...
    @Override
    public TrackedVisit deleteTrackedVisit(long id)
        throws PortalException, SystemException {
        return trackedVisitPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public TrackedVisit deleteTrackedVisit(TrackedVisit trackedVisit)
        throws SystemException {
        return trackedVisitPersistence.remove(trackedVisit);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(TrackedVisit.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return trackedVisitPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return trackedVisitPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public TrackedVisit fetchTrackedVisit(long id) throws SystemException {
        return trackedVisitPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public TrackedVisit getTrackedVisit(long id)
        throws PortalException, SystemException {
        return trackedVisitPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return trackedVisitPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<TrackedVisit> getTrackedVisits(int start, int end)
        throws SystemException {
        return trackedVisitPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getTrackedVisitsCount() throws SystemException {
        return trackedVisitPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public TrackedVisit updateTrackedVisit(TrackedVisit trackedVisit)
        throws SystemException {
        return trackedVisitPersistence.update(trackedVisit);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.TrackedVisit",
            trackedVisitLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = trackedVisitPersistence.getDataSource();
