...
/**
 * The base implementation of the proposal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalLocalServiceImpl}.
 * </p>
 *
...
public abstract class ProposalLocalServiceBaseImpl
    ...
    private static Log _log = LogFactoryUtil.getLog(ProposalLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalLocalServiceUtil} to access the proposal local service.
     */
    ...
    public Proposal addProposal(Proposal proposal) throws SystemException {
        ...
        proposal = proposalPersistence.update(proposal, false);
    ...
    public void deleteProposal(long proposalId)
        ...
        Proposal proposal = proposalPersistence.remove(proposalId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposal);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteProposal(Proposal proposal) throws SystemException {
        proposalPersistence.remove(proposal);
    ...
    public Proposal updateProposal(Proposal proposal) throws SystemException {
        return updateProposal(proposal, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Proposal updateProposal(Proposal proposal, boolean merge)
        throws SystemException {
        proposal.setNew(false);

        proposal = proposalPersistence.update(proposal, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Proposal",
