...
import com.ext.portlet.service.ImpactTemplateMaxFocusAreaLocalService;
...
/**
 * Provides the base implementation for the impact template max focus area local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ImpactTemplateMaxFocusAreaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ImpactTemplateMaxFocusAreaLocalServiceImpl
 * @see com.ext.portlet.service.ImpactTemplateMaxFocusAreaLocalServiceUtil
 * @generated
 */
public abstract class ImpactTemplateMaxFocusAreaLocalServiceBaseImpl
    extends BaseLocalServiceImpl
    implements ImpactTemplateMaxFocusAreaLocalService, IdentifiableBean {
    ...
    private ImpactTemplateMaxFocusAreaLocalServiceClpInvoker _clpInvoker = new ImpactTemplateMaxFocusAreaLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ImpactTemplateMaxFocusAreaLocalServiceUtil} to access the impact template max focus area local service.
     */
    ...
    @Override
    public ImpactTemplateMaxFocusArea addImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusArea impactTemplateMaxFocusArea)
        throws SystemException {
        impactTemplateMaxFocusArea.setNew(true);

        return impactTemplateMaxFocusAreaPersistence.update(impactTemplateMaxFocusArea);
    }
     ...
     */
    @Override
    public ImpactTemplateMaxFocusArea createImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusAreaPK impactTemplateMaxFocusAreaPK) {
        return impactTemplateMaxFocusAreaPersistence.create(impactTemplateMaxFocusAreaPK);
    }
    ...
    @Override
    public ImpactTemplateMaxFocusArea deleteImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusAreaPK impactTemplateMaxFocusAreaPK)
        throws PortalException, SystemException {
        return impactTemplateMaxFocusAreaPersistence.remove(impactTemplateMaxFocusAreaPK);
    }
    ...
    public ImpactTemplateMaxFocusArea deleteImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusArea impactTemplateMaxFocusArea)
        throws SystemException {
        return impactTemplateMaxFocusAreaPersistence.remove(impactTemplateMaxFocusArea);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImpactTemplateMaxFocusArea.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactTemplateMaxFocusAreaPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactTemplateMaxFocusAreaPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImpactTemplateMaxFocusArea fetchImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusAreaPK impactTemplateMaxFocusAreaPK)
        throws SystemException {
        return impactTemplateMaxFocusAreaPersistence.fetchByPrimaryKey(impactTemplateMaxFocusAreaPK);
    }
     ...
     */
    @Override
    public ImpactTemplateMaxFocusArea getImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusAreaPK impactTemplateMaxFocusAreaPK)
        throws PortalException, SystemException {
        return impactTemplateMaxFocusAreaPersistence.findByPrimaryKey(impactTemplateMaxFocusAreaPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return impactTemplateMaxFocusAreaPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<ImpactTemplateMaxFocusArea> getImpactTemplateMaxFocusAreas(
        ...
        return impactTemplateMaxFocusAreaPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImpactTemplateMaxFocusAreasCount() throws SystemException {
        return impactTemplateMaxFocusAreaPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImpactTemplateMaxFocusArea updateImpactTemplateMaxFocusArea(
        ImpactTemplateMaxFocusArea impactTemplateMaxFocusArea)
        throws SystemException {
        return impactTemplateMaxFocusAreaPersistence.update(impactTemplateMaxFocusArea);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ImpactTemplateMaxFocusArea",
            impactTemplateMaxFocusAreaLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = impactTemplateMaxFocusAreaPersistence.getDataSource();
