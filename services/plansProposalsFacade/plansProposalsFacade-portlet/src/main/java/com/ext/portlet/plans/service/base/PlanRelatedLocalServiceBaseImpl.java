...
/**
 * The base implementation of the plan related local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanRelatedLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.plans.service.impl.PlanRelatedLocalServiceImpl
 * @see com.ext.portlet.plans.service.PlanRelatedLocalServiceUtil
 * @generated
 */
public abstract class PlanRelatedLocalServiceBaseImpl
    implements PlanRelatedLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanRelatedLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanRelatedLocalServiceUtil} to access the plan related local service.
     */
    ...
    public PlanRelated addPlanRelated(PlanRelated planRelated)
        ...
        planRelated = planRelatedPersistence.update(planRelated, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planRelated);
    ...
    public void deletePlanRelated(PlanRelatedPK planRelatedPK)
        ...
        PlanRelated planRelated = planRelatedPersistence.remove(planRelatedPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planRelated);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanRelated updatePlanRelated(PlanRelated planRelated)
        throws SystemException {
        return updatePlanRelated(planRelated, true);
    }
    ...
    public PlanRelated updatePlanRelated(PlanRelated planRelated, boolean merge)
        ...
        planRelated = planRelatedPersistence.update(planRelated, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanRelated",
            planRelatedLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanRelated");
    }
