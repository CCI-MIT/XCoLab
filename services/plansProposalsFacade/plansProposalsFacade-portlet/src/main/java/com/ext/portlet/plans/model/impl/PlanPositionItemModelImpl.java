...
import com.ext.portlet.plans.model.PlanPositionItemModel;
...
/**
 * The base model implementation for the PlanPositionItem service. Represents a row in the &quot;Plans_PlanPositionItem&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.ext.portlet.plans.model.PlanPositionItemModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PlanPositionItemImpl}.
 * </p>
 *
...
public class PlanPositionItemModelImpl extends BaseModelImpl<PlanPositionItem>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a plan position item model instance should use the {@link com.ext.portlet.plans.model.PlanPositionItem} interface instead.
     */
    public static final String TABLE_NAME = "Plans_PlanPositionItem";
    public static final Object[][] TABLE_COLUMNS = {
            { "planPositionsId", Types.BIGINT },
            { "positionId", Types.BIGINT }
        };
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanPositionItem (planPositionsId LONG not null,positionId LONG not null,primary key (planPositionsId, positionId))";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanPositionItem";
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.ext.portlet.plans.model.PlanPositionItem"),
            true);
