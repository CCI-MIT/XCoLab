...
/**
 * The base implementation of the contest local service.
 *
 * <p>
...
public abstract class ContestLocalServiceBaseImpl implements ContestLocalService,
    IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ContestLocalServiceBaseImpl.class);
    ...
    public Contest addContest(Contest contest) throws SystemException {
        ...
        contest = contestPersistence.update(contest, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(contest);
    ...
    public Contest updateContest(Contest contest) throws SystemException {
        return updateContest(contest, true);
    }
    ...
    public Contest updateContest(Contest contest, boolean merge)
        ...
        contest = contestPersistence.update(contest, merge);
