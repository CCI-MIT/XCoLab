 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContestLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements ContestLocalService, IdentifiableBean {
    ...
    private ContestLocalServiceClpInvoker _clpInvoker = new ContestLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestLocalServiceUtil} to access the contest local service.
     */
    ...
    public Contest addContest(Contest contest) throws SystemException {
        ...
        return contestPersistence.update(contest);
    }
    ...
    @Override
    public Contest deleteContest(long ContestPK)
        throws PortalException, SystemException {
        return contestPersistence.remove(ContestPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Contest deleteContest(Contest contest) throws SystemException {
        return contestPersistence.remove(contest);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Contest.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return contestPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return contestPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Contest",
            contestLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestPersistence.getDataSource();
