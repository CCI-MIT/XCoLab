...
/**
 * Provides the base implementation for the model output chart order local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelOutputChartOrderLocalServiceImpl}.
 * </p>
 *
...
public abstract class ModelOutputChartOrderLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ModelOutputChartOrderLocalService,
        IdentifiableBean {
    ...
    private ModelOutputChartOrderLocalServiceClpInvoker _clpInvoker = new ModelOutputChartOrderLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelOutputChartOrderLocalServiceUtil} to access the model output chart order local service.
     */
    ...
    @Override
    public ModelOutputChartOrder deleteModelOutputChartOrder(
        long modelOutputChartOrderPK) throws PortalException, SystemException {
        return modelOutputChartOrderPersistence.remove(modelOutputChartOrderPK);
    }
    ...
    public ModelOutputChartOrder deleteModelOutputChartOrder(
        ModelOutputChartOrder modelOutputChartOrder) throws SystemException {
        return modelOutputChartOrderPersistence.remove(modelOutputChartOrder);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ModelOutputChartOrder.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ModelOutputChartOrder",
