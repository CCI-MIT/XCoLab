...
/**
 * The base implementation of the plan section local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanSectionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanSectionLocalServiceBaseImpl
    implements PlanSectionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanSectionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanSectionLocalServiceUtil} to access the plan section local service.
     */
    ...
    public PlanSection addPlanSection(PlanSection planSection)
        ...
        planSection = planSectionPersistence.update(planSection, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planSection);
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planSectionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanSection updatePlanSection(PlanSection planSection)
        throws SystemException {
        return updatePlanSection(planSection, true);
    }
    ...
    public PlanSection updatePlanSection(PlanSection planSection, boolean merge)
        ...
        planSection = planSectionPersistence.update(planSection, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanSection",
            planSectionLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanSection");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planSectionPersistence.getDataSource();
