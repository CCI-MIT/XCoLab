...
/**
 * The base implementation of the discussion message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.discussions.service.impl.DiscussionMessageLocalServiceImpl}.
 * </p>
 *
...
public abstract class DiscussionMessageLocalServiceBaseImpl
    implements DiscussionMessageLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(DiscussionMessageLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.discussions.service.DiscussionMessageLocalServiceUtil} to access the discussion message local service.
     */
    ...
    public DiscussionMessage addDiscussionMessage(
        ...
        discussionMessage = discussionMessagePersistence.update(discussionMessage,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(discussionMessage);
    ...
    public void deleteDiscussionMessage(Long pk)
        ...
        if (indexer != null) {
            try {
                indexer.delete(discussionMessage);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return discussionMessagePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public DiscussionMessage updateDiscussionMessage(
        DiscussionMessage discussionMessage) throws SystemException {
        return updateDiscussionMessage(discussionMessage, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.discussions.model.DiscussionMessage",
            discussionMessageLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.discussions.model.DiscussionMessage");
    }
