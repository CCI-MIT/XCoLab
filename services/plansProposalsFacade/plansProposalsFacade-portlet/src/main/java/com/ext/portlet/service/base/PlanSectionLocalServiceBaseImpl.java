...
/**
 * Provides the base implementation for the plan section local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanSectionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanSectionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanSectionLocalService,
        IdentifiableBean {
    ...
    private PlanSectionLocalServiceClpInvoker _clpInvoker = new PlanSectionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanSectionLocalServiceUtil} to access the plan section local service.
     */
    ...
    public PlanSection addPlanSection(PlanSection planSection)
        ...
        return planSectionPersistence.update(planSection);
    }
    ...
    @Override
    public PlanSection deletePlanSection(long id)
        throws PortalException, SystemException {
        return planSectionPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanSection deletePlanSection(PlanSection planSection)
        throws SystemException {
        return planSectionPersistence.remove(planSection);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanSection.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanSection",
