...
/**
 * Provides the base implementation for the focus area ontology term local service.
 *
 * <p>
...
public abstract class FocusAreaOntologyTermLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements FocusAreaOntologyTermLocalService,
        IdentifiableBean {
    ...
    private FocusAreaOntologyTermLocalServiceClpInvoker _clpInvoker = new FocusAreaOntologyTermLocalServiceClpInvoker();
    ...
    @Override
    public FocusAreaOntologyTerm deleteFocusAreaOntologyTerm(
        FocusAreaOntologyTermPK focusAreaOntologyTermPK)
        throws PortalException, SystemException {
        return focusAreaOntologyTermPersistence.remove(focusAreaOntologyTermPK);
    }
    ...
    public FocusAreaOntologyTerm deleteFocusAreaOntologyTerm(
        FocusAreaOntologyTerm focusAreaOntologyTerm) throws SystemException {
        return focusAreaOntologyTermPersistence.remove(focusAreaOntologyTerm);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FocusAreaOntologyTerm.class,
