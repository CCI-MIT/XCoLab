...
/**
 * The base implementation of the focus area ontology term local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.FocusAreaOntologyTermLocalServiceImpl}.
 * </p>
 *
...
public abstract class FocusAreaOntologyTermLocalServiceBaseImpl
    implements FocusAreaOntologyTermLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(FocusAreaOntologyTermLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.FocusAreaOntologyTermLocalServiceUtil} to access the focus area ontology term local service.
     */
    ...
    public FocusAreaOntologyTerm addFocusAreaOntologyTerm(
        ...
        focusAreaOntologyTerm = focusAreaOntologyTermPersistence.update(focusAreaOntologyTerm,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(focusAreaOntologyTerm);
    ...
    public void deleteFocusAreaOntologyTerm(
        ...
        FocusAreaOntologyTerm focusAreaOntologyTerm = focusAreaOntologyTermPersistence.remove(focusAreaOntologyTermPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(focusAreaOntologyTerm);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return focusAreaOntologyTermPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public FocusAreaOntologyTerm fetchFocusAreaOntologyTerm(
        FocusAreaOntologyTermPK focusAreaOntologyTermPK)
        throws SystemException {
        return focusAreaOntologyTermPersistence.fetchByPrimaryKey(focusAreaOntologyTermPK);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return focusAreaOntologyTermPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public FocusAreaOntologyTerm updateFocusAreaOntologyTerm(
        FocusAreaOntologyTerm focusAreaOntologyTerm) throws SystemException {
        return updateFocusAreaOntologyTerm(focusAreaOntologyTerm, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.FocusAreaOntologyTerm",
            focusAreaOntologyTermLocalService);
    }
