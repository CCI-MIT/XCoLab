...
/**
 * The base model implementation for the PlanTemplate service. Represents a row in the &quot;Plans_PlanTemplate&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PlanTemplateModelImpl extends BaseModelImpl<PlanTemplate>
     ...
     */
    public static final String TABLE_NAME = "Plans_PlanTemplate";
    public static final Object[][] TABLE_COLUMNS = {
            { "id_", Types.BIGINT },
            { "name", Types.VARCHAR }
        };
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanTemplate (id_ LONG not null primary key,name VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanTemplate";
