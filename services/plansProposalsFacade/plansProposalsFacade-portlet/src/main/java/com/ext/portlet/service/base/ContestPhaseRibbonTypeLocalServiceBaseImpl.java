...
/**
 * Provides the base implementation for the contest phase ribbon type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestPhaseRibbonTypeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContestPhaseRibbonTypeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestPhaseRibbonTypeLocalService,
        IdentifiableBean {
    ...
    private ContestPhaseRibbonTypeLocalServiceClpInvoker _clpInvoker = new ContestPhaseRibbonTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestPhaseRibbonTypeLocalServiceUtil} to access the contest phase ribbon type local service.
     */
    ...
    @Override
    public ContestPhaseRibbonType addContestPhaseRibbonType(
        ContestPhaseRibbonType contestPhaseRibbonType)
        throws SystemException {
        contestPhaseRibbonType.setNew(true);

        return contestPhaseRibbonTypePersistence.update(contestPhaseRibbonType);
    }
     ...
     */
    @Override
    public ContestPhaseRibbonType createContestPhaseRibbonType(long id) {
        return contestPhaseRibbonTypePersistence.create(id);
    }
    ...
    @Override
    public ContestPhaseRibbonType deleteContestPhaseRibbonType(long id)
        throws PortalException, SystemException {
        return contestPhaseRibbonTypePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestPhaseRibbonType deleteContestPhaseRibbonType(
        ContestPhaseRibbonType contestPhaseRibbonType)
        throws SystemException {
        return contestPhaseRibbonTypePersistence.remove(contestPhaseRibbonType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestPhaseRibbonType.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestPhaseRibbonTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestPhaseRibbonTypePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ContestPhaseRibbonType fetchContestPhaseRibbonType(long id)
        throws SystemException {
        return contestPhaseRibbonTypePersistence.fetchByPrimaryKey(id);
    }
    ...
    public ContestPhaseRibbonType getContestPhaseRibbonType(long id)
        throws PortalException, SystemException {
        return contestPhaseRibbonTypePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestPhaseRibbonTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContestPhaseRibbonType> getContestPhaseRibbonTypes(int start,
        int end) throws SystemException {
        return contestPhaseRibbonTypePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContestPhaseRibbonTypesCount() throws SystemException {
        return contestPhaseRibbonTypePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContestPhaseRibbonType updateContestPhaseRibbonType(
        ContestPhaseRibbonType contestPhaseRibbonType)
        throws SystemException {
        return contestPhaseRibbonTypePersistence.update(contestPhaseRibbonType);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestPhaseRibbonType",
            contestPhaseRibbonTypeLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.ContestPhaseRibbonType");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestPhaseRibbonTypePersistence.getDataSource();
