...
/**
 * The base implementation of the contest phase ribbon type local service.
 *
 * <p>
...
public abstract class ContestPhaseRibbonTypeLocalServiceBaseImpl
    implements ContestPhaseRibbonTypeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ContestPhaseRibbonTypeLocalServiceBaseImpl.class);
    ...
    public ContestPhaseRibbonType addContestPhaseRibbonType(
        ...
        contestPhaseRibbonType = contestPhaseRibbonTypePersistence.update(contestPhaseRibbonType,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(contestPhaseRibbonType);
    ...
    public void deleteContestPhaseRibbonType(long id)
        ...
        ContestPhaseRibbonType contestPhaseRibbonType = contestPhaseRibbonTypePersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(contestPhaseRibbonType);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteContestPhaseRibbonType(
        ContestPhaseRibbonType contestPhaseRibbonType)
        throws SystemException {
        contestPhaseRibbonTypePersistence.remove(contestPhaseRibbonType);
    ...
    public ContestPhaseRibbonType updateContestPhaseRibbonType(
        ContestPhaseRibbonType contestPhaseRibbonType)
        throws SystemException {
        return updateContestPhaseRibbonType(contestPhaseRibbonType, true);
    }
