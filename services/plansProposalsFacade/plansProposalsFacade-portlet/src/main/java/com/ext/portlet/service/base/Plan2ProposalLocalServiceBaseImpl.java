...
/**
 * The base implementation of the plan2 proposal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.Plan2ProposalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.Plan2ProposalLocalServiceImpl
 * @see com.ext.portlet.service.Plan2ProposalLocalServiceUtil
 * @generated
 */
public abstract class Plan2ProposalLocalServiceBaseImpl
    implements Plan2ProposalLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(Plan2ProposalLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.Plan2ProposalLocalServiceUtil} to access the plan2 proposal local service.
     */
     ...
     */
    public Plan2Proposal addPlan2Proposal(Plan2Proposal plan2Proposal)
        throws SystemException {
        plan2Proposal.setNew(true);

        plan2Proposal = plan2ProposalPersistence.update(plan2Proposal, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(plan2Proposal);
     ...
     */
    public Plan2Proposal createPlan2Proposal(long planId) {
        return plan2ProposalPersistence.create(planId);
    }
    ...
    public void deletePlan2Proposal(long planId)
        ...
        Plan2Proposal plan2Proposal = plan2ProposalPersistence.remove(planId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(plan2Proposal);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deletePlan2Proposal(Plan2Proposal plan2Proposal)
        throws SystemException {
        plan2ProposalPersistence.remove(plan2Proposal);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return plan2ProposalPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return plan2ProposalPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Plan2Proposal fetchPlan2Proposal(long planId)
        throws SystemException {
        return plan2ProposalPersistence.fetchByPrimaryKey(planId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Plan2Proposal getPlan2Proposal(long planId)
        throws PortalException, SystemException {
        return plan2ProposalPersistence.findByPrimaryKey(planId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return plan2ProposalPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Plan2Proposal> getPlan2Proposals(int start, int end)
        throws SystemException {
        return plan2ProposalPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getPlan2ProposalsCount() throws SystemException {
        return plan2ProposalPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Plan2Proposal updatePlan2Proposal(Plan2Proposal plan2Proposal)
        throws SystemException {
        return updatePlan2Proposal(plan2Proposal, true);
    }
    ...
    public Plan2Proposal updatePlan2Proposal(Plan2Proposal plan2Proposal,
        ...
        plan2Proposal = plan2ProposalPersistence.update(plan2Proposal, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Plan2Proposal",
            plan2ProposalLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = plan2ProposalPersistence.getDataSource();
