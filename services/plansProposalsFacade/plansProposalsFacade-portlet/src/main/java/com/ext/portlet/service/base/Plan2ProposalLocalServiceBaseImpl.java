...
/**
 * Provides the base implementation for the plan2 proposal local service.
 *
 * <p>
...
public abstract class Plan2ProposalLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements Plan2ProposalLocalService,
        IdentifiableBean {
    ...
    private Plan2ProposalLocalServiceClpInvoker _clpInvoker = new Plan2ProposalLocalServiceClpInvoker();
    ...
    public Plan2Proposal addPlan2Proposal(Plan2Proposal plan2Proposal)
        ...
        return plan2ProposalPersistence.update(plan2Proposal);
    }
    ...
    @Override
    public Plan2Proposal deletePlan2Proposal(long planId)
        throws PortalException, SystemException {
        return plan2ProposalPersistence.remove(planId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Plan2Proposal deletePlan2Proposal(Plan2Proposal plan2Proposal)
        throws SystemException {
        return plan2ProposalPersistence.remove(plan2Proposal);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Plan2Proposal.class,
