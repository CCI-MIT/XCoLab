...
/**
 * Provides the base implementation for the points local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PointsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PointsLocalServiceImpl
 * @see com.ext.portlet.service.PointsLocalServiceUtil
 * @generated
 */
public abstract class PointsLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PointsLocalService, IdentifiableBean {
    ...
    private PointsLocalServiceClpInvoker _clpInvoker = new PointsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PointsLocalServiceUtil} to access the points local service.
     */

    /**
     * Adds the points to the database. Also notifies the appropriate model listeners.
     *
    ...
    @Override
    public Points addPoints(Points points) throws SystemException {
        points.setNew(true);

        return pointsPersistence.update(points);
    }
     ...
     */
    @Override
    public Points createPoints(long id) {
        return pointsPersistence.create(id);
    }

    /**
     * Deletes the points with the primary key from the database. Also notifies the appropriate model listeners.
     *
    ...
    @Override
    public Points deletePoints(long id) throws PortalException, SystemException {
        return pointsPersistence.remove(id);
    }

    /**
     * Deletes the points from the database. Also notifies the appropriate model listeners.
     *
     * @param points the points
     * @return the points that was removed
     * @throws SystemException if a system exception occurred
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Points deletePoints(Points points) throws SystemException {
        return pointsPersistence.remove(points);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Points.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return pointsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return pointsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return pointsPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Points fetchPoints(long id) throws SystemException {
        return pointsPersistence.fetchByPrimaryKey(id);
    }

    /**
     * Returns the points with the primary key.
     *
     * @param id the primary key of the points
     * @return the points
     * @throws PortalException if a points with the primary key could not be found
     ...
     */
    @Override
    public Points getPoints(long id) throws PortalException, SystemException {
        return pointsPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return pointsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Points> getPointses(int start, int end)
        throws SystemException {
        return pointsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPointsesCount() throws SystemException {
        return pointsPersistence.countAll();
    }

    /**
     * Updates the points in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
     *
     * @param points the points
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Points updatePoints(Points points) throws SystemException {
        return pointsPersistence.update(points);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Points",
            pointsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.Points");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = pointsPersistence.getDataSource();
