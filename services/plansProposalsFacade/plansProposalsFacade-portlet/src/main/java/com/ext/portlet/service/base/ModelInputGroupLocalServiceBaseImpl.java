...
/**
 * The base implementation of the model input group local service.
 *
 * <p>
...
public abstract class ModelInputGroupLocalServiceBaseImpl
    implements ModelInputGroupLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ModelInputGroupLocalServiceBaseImpl.class);
    ...
    public ModelInputGroup addModelInputGroup(ModelInputGroup modelInputGroup)
        ...
        modelInputGroup = modelInputGroupPersistence.update(modelInputGroup,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(modelInputGroup);
    ...
    public void deleteModelInputGroup(long modelInputGroupPK)
        ...
        if (indexer != null) {
            try {
                indexer.delete(modelInputGroup);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public ModelInputGroup updateModelInputGroup(
        ...
        return updateModelInputGroup(modelInputGroup, true);
    }
