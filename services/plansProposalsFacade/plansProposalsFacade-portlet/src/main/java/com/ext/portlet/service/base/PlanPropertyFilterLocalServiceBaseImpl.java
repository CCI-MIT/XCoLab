...
/**
 * The base implementation of the plan property filter local service.
 *
 * <p>
...
public abstract class PlanPropertyFilterLocalServiceBaseImpl
    implements PlanPropertyFilterLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanPropertyFilterLocalServiceBaseImpl.class);
    ...
    public PlanPropertyFilter addPlanPropertyFilter(
        ...
        planPropertyFilter = planPropertyFilterPersistence.update(planPropertyFilter,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planPropertyFilter);
    ...
    public void deletePlanPropertyFilter(long planPropertyFilterId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(planPropertyFilter);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanPropertyFilter updatePlanPropertyFilter(
        PlanPropertyFilter planPropertyFilter) throws SystemException {
        return updatePlanPropertyFilter(planPropertyFilter, true);
    }
