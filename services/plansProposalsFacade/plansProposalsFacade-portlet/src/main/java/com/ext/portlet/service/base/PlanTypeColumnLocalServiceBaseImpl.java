...
/**
 * The base implementation of the plan type column local service.
 *
 * <p>
...
public abstract class PlanTypeColumnLocalServiceBaseImpl
    implements PlanTypeColumnLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanTypeColumnLocalServiceBaseImpl.class);
    ...
    public PlanTypeColumn addPlanTypeColumn(PlanTypeColumn planTypeColumn)
        ...
        planTypeColumn = planTypeColumnPersistence.update(planTypeColumn, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planTypeColumn);
    ...
    public PlanTypeColumn updatePlanTypeColumn(PlanTypeColumn planTypeColumn)
        throws SystemException {
        return updatePlanTypeColumn(planTypeColumn, true);
    }
    ...
    public PlanTypeColumn updatePlanTypeColumn(PlanTypeColumn planTypeColumn,
        ...
        planTypeColumn = planTypeColumnPersistence.update(planTypeColumn, merge);
