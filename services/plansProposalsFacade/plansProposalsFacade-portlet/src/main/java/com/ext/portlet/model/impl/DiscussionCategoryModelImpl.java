...
import com.ext.portlet.model.DiscussionCategoryModel;
import com.ext.portlet.model.DiscussionCategorySoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.ext.portlet.model.DiscussionCategoryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DiscussionCategoryImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see DiscussionCategoryImpl
 * @see com.ext.portlet.model.DiscussionCategory
 * @see com.ext.portlet.model.DiscussionCategoryModel
 * @generated
 */
@JSON(strict = true)
public class DiscussionCategoryModelImpl extends BaseModelImpl<DiscussionCategory>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a discussion category model instance should use the {@link com.ext.portlet.model.DiscussionCategory} interface instead.
     */
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_DiscussionCategory (pk LONG not null primary key,categoryId LONG,categoryGroupId LONG,authorId LONG,name VARCHAR(1024) null,description TEXT null,createDate DATE null,deleted DATE null,threadsCount INTEGER,lastActivityDate DATE null,lastActivityAuthorId LONG)";
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.ext.portlet.model.DiscussionCategory"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.ext.portlet.model.DiscussionCategory"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.ext.portlet.model.DiscussionCategory"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.ext.portlet.model.DiscussionCategory"));
    ...
    private DiscussionCategory _escapedModel;
    ...
    public DiscussionCategory toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (DiscussionCategory) ProxyUtil.newProxyInstance(_classLoader,
