...
import com.ext.portlet.service.BalloonTextLocalService;
...
/**
 * Provides the base implementation for the balloon text local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.BalloonTextLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BalloonTextLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements BalloonTextLocalService,
        IdentifiableBean {
    ...
    private BalloonTextLocalServiceClpInvoker _clpInvoker = new BalloonTextLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.BalloonTextLocalServiceUtil} to access the balloon text local service.
     */
    ...
    @Override
    public BalloonText addBalloonText(BalloonText balloonText)
        throws SystemException {
        balloonText.setNew(true);

        return balloonTextPersistence.update(balloonText);
    }
     ...
     */
    @Override
    public BalloonText createBalloonText(long id) {
        return balloonTextPersistence.create(id);
    }
    ...
    @Override
    public BalloonText deleteBalloonText(long id)
        throws PortalException, SystemException {
        return balloonTextPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public BalloonText deleteBalloonText(BalloonText balloonText)
        throws SystemException {
        return balloonTextPersistence.remove(balloonText);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(BalloonText.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonTextPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return balloonTextPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonTextPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public BalloonText fetchBalloonText(long id) throws SystemException {
        return balloonTextPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public BalloonText getBalloonText(long id)
        throws PortalException, SystemException {
        return balloonTextPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return balloonTextPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<BalloonText> getBalloonTexts(int start, int end)
        throws SystemException {
        return balloonTextPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBalloonTextsCount() throws SystemException {
        return balloonTextPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public BalloonText updateBalloonText(BalloonText balloonText)
        throws SystemException {
        return balloonTextPersistence.update(balloonText);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.BalloonText",
            balloonTextLocalService);
    }
