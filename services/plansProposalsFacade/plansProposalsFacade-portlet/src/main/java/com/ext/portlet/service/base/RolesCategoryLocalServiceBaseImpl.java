...
import com.ext.portlet.service.RolesCategoryLocalService;
...
/**
 * Provides the base implementation for the roles category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.RolesCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.RolesCategoryLocalServiceImpl
 * @see com.ext.portlet.service.RolesCategoryLocalServiceUtil
 * @generated
 */
public abstract class RolesCategoryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements RolesCategoryLocalService,
        IdentifiableBean {
    ...
    private RolesCategoryLocalServiceClpInvoker _clpInvoker = new RolesCategoryLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.RolesCategoryLocalServiceUtil} to access the roles category local service.
     */
    ...
    @Override
    public RolesCategory addRolesCategory(RolesCategory rolesCategory)
        throws SystemException {
        rolesCategory.setNew(true);

        return rolesCategoryPersistence.update(rolesCategory);
    }
     ...
     */
    @Override
    public RolesCategory createRolesCategory(long roleId) {
        return rolesCategoryPersistence.create(roleId);
    }
    ...
    @Override
    public RolesCategory deleteRolesCategory(long roleId)
        throws PortalException, SystemException {
        return rolesCategoryPersistence.remove(roleId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public RolesCategory deleteRolesCategory(RolesCategory rolesCategory)
        throws SystemException {
        return rolesCategoryPersistence.remove(rolesCategory);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(RolesCategory.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return rolesCategoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return rolesCategoryPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public RolesCategory fetchRolesCategory(long roleId)
        throws SystemException {
        return rolesCategoryPersistence.fetchByPrimaryKey(roleId);
    }
     ...
     */
    @Override
    public RolesCategory getRolesCategory(long roleId)
        throws PortalException, SystemException {
        return rolesCategoryPersistence.findByPrimaryKey(roleId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return rolesCategoryPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<RolesCategory> getRolesCategories(int start, int end)
        throws SystemException {
        return rolesCategoryPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getRolesCategoriesCount() throws SystemException {
        return rolesCategoryPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public RolesCategory updateRolesCategory(RolesCategory rolesCategory)
        throws SystemException {
        return rolesCategoryPersistence.update(rolesCategory);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.RolesCategory",
            rolesCategoryLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.RolesCategory");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = rolesCategoryPersistence.getDataSource();
