...
/**
 * The base implementation of the email list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.EmailListLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class EmailListLocalServiceBaseImpl
    implements EmailListLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(EmailListLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.EmailListLocalServiceUtil} to access the email list local service.
     */
     ...
     */
    public EmailList addEmailList(EmailList emailList)
        throws SystemException {
        emailList.setNew(true);

        emailList = emailListPersistence.update(emailList, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(emailList);
     ...
     */
    public EmailList createEmailList(long id) {
        return emailListPersistence.create(id);
    }
    ...
    public void deleteEmailList(long id)
        ...
        EmailList emailList = emailListPersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(emailList);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteEmailList(EmailList emailList) throws SystemException {
        emailListPersistence.remove(emailList);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return emailListPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return emailListPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return emailListPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public EmailList fetchEmailList(long id) throws SystemException {
        return emailListPersistence.fetchByPrimaryKey(id);
    }
    ...
    public EmailList getEmailList(long id)
        throws PortalException, SystemException {
        return emailListPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return emailListPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<EmailList> getEmailLists(int start, int end)
        throws SystemException {
        return emailListPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getEmailListsCount() throws SystemException {
        return emailListPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public EmailList updateEmailList(EmailList emailList)
        throws SystemException {
        return updateEmailList(emailList, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public EmailList updateEmailList(EmailList emailList, boolean merge)
        throws SystemException {
        emailList.setNew(false);

        emailList = emailListPersistence.update(emailList, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.EmailList",
            emailListLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.EmailList");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = emailListPersistence.getDataSource();
