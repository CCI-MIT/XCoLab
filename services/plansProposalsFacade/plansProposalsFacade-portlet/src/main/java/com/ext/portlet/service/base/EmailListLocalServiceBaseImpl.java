...
/**
 * Provides the base implementation for the email list local service.
 *
 * <p>
 ...
 * @generated
 */
public abstract class EmailListLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    private EmailListLocalServiceClpInvoker _clpInvoker = new EmailListLocalServiceClpInvoker();
    ...
    public EmailList addEmailList(EmailList emailList)
        ...
        return emailListPersistence.update(emailList);
    }
    ...
    @Override
    public EmailList deleteEmailList(long id)
        throws PortalException, SystemException {
        return emailListPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public EmailList deleteEmailList(EmailList emailList)
        throws SystemException {
        return emailListPersistence.remove(emailList);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(EmailList.class,
