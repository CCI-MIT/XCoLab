...
/**
 * The base implementation of the ontology term entity local service.
 *
 * <p>
...
public abstract class OntologyTermEntityLocalServiceBaseImpl
    implements OntologyTermEntityLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(OntologyTermEntityLocalServiceBaseImpl.class);
    ...
    public OntologyTermEntity addOntologyTermEntity(
        ...
        ontologyTermEntity = ontologyTermEntityPersistence.update(ontologyTermEntity,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(ontologyTermEntity);
    ...
    public void deleteOntologyTermEntity(long id)
        ...
        OntologyTermEntity ontologyTermEntity = ontologyTermEntityPersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(ontologyTermEntity);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public OntologyTermEntity updateOntologyTermEntity(
        OntologyTermEntity ontologyTermEntity) throws SystemException {
        return updateOntologyTermEntity(ontologyTermEntity, true);
    }
