...
/**
 * Provides the base implementation for the ontology term entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.OntologyTermEntityLocalServiceImpl}.
 * </p>
 *
...
public abstract class OntologyTermEntityLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements OntologyTermEntityLocalService,
        IdentifiableBean {
    ...
    private OntologyTermEntityLocalServiceClpInvoker _clpInvoker = new OntologyTermEntityLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.OntologyTermEntityLocalServiceUtil} to access the ontology term entity local service.
     */
    ...
    public OntologyTermEntity addOntologyTermEntity(
        ...
        return ontologyTermEntityPersistence.update(ontologyTermEntity);
    }
    ...
    @Override
    public OntologyTermEntity deleteOntologyTermEntity(long id)
        throws PortalException, SystemException {
        return ontologyTermEntityPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public OntologyTermEntity deleteOntologyTermEntity(
        OntologyTermEntity ontologyTermEntity) throws SystemException {
        return ontologyTermEntityPersistence.remove(ontologyTermEntity);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(OntologyTermEntity.class,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ontologyTermEntityPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public OntologyTermEntity fetchOntologyTermEntity(long id)
        throws SystemException {
        return ontologyTermEntityPersistence.fetchByPrimaryKey(id);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ontologyTermEntityPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.OntologyTermEntity",
            ontologyTermEntityLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ontologyTermEntityPersistence.getDataSource();
