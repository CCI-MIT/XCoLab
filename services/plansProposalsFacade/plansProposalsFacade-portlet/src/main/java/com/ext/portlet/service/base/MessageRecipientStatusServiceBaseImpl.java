...
/**
 * Provides the base implementation for the message recipient status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessageRecipientStatusServiceImpl}.
 * </p>
 *
...
public abstract class MessageRecipientStatusServiceBaseImpl
    extends BaseServiceImpl implements MessageRecipientStatusService,
        IdentifiableBean {
    ...
    private MessageRecipientStatusServiceClpInvoker _clpInvoker = new MessageRecipientStatusServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessageRecipientStatusServiceUtil} to access the message recipient status remote service.
     */
