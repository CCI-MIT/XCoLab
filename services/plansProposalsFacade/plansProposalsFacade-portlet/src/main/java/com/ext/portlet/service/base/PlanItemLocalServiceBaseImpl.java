...
/**
 * Provides the base implementation for the plan item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanItemLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanItemLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PlanItemLocalService, IdentifiableBean {
    ...
    private PlanItemLocalServiceClpInvoker _clpInvoker = new PlanItemLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanItemLocalServiceUtil} to access the plan item local service.
     */
    ...
    public PlanItem addPlanItem(PlanItem planItem) throws SystemException {
        ...
        return planItemPersistence.update(planItem);
    }
    ...
    @Override
    public PlanItem deletePlanItem(long id)
        throws PortalException, SystemException {
        return planItemPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanItem deletePlanItem(PlanItem planItem) throws SystemException {
        return planItemPersistence.remove(planItem);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanItem.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return planItemPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planItemPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanItem",
            planItemLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planItemPersistence.getDataSource();
