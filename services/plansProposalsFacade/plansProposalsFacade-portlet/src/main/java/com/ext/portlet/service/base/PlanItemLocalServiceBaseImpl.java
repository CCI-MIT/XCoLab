...
/**
 * The base implementation of the plan item local service.
 *
 * <p>
...
public abstract class PlanItemLocalServiceBaseImpl
    ...
    private static Log _log = LogFactoryUtil.getLog(PlanItemLocalServiceBaseImpl.class);
    ...
    public PlanItem addPlanItem(PlanItem planItem) throws SystemException {
        ...
        planItem = planItemPersistence.update(planItem, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planItem);
    ...
    public PlanItem updatePlanItem(PlanItem planItem) throws SystemException {
        return updatePlanItem(planItem, true);
    }
    ...
    public PlanItem updatePlanItem(PlanItem planItem, boolean merge)
        ...
        planItem = planItemPersistence.update(planItem, merge);
