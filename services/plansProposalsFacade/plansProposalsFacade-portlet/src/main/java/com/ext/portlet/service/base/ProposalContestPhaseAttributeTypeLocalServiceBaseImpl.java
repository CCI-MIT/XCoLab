...
public abstract class ProposalContestPhaseAttributeTypeLocalServiceBaseImpl
    ...
    public ProposalContestPhaseAttributeType createProposalContestPhaseAttributeType(
        long id) {
        return proposalContestPhaseAttributeTypePersistence.create(id);
    }
    ...
    public void deleteProposalContestPhaseAttributeType(long id)
        ...
        ProposalContestPhaseAttributeType proposalContestPhaseAttributeType = proposalContestPhaseAttributeTypePersistence.remove(id);
    ...
    public ProposalContestPhaseAttributeType fetchProposalContestPhaseAttributeType(
        ...
        return proposalContestPhaseAttributeTypePersistence.fetchByPrimaryKey(id);
    }
    ...
    public ProposalContestPhaseAttributeType getProposalContestPhaseAttributeType(
        ...
        return proposalContestPhaseAttributeTypePersistence.findByPrimaryKey(id);
    }
