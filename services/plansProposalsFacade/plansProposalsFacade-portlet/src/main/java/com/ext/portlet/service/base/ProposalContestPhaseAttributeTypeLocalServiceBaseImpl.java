...
/**
 * The base implementation of the proposal contest phase attribute type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalContestPhaseAttributeTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ProposalContestPhaseAttributeTypeLocalServiceImpl
 * @see com.ext.portlet.service.ProposalContestPhaseAttributeTypeLocalServiceUtil
 * @generated
 */
public abstract class ProposalContestPhaseAttributeTypeLocalServiceBaseImpl
    implements ProposalContestPhaseAttributeTypeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalContestPhaseAttributeTypeLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalContestPhaseAttributeTypeLocalServiceUtil} to access the proposal contest phase attribute type local service.
     */
     ...
     */
    public ProposalContestPhaseAttributeType addProposalContestPhaseAttributeType(
        ProposalContestPhaseAttributeType proposalContestPhaseAttributeType)
        throws SystemException {
        proposalContestPhaseAttributeType.setNew(true);

        proposalContestPhaseAttributeType = proposalContestPhaseAttributeTypePersistence.update(proposalContestPhaseAttributeType,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(proposalContestPhaseAttributeType);
     ...
     */
    public ProposalContestPhaseAttributeType createProposalContestPhaseAttributeType(
        String name) {
        return proposalContestPhaseAttributeTypePersistence.create(name);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalContestPhaseAttributeType(String name)
        throws PortalException, SystemException {
        ProposalContestPhaseAttributeType proposalContestPhaseAttributeType = proposalContestPhaseAttributeTypePersistence.remove(name);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposalContestPhaseAttributeType);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteProposalContestPhaseAttributeType(
        ProposalContestPhaseAttributeType proposalContestPhaseAttributeType)
        throws SystemException {
        proposalContestPhaseAttributeTypePersistence.remove(proposalContestPhaseAttributeType);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalContestPhaseAttributeTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalContestPhaseAttributeTypePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ProposalContestPhaseAttributeType fetchProposalContestPhaseAttributeType(
        String name) throws SystemException {
        return proposalContestPhaseAttributeTypePersistence.fetchByPrimaryKey(name);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalContestPhaseAttributeType getProposalContestPhaseAttributeType(
        String name) throws PortalException, SystemException {
        return proposalContestPhaseAttributeTypePersistence.findByPrimaryKey(name);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalContestPhaseAttributeTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<ProposalContestPhaseAttributeType> getProposalContestPhaseAttributeTypes(
        int start, int end) throws SystemException {
        return proposalContestPhaseAttributeTypePersistence.findAll(start, end);
    }
    ...
    public int getProposalContestPhaseAttributeTypesCount()
        throws SystemException {
        return proposalContestPhaseAttributeTypePersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalContestPhaseAttributeType updateProposalContestPhaseAttributeType(
        ProposalContestPhaseAttributeType proposalContestPhaseAttributeType)
        throws SystemException {
        return updateProposalContestPhaseAttributeType(proposalContestPhaseAttributeType,
            true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalContestPhaseAttributeType",
            proposalContestPhaseAttributeTypeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalContestPhaseAttributeTypePersistence.getDataSource();
