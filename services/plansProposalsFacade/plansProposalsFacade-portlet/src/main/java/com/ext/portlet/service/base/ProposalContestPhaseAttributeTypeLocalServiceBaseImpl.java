...
/**
 * Provides the base implementation for the proposal contest phase attribute type local service.
 *
 * <p>
...
public abstract class ProposalContestPhaseAttributeTypeLocalServiceBaseImpl
    ...
    private ProposalContestPhaseAttributeTypeLocalServiceClpInvoker _clpInvoker = new ProposalContestPhaseAttributeTypeLocalServiceClpInvoker();
    ...
    public ProposalContestPhaseAttributeType addProposalContestPhaseAttributeType(
        ...
        return proposalContestPhaseAttributeTypePersistence.update(proposalContestPhaseAttributeType);
    }
    ...
    @Override
    public ProposalContestPhaseAttributeType deleteProposalContestPhaseAttributeType(
        String name) throws PortalException, SystemException {
        return proposalContestPhaseAttributeTypePersistence.remove(name);
    }
    ...
    public ProposalContestPhaseAttributeType deleteProposalContestPhaseAttributeType(
        ProposalContestPhaseAttributeType proposalContestPhaseAttributeType)
        throws SystemException {
        return proposalContestPhaseAttributeTypePersistence.remove(proposalContestPhaseAttributeType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalContestPhaseAttributeType.class,
