...
/**
 * The base model implementation for the PlanColumnSettings service. Represents a row in the &quot;Plans_PlanColumnSettings&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PlanColumnSettingsModelImpl extends BaseModelImpl<PlanColumnSettings>
     ...
     */
    public static final String TABLE_NAME = "Plans_PlanColumnSettings";
    ...
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanColumnSettings (planColumnSettingsId LONG not null primary key,columnName VARCHAR(75) null,planUserSettingsId LONG,visible BOOLEAN)";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanColumnSettings";
