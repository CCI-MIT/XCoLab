...
import com.ext.portlet.service.ProposalMoveHistoryLocalService;
...
/**
 * Provides the base implementation for the proposal move history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalMoveHistoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalMoveHistoryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalMoveHistoryLocalService,
        IdentifiableBean {
    ...
    private ProposalMoveHistoryLocalServiceClpInvoker _clpInvoker = new ProposalMoveHistoryLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalMoveHistoryLocalServiceUtil} to access the proposal move history local service.
     */
    ...
    @Override
    public ProposalMoveHistory addProposalMoveHistory(
        ProposalMoveHistory proposalMoveHistory) throws SystemException {
        proposalMoveHistory.setNew(true);

        return proposalMoveHistoryPersistence.update(proposalMoveHistory);
    }
     ...
     */
    @Override
    public ProposalMoveHistory createProposalMoveHistory(long id_) {
        return proposalMoveHistoryPersistence.create(id_);
    }
    ...
    @Override
    public ProposalMoveHistory deleteProposalMoveHistory(long id_)
        throws PortalException, SystemException {
        return proposalMoveHistoryPersistence.remove(id_);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProposalMoveHistory deleteProposalMoveHistory(
        ProposalMoveHistory proposalMoveHistory) throws SystemException {
        return proposalMoveHistoryPersistence.remove(proposalMoveHistory);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalMoveHistory.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return proposalMoveHistoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalMoveHistoryPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProposalMoveHistory fetchProposalMoveHistory(long id_)
        throws SystemException {
        return proposalMoveHistoryPersistence.fetchByPrimaryKey(id_);
    }
     ...
     */
    @Override
    public ProposalMoveHistory getProposalMoveHistory(long id_)
        throws PortalException, SystemException {
        return proposalMoveHistoryPersistence.findByPrimaryKey(id_);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalMoveHistoryPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalMoveHistory> getProposalMoveHistories(int start, int end)
        throws SystemException {
        return proposalMoveHistoryPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalMoveHistoriesCount() throws SystemException {
        return proposalMoveHistoryPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalMoveHistory updateProposalMoveHistory(
        ProposalMoveHistory proposalMoveHistory) throws SystemException {
        return proposalMoveHistoryPersistence.update(proposalMoveHistory);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalMoveHistory",
            proposalMoveHistoryLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalMoveHistoryPersistence.getDataSource();
