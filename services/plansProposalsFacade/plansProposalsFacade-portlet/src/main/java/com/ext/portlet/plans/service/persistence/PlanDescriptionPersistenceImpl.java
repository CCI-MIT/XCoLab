...
public class PlanDescriptionPersistenceImpl extends BasePersistenceImpl<PlanDescription>
    ...
    public static final FinderPath FINDER_PATH_FETCH_BY_PLANIDPLANVERSION = new FinderPath(PlanDescriptionModelImpl.ENTITY_CACHE_ENABLED,
            PlanDescriptionModelImpl.FINDER_CACHE_ENABLED,
            PlanDescriptionImpl.class, FINDER_CLASS_NAME_ENTITY,
            "fetchByPlanIdPlanVersion",
            new String[] { Long.class.getName(), Long.class.getName() },
            PlanDescriptionModelImpl.PLANID_COLUMN_BITMASK |
            PlanDescriptionModelImpl.PLANVERSION_COLUMN_BITMASK);
    ...
    public void cacheResult(PlanDescription planDescription) {
        ...
        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CURRENTBYPLANID,
            new Object[] { Long.valueOf(planDescription.getPlanId()) },
            planDescription);

        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_PLANIDPLANVERSION,
            new Object[] {
                Long.valueOf(planDescription.getPlanId()),
                Long.valueOf(planDescription.getPlanVersion())
            }, planDescription);
    ...
    protected PlanDescription removeImpl(PlanDescription planDescription)
        ...
        try {
            ...
            BatchSessionUtil.delete(session, planDescription);
        } catch (Exception e) {
            throw processException(e);
        } finally {
            closeSession(session);
    ...
    public PlanDescription updateImpl(
        ...
        if (isNew || !PlanDescriptionModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((planDescriptionModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        Long.valueOf(planDescriptionModelImpl.getOriginalPlanId())
                    };
                ...
                args = new Object[] {
                        Long.valueOf(planDescriptionModelImpl.getPlanId())
                    };
        ...
        if (isNew) {
            ...
            if ((planDescriptionModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        Long.valueOf(planDescriptionModelImpl.getOriginalPlanId()),
                        Long.valueOf(planDescriptionModelImpl.getOriginalPlanVersion())
                    };
     ...
     * @throws com.liferay.portal.NoSuchModelException if a plan description with the primary key could not be found
     * @throws SystemException if a system exception occurred
     */
    @Override
        ...
        if (planDescription == null) {
            ...
            try {
                ...
                if (planDescription != null) {
                    ...
                    EntityCacheUtil.putResult(PlanDescriptionModelImpl.ENTITY_CACHE_ENABLED,
                        PlanDescriptionImpl.class, id, _nullPlanDescription);
                }
        ...
        if (result == null) {
            ...
            try {
                ...
                if (list.isEmpty()) {
                    ...
                    if ((planDescription.getPlanId() != planId) ||
                            (planDescription.getPlanVersion() != planVersion)) {
                        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_PLANIDPLANVERSION,
                            finderArgs, planDescription);
                    }
                }
    ...
    public List<PlanDescription> findAll(int start, int end,
        ...
        if (list == null) {
            ...
            if (orderByComparator != null) {
                ...
                sql = _SQL_SELECT_PLANDESCRIPTION.concat(PlanDescriptionModelImpl.ORDER_BY_JPQL);
            }
