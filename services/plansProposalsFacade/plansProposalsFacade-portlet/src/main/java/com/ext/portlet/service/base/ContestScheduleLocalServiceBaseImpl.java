...
/**
 * Provides the base implementation for the contest schedule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestScheduleLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContestScheduleLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestScheduleLocalService,
        IdentifiableBean {
    ...
    private ContestScheduleLocalServiceClpInvoker _clpInvoker = new ContestScheduleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestScheduleLocalServiceUtil} to access the contest schedule local service.
     */
    ...
    @Override
    public ContestSchedule addContestSchedule(ContestSchedule contestSchedule)
        throws SystemException {
        contestSchedule.setNew(true);

        return contestSchedulePersistence.update(contestSchedule);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestSchedule deleteContestSchedule(
        ContestSchedule contestSchedule) throws SystemException {
        return contestSchedulePersistence.remove(contestSchedule);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestSchedule.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestSchedulePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestSchedulePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestSchedulePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContestSchedule> getContestSchedules(int start, int end)
        throws SystemException {
        return contestSchedulePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContestSchedulesCount() throws SystemException {
        return contestSchedulePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContestSchedule updateContestSchedule(
        ContestSchedule contestSchedule) throws SystemException {
        return contestSchedulePersistence.update(contestSchedule);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestSchedule",
            contestScheduleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestSchedulePersistence.getDataSource();
