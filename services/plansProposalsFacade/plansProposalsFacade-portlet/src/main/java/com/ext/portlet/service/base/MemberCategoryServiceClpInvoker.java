 ...
 * @generated
 */
public class MemberCategoryServiceClpInvoker {
    private String _methodName508;
    private String[] _methodParameterTypes508;
    private String _methodName509;
    private String[] _methodParameterTypes509;

    public MemberCategoryServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName508.equals(name) &&
            ...
            return MemberCategoryServiceUtil.getBeanIdentifier();
        }

        if (_methodName509.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes509, parameterTypes)) {
            MemberCategoryServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
