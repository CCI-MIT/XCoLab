...
/**
 * The base implementation of the plan type attribute local service.
 *
 * <p>
...
public abstract class PlanTypeAttributeLocalServiceBaseImpl
    implements PlanTypeAttributeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanTypeAttributeLocalServiceBaseImpl.class);
    ...
    public PlanTypeAttribute addPlanTypeAttribute(
        ...
        planTypeAttribute = planTypeAttributePersistence.update(planTypeAttribute,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planTypeAttribute);
    ...
    public void deletePlanTypeAttribute(long planTypeAttributeId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(planTypeAttribute);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanTypeAttribute updatePlanTypeAttribute(
        PlanTypeAttribute planTypeAttribute) throws SystemException {
        return updatePlanTypeAttribute(planTypeAttribute, true);
    }
