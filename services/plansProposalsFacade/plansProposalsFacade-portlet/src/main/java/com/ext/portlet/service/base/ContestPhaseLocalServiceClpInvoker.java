...
public class ContestPhaseLocalServiceClpInvoker {
    ...
    public ContestPhaseLocalServiceClpInvoker() {
        ...
        _methodName675 = "getPhasesForContestSchedule";

        _methodParameterTypes675 = new String[] { "long", "long" };

        _methodName676 = "getActivePhaseForContest";

        _methodParameterTypes676 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName677 = "getContest";

        _methodParameterTypes677 = new String[] {
                "com.ext.portlet.model.ContestPhase"
            };

        _methodName678 = "getName";

        _methodParameterTypes678 = new String[] {
                "com.ext.portlet.model.ContestPhase"
            };

        _methodName679 = "promoteProposal";

        _methodParameterTypes679 = new String[] { "long", "long", "long" };

        _methodName680 = "autoPromoteProposals";

        _methodParameterTypes680 = new String[] {  };

        _methodName681 = "createFromContestPhase";

        _methodParameterTypes681 = new String[] {
                "com.ext.portlet.model.ContestPhase"
            };

        _methodName685 = "forcePromotionOfProposalInPhase";
        ...
        _methodName686 = "getNumberOfProposalsForJudge";
