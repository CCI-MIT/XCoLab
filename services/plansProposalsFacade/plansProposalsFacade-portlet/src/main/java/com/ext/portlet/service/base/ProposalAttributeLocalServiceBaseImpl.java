...
/**
 * The base implementation of the proposal attribute local service.
 *
 * <p>
...
public abstract class ProposalAttributeLocalServiceBaseImpl
    implements ProposalAttributeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalAttributeLocalServiceBaseImpl.class);
    ...
    public ProposalAttribute addProposalAttribute(
        ...
        proposalAttribute = proposalAttributePersistence.update(proposalAttribute,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(proposalAttribute);
    ...
    public void deleteProposalAttribute(long id)
        ...
        if (indexer != null) {
            try {
                indexer.delete(proposalAttribute);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalAttribute(ProposalAttribute proposalAttribute)
        throws SystemException {
        proposalAttributePersistence.remove(proposalAttribute);
    ...
    public ProposalAttribute updateProposalAttribute(
        ProposalAttribute proposalAttribute) throws SystemException {
        return updateProposalAttribute(proposalAttribute, true);
    }
