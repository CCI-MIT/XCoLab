...
/**
 * Provides the base implementation for the proposal attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalAttributeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalAttributeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalAttributeLocalService,
        IdentifiableBean {
    ...
    private ProposalAttributeLocalServiceClpInvoker _clpInvoker = new ProposalAttributeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalAttributeLocalServiceUtil} to access the proposal attribute local service.
     */
    ...
    @Override
    public ProposalAttribute addProposalAttribute(
        ProposalAttribute proposalAttribute) throws SystemException {
        proposalAttribute.setNew(true);

        return proposalAttributePersistence.update(proposalAttribute);
    }
    ...
    @Override
    public ProposalAttribute deleteProposalAttribute(long id)
        throws PortalException, SystemException {
        return proposalAttributePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProposalAttribute deleteProposalAttribute(
        ProposalAttribute proposalAttribute) throws SystemException {
        return proposalAttributePersistence.remove(proposalAttribute);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalAttribute.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return proposalAttributePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalAttributePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalAttribute> getProposalAttributes(int start, int end)
        throws SystemException {
        return proposalAttributePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalAttributesCount() throws SystemException {
        return proposalAttributePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalAttribute updateProposalAttribute(
        ProposalAttribute proposalAttribute) throws SystemException {
        return proposalAttributePersistence.update(proposalAttribute);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalAttribute",
            proposalAttributeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalAttributePersistence.getDataSource();
