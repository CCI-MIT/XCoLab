...
/**
 * The base implementation of the plan attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanAttributeLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanAttributeLocalServiceBaseImpl
    implements PlanAttributeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanAttributeLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanAttributeLocalServiceUtil} to access the plan attribute local service.
     */
    ...
    public PlanAttribute addPlanAttribute(PlanAttribute planAttribute)
        ...
        planAttribute = planAttributePersistence.update(planAttribute, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planAttribute);
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planAttributePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanAttribute updatePlanAttribute(PlanAttribute planAttribute)
        throws SystemException {
        return updatePlanAttribute(planAttribute, true);
    }
    ...
    public PlanAttribute updatePlanAttribute(PlanAttribute planAttribute,
        ...
        planAttribute = planAttributePersistence.update(planAttribute, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanAttribute",
            planAttributeLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanAttribute");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planAttributePersistence.getDataSource();
