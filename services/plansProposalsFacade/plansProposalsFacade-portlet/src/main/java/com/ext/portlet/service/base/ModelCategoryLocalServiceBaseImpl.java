...
/**
 * Provides the base implementation for the model category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelCategoryLocalServiceImpl}.
 * </p>
 *
...
public abstract class ModelCategoryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ModelCategoryLocalService,
        IdentifiableBean {
    ...
    private ModelCategoryLocalServiceClpInvoker _clpInvoker = new ModelCategoryLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelCategoryLocalServiceUtil} to access the model category local service.
     */
    ...
    public ModelCategory addModelCategory(ModelCategory modelCategory)
        ...
        return modelCategoryPersistence.update(modelCategory);
    }
    ...
    @Override
    public ModelCategory deleteModelCategory(long modelCategoryPK)
        throws PortalException, SystemException {
        return modelCategoryPersistence.remove(modelCategoryPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ModelCategory deleteModelCategory(ModelCategory modelCategory)
        throws SystemException {
        return modelCategoryPersistence.remove(modelCategory);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ModelCategory.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ModelCategory",
