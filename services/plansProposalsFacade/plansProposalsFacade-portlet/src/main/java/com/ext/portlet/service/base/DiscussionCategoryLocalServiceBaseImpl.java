...
/**
 * The base implementation of the discussion category local service.
 *
 * <p>
...
public abstract class DiscussionCategoryLocalServiceBaseImpl
    implements DiscussionCategoryLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(DiscussionCategoryLocalServiceBaseImpl.class);
    ...
    public DiscussionCategory addDiscussionCategory(
        ...
        discussionCategory = discussionCategoryPersistence.update(discussionCategory,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(discussionCategory);
    ...
    public void deleteDiscussionCategory(long pk)
        ...
        if (indexer != null) {
            try {
                indexer.delete(discussionCategory);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public DiscussionCategory updateDiscussionCategory(
        DiscussionCategory discussionCategory) throws SystemException {
        return updateDiscussionCategory(discussionCategory, true);
    }
