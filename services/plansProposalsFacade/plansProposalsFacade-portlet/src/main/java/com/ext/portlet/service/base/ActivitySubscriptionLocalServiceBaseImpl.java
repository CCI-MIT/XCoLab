...
/**
 * The base implementation of the activity subscription local service.
 *
 * <p>
...
public abstract class ActivitySubscriptionLocalServiceBaseImpl
    implements ActivitySubscriptionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ActivitySubscriptionLocalServiceBaseImpl.class);
    ...
    public ActivitySubscription addActivitySubscription(
        ...
        activitySubscription = activitySubscriptionPersistence.update(activitySubscription,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(activitySubscription);
    ...
    public void deleteActivitySubscription(long pk)
        ...
        if (indexer != null) {
            try {
                indexer.delete(activitySubscription);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public ActivitySubscription updateActivitySubscription(
        ActivitySubscription activitySubscription) throws SystemException {
        return updateActivitySubscription(activitySubscription, true);
    }
