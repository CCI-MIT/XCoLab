...
/**
 * Provides the base implementation for the proposal supporter local service.
 *
 * <p>
...
public abstract class ProposalSupporterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalSupporterLocalService,
        IdentifiableBean {
    ...
    private ProposalSupporterLocalServiceClpInvoker _clpInvoker = new ProposalSupporterLocalServiceClpInvoker();
    ...
    public ProposalSupporter addProposalSupporter(
        ...
        return proposalSupporterPersistence.update(proposalSupporter);
    }
    ...
    @Override
    public ProposalSupporter deleteProposalSupporter(
        ProposalSupporterPK proposalSupporterPK)
        throws PortalException, SystemException {
        return proposalSupporterPersistence.remove(proposalSupporterPK);
    }
    ...
    public ProposalSupporter deleteProposalSupporter(
        ProposalSupporter proposalSupporter) throws SystemException {
        return proposalSupporterPersistence.remove(proposalSupporter);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalSupporter.class,
