...
/**
 * The base implementation of the proposal supporter local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalSupporterLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalSupporterLocalServiceBaseImpl
    implements ProposalSupporterLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalSupporterLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalSupporterLocalServiceUtil} to access the proposal supporter local service.
     */
     ...
     */
    public ProposalSupporter addProposalSupporter(
        ProposalSupporter proposalSupporter) throws SystemException {
        proposalSupporter.setNew(true);

        proposalSupporter = proposalSupporterPersistence.update(proposalSupporter,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(proposalSupporter);
     ...
     */
    public ProposalSupporter createProposalSupporter(
        ProposalSupporterPK proposalSupporterPK) {
        return proposalSupporterPersistence.create(proposalSupporterPK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalSupporter(ProposalSupporterPK proposalSupporterPK)
        throws PortalException, SystemException {
        ProposalSupporter proposalSupporter = proposalSupporterPersistence.remove(proposalSupporterPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposalSupporter);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalSupporter(ProposalSupporter proposalSupporter)
        throws SystemException {
        proposalSupporterPersistence.remove(proposalSupporter);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalSupporterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalSupporterPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ProposalSupporter fetchProposalSupporter(
        ProposalSupporterPK proposalSupporterPK) throws SystemException {
        return proposalSupporterPersistence.fetchByPrimaryKey(proposalSupporterPK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalSupporter getProposalSupporter(
        ProposalSupporterPK proposalSupporterPK)
        throws PortalException, SystemException {
        return proposalSupporterPersistence.findByPrimaryKey(proposalSupporterPK);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalSupporterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<ProposalSupporter> getProposalSupporters(int start, int end)
        throws SystemException {
        return proposalSupporterPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getProposalSupportersCount() throws SystemException {
        return proposalSupporterPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalSupporter updateProposalSupporter(
        ProposalSupporter proposalSupporter) throws SystemException {
        return updateProposalSupporter(proposalSupporter, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalSupporter",
