...
/**
 * The base model implementation for the OntologyTerm service. Represents a row in the &quot;ontology_OntologyTerm&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class OntologyTermModelImpl extends BaseModelImpl<OntologyTerm>
     ...
     */
    public static final String TABLE_NAME = "ontology_OntologyTerm";
    ...
    public static final String TABLE_SQL_CREATE = "create table ontology_OntologyTerm (id_ LONG not null primary key,parentId LONG,ontologySpaceId LONG,name VARCHAR(75) null,descriptionUrl VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table ontology_OntologyTerm";
