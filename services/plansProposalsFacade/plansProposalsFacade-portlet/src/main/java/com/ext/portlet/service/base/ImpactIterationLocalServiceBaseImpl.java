...
import com.ext.portlet.service.ImpactIterationLocalService;
...
/**
 * Provides the base implementation for the impact iteration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ImpactIterationLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ImpactIterationLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ImpactIterationLocalService,
        IdentifiableBean {
    ...
    private ImpactIterationLocalServiceClpInvoker _clpInvoker = new ImpactIterationLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ImpactIterationLocalServiceUtil} to access the impact iteration local service.
     */
    ...
    @Override
    public ImpactIteration addImpactIteration(ImpactIteration impactIteration)
        throws SystemException {
        impactIteration.setNew(true);

        return impactIterationPersistence.update(impactIteration);
    }
     ...
     */
    @Override
    public ImpactIteration createImpactIteration(
        ImpactIterationPK impactIterationPK) {
        return impactIterationPersistence.create(impactIterationPK);
    }
    ...
    @Override
    public ImpactIteration deleteImpactIteration(
        ImpactIterationPK impactIterationPK)
        throws PortalException, SystemException {
        return impactIterationPersistence.remove(impactIterationPK);
    }
    ...
    @Override
    public ImpactIteration deleteImpactIteration(
        ImpactIteration impactIteration) throws SystemException {
        return impactIterationPersistence.remove(impactIteration);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImpactIteration.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactIterationPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactIterationPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImpactIteration fetchImpactIteration(
        ImpactIterationPK impactIterationPK) throws SystemException {
        return impactIterationPersistence.fetchByPrimaryKey(impactIterationPK);
    }
     ...
     */
    @Override
    public ImpactIteration getImpactIteration(
        ImpactIterationPK impactIterationPK)
        throws PortalException, SystemException {
        return impactIterationPersistence.findByPrimaryKey(impactIterationPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return impactIterationPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ImpactIteration> getImpactIterations(int start, int end)
        throws SystemException {
        return impactIterationPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImpactIterationsCount() throws SystemException {
        return impactIterationPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImpactIteration updateImpactIteration(
        ImpactIteration impactIteration) throws SystemException {
        return impactIterationPersistence.update(impactIteration);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ImpactIteration",
            impactIterationLocalService);
    }
