 ...
 * @generated
 */
public class LandingPageLocalServiceClpInvoker {
    ...
    public LandingPageLocalServiceClpInvoker() {
        ...
        _methodName1 = "createLandingPage";

        _methodParameterTypes1 = new String[] { "long" };

        _methodName2 = "deleteLandingPage";

        _methodParameterTypes2 = new String[] { "long" };

        _methodName3 = "deleteLandingPage";
        ...
        _methodName10 = "fetchLandingPage";

        _methodParameterTypes10 = new String[] { "long" };

        _methodName11 = "getLandingPage";
        ...
        _methodName13 = "getLandingPages";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getLandingPagesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateLandingPage";
        ...
        _methodName626 = "createNewLandingPage";

        _methodParameterTypes626 = new String[] {
                "java.lang.String", "java.lang.String"
            };

        _methodName627 = "store";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LandingPageLocalServiceUtil.addLandingPage((com.ext.portlet.model.LandingPage) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return LandingPageLocalServiceUtil.createLandingPage(((Long) arguments[0]).longValue());
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return LandingPageLocalServiceUtil.deleteLandingPage(((Long) arguments[0]).longValue());
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return LandingPageLocalServiceUtil.deleteLandingPage((com.ext.portlet.model.LandingPage) arguments[0]);
        }

        if (_methodName4.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes4, parameterTypes)) {
            return LandingPageLocalServiceUtil.dynamicQuery();
        }

        if (_methodName5.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes5, parameterTypes)) {
            return LandingPageLocalServiceUtil.dynamicQuery((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName8.equals(name) &&
            ...
            return LandingPageLocalServiceUtil.dynamicQueryCount((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName10.equals(name) &&
            ...
            return LandingPageLocalServiceUtil.fetchLandingPage(((Long) arguments[0]).longValue());
        }

        if (_methodName11.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
            return LandingPageLocalServiceUtil.getLandingPage(((Long) arguments[0]).longValue());
        }

        if (_methodName12.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes12, parameterTypes)) {
            return LandingPageLocalServiceUtil.getPersistedModel((java.io.Serializable) arguments[0]);
        }

        if (_methodName13.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes13, parameterTypes)) {
            return LandingPageLocalServiceUtil.getLandingPages(((Integer) arguments[0]).intValue(),
                ((Integer) arguments[1]).intValue());
        }

        if (_methodName14.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes14, parameterTypes)) {
            return LandingPageLocalServiceUtil.getLandingPagesCount();
        }
