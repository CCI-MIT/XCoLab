...
import com.ext.portlet.service.ImpactTemplateSeriesLocalService;
...
/**
 * Provides the base implementation for the impact template series local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ImpactTemplateSeriesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ImpactTemplateSeriesLocalServiceImpl
 * @see com.ext.portlet.service.ImpactTemplateSeriesLocalServiceUtil
 * @generated
 */
public abstract class ImpactTemplateSeriesLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ImpactTemplateSeriesLocalService,
        IdentifiableBean {
    ...
    private ImpactTemplateSeriesLocalServiceClpInvoker _clpInvoker = new ImpactTemplateSeriesLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ImpactTemplateSeriesLocalServiceUtil} to access the impact template series local service.
     */
    ...
    @Override
    public ImpactTemplateSeries addImpactTemplateSeries(
        ImpactTemplateSeries impactTemplateSeries) throws SystemException {
        impactTemplateSeries.setNew(true);

        return impactTemplateSeriesPersistence.update(impactTemplateSeries);
    }
     ...
     */
    @Override
    public ImpactTemplateSeries createImpactTemplateSeries(long seriesId) {
        return impactTemplateSeriesPersistence.create(seriesId);
    }
    ...
    @Override
    public ImpactTemplateSeries deleteImpactTemplateSeries(long seriesId)
        throws PortalException, SystemException {
        return impactTemplateSeriesPersistence.remove(seriesId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ImpactTemplateSeries deleteImpactTemplateSeries(
        ImpactTemplateSeries impactTemplateSeries) throws SystemException {
        return impactTemplateSeriesPersistence.remove(impactTemplateSeries);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImpactTemplateSeries.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return impactTemplateSeriesPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactTemplateSeriesPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImpactTemplateSeries fetchImpactTemplateSeries(long seriesId)
        throws SystemException {
        return impactTemplateSeriesPersistence.fetchByPrimaryKey(seriesId);
    }
    ...
    public ImpactTemplateSeries getImpactTemplateSeries(long seriesId)
        throws PortalException, SystemException {
        return impactTemplateSeriesPersistence.findByPrimaryKey(seriesId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return impactTemplateSeriesPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ImpactTemplateSeries> getImpactTemplateSerieses(int start,
        int end) throws SystemException {
        return impactTemplateSeriesPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImpactTemplateSeriesesCount() throws SystemException {
        return impactTemplateSeriesPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImpactTemplateSeries updateImpactTemplateSeries(
        ImpactTemplateSeries impactTemplateSeries) throws SystemException {
        return impactTemplateSeriesPersistence.update(impactTemplateSeries);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ImpactTemplateSeries",
            impactTemplateSeriesLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = impactTemplateSeriesPersistence.getDataSource();
