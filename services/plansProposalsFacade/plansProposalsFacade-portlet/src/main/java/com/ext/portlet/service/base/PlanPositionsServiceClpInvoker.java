 ...
 * @generated
 */
public class PlanPositionsServiceClpInvoker {
    private String _methodName486;
    private String[] _methodParameterTypes486;
    private String _methodName487;
    private String[] _methodParameterTypes487;

    public PlanPositionsServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName486.equals(name) &&
            ...
            return PlanPositionsServiceUtil.getBeanIdentifier();
        }

        if (_methodName487.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes487, parameterTypes)) {
            PlanPositionsServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
