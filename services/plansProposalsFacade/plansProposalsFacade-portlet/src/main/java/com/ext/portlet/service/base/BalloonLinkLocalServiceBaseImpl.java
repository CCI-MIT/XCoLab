...
import com.ext.portlet.service.BalloonLinkLocalService;
...
/**
 * Provides the base implementation for the balloon link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.BalloonLinkLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BalloonLinkLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements BalloonLinkLocalService,
        IdentifiableBean {
    ...
    private BalloonLinkLocalServiceClpInvoker _clpInvoker = new BalloonLinkLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.BalloonLinkLocalServiceUtil} to access the balloon link local service.
     */
    ...
    @Override
    public BalloonLink addBalloonLink(BalloonLink balloonLink)
        throws SystemException {
        balloonLink.setNew(true);

        return balloonLinkPersistence.update(balloonLink);
    }
     ...
     */
    @Override
    public BalloonLink createBalloonLink(String uuid) {
        return balloonLinkPersistence.create(uuid);
    }
    ...
    @Override
    public BalloonLink deleteBalloonLink(String uuid)
        throws PortalException, SystemException {
        return balloonLinkPersistence.remove(uuid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public BalloonLink deleteBalloonLink(BalloonLink balloonLink)
        throws SystemException {
        return balloonLinkPersistence.remove(balloonLink);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(BalloonLink.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonLinkPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return balloonLinkPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonLinkPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public BalloonLink fetchBalloonLink(String uuid) throws SystemException {
        return balloonLinkPersistence.fetchByPrimaryKey(uuid);
    }
     ...
     */
    @Override
    public BalloonLink getBalloonLink(String uuid)
        throws PortalException, SystemException {
        return balloonLinkPersistence.findByPrimaryKey(uuid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return balloonLinkPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<BalloonLink> getBalloonLinks(int start, int end)
        throws SystemException {
        return balloonLinkPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBalloonLinksCount() throws SystemException {
        return balloonLinkPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public BalloonLink updateBalloonLink(BalloonLink balloonLink)
        throws SystemException {
        return balloonLinkPersistence.update(balloonLink);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.BalloonLink",
            balloonLinkLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = balloonLinkPersistence.getDataSource();
