...
/**
 * Provides the base implementation for the plan positions remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanPositionsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanPositionsServiceImpl
 * @see com.ext.portlet.service.PlanPositionsServiceUtil
 * @generated
 */
public abstract class PlanPositionsServiceBaseImpl extends BaseServiceImpl
    implements PlanPositionsService, IdentifiableBean {
    ...
    private PlanPositionsServiceClpInvoker _clpInvoker = new PlanPositionsServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanPositionsServiceUtil} to access the plan positions remote service.
     */
