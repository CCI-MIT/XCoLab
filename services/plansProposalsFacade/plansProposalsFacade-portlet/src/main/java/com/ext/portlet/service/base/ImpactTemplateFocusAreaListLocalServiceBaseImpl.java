...
import com.ext.portlet.service.ImpactTemplateFocusAreaListLocalService;
...
/**
 * Provides the base implementation for the impact template focus area list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ImpactTemplateFocusAreaListLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ImpactTemplateFocusAreaListLocalServiceBaseImpl
    extends BaseLocalServiceImpl
    implements ImpactTemplateFocusAreaListLocalService, IdentifiableBean {
    ...
    private ImpactTemplateFocusAreaListLocalServiceClpInvoker _clpInvoker = new ImpactTemplateFocusAreaListLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ImpactTemplateFocusAreaListLocalServiceUtil} to access the impact template focus area list local service.
     */
    ...
    @Override
    public ImpactTemplateFocusAreaList addImpactTemplateFocusAreaList(
        ImpactTemplateFocusAreaList impactTemplateFocusAreaList)
        throws SystemException {
        impactTemplateFocusAreaList.setNew(true);

        return impactTemplateFocusAreaListPersistence.update(impactTemplateFocusAreaList);
    }
     ...
     */
    @Override
    public ImpactTemplateFocusAreaList createImpactTemplateFocusAreaList(
        long focusAreaListId) {
        return impactTemplateFocusAreaListPersistence.create(focusAreaListId);
    }
    ...
    @Override
    public ImpactTemplateFocusAreaList deleteImpactTemplateFocusAreaList(
        long focusAreaListId) throws PortalException, SystemException {
        return impactTemplateFocusAreaListPersistence.remove(focusAreaListId);
    }
    ...
    public ImpactTemplateFocusAreaList deleteImpactTemplateFocusAreaList(
        ImpactTemplateFocusAreaList impactTemplateFocusAreaList)
        throws SystemException {
        return impactTemplateFocusAreaListPersistence.remove(impactTemplateFocusAreaList);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImpactTemplateFocusAreaList.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactTemplateFocusAreaListPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactTemplateFocusAreaListPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImpactTemplateFocusAreaList fetchImpactTemplateFocusAreaList(
        long focusAreaListId) throws SystemException {
        return impactTemplateFocusAreaListPersistence.fetchByPrimaryKey(focusAreaListId);
    }
     ...
     */
    @Override
    public ImpactTemplateFocusAreaList getImpactTemplateFocusAreaList(
        long focusAreaListId) throws PortalException, SystemException {
        return impactTemplateFocusAreaListPersistence.findByPrimaryKey(focusAreaListId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return impactTemplateFocusAreaListPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ImpactTemplateFocusAreaList> getImpactTemplateFocusAreaLists(
        int start, int end) throws SystemException {
        return impactTemplateFocusAreaListPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImpactTemplateFocusAreaListsCount() throws SystemException {
        return impactTemplateFocusAreaListPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImpactTemplateFocusAreaList updateImpactTemplateFocusAreaList(
        ImpactTemplateFocusAreaList impactTemplateFocusAreaList)
        throws SystemException {
        return impactTemplateFocusAreaListPersistence.update(impactTemplateFocusAreaList);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ImpactTemplateFocusAreaList",
            impactTemplateFocusAreaListLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = impactTemplateFocusAreaListPersistence.getDataSource();
