...
/**
 * Provides the base implementation for the points distribution configuration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PointsDistributionConfigurationLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PointsDistributionConfigurationLocalServiceBaseImpl
    extends BaseLocalServiceImpl
    implements PointsDistributionConfigurationLocalService, IdentifiableBean {
    ...
    private PointsDistributionConfigurationLocalServiceClpInvoker _clpInvoker = new PointsDistributionConfigurationLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PointsDistributionConfigurationLocalServiceUtil} to access the points distribution configuration local service.
     */
    ...
    @Override
    public PointsDistributionConfiguration addPointsDistributionConfiguration(
        PointsDistributionConfiguration pointsDistributionConfiguration)
        throws SystemException {
        pointsDistributionConfiguration.setNew(true);

        return pointsDistributionConfigurationPersistence.update(pointsDistributionConfiguration);
    }
    ...
    public PointsDistributionConfiguration createPointsDistributionConfiguration(
        long id) {
        return pointsDistributionConfigurationPersistence.create(id);
    }
    ...
    @Override
    public PointsDistributionConfiguration deletePointsDistributionConfiguration(
        long id) throws PortalException, SystemException {
        return pointsDistributionConfigurationPersistence.remove(id);
    }
    ...
    public PointsDistributionConfiguration deletePointsDistributionConfiguration(
        PointsDistributionConfiguration pointsDistributionConfiguration)
        throws SystemException {
        return pointsDistributionConfigurationPersistence.remove(pointsDistributionConfiguration);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PointsDistributionConfiguration.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointsDistributionConfigurationPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointsDistributionConfigurationPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PointsDistributionConfiguration fetchPointsDistributionConfiguration(
        long id) throws SystemException {
        return pointsDistributionConfigurationPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public PointsDistributionConfiguration getPointsDistributionConfiguration(
        long id) throws PortalException, SystemException {
        return pointsDistributionConfigurationPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return pointsDistributionConfigurationPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<PointsDistributionConfiguration> getPointsDistributionConfigurations(
        ...
        return pointsDistributionConfigurationPersistence.findAll(start, end);
    }
    ...
    public int getPointsDistributionConfigurationsCount()
        throws SystemException {
        return pointsDistributionConfigurationPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PointsDistributionConfiguration updatePointsDistributionConfiguration(
        PointsDistributionConfiguration pointsDistributionConfiguration)
        throws SystemException {
        return pointsDistributionConfigurationPersistence.update(pointsDistributionConfiguration);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PointsDistributionConfiguration",
            pointsDistributionConfigurationLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = pointsDistributionConfigurationPersistence.getDataSource();
