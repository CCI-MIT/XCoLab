...
public class MessageRecipientStatusLocalServiceClpInvoker {
    ...
    public MessageRecipientStatusLocalServiceClpInvoker() {
        ...
        _methodName540 = "countByMessageId";

        _methodParameterTypes540 = new String[] { "long" };

        _methodName541 = "findByMessageId";

        _methodParameterTypes541 = new String[] { "long", "int", "int" };

        _methodName542 = "countArchivedMessagesForUser";

        _methodParameterTypes542 = new String[] { "long" };

        _methodName543 = "findArchivedMessagesForUser";

        _methodParameterTypes543 = new String[] { "long", "int", "int" };

        _methodName544 = "countInboxMessagesForUser";

        _methodParameterTypes544 = new String[] { "long" };

        _methodName545 = "findInboxMessagesForUser";

        _methodParameterTypes545 = new String[] { "long", "int", "int" };

        _methodName546 = "findByMessageRecipient";

        _methodParameterTypes546 = new String[] { "long", "long" };

        _methodName547 = "countUnreadMessages";

        _methodParameterTypes547 = new String[] { "long" };

        _methodName548 = "didReceiveJudgeCommentForProposal";
