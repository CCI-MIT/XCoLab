...
public class MessageLocalServiceClpInvoker {
    ...
    public MessageLocalServiceClpInvoker() {
        ...
        _methodName512 = "countSentMessage";

        _methodParameterTypes512 = new String[] { "long" };

        _methodName513 = "findSentMessages";

        _methodParameterTypes513 = new String[] { "long", "int", "int" };

        _methodName514 = "getRecipients";

        _methodParameterTypes514 = new String[] { "com.ext.portlet.model.Message" };

        _methodName515 = "hasReciever";

        _methodParameterTypes515 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName516 = "isOpened";

        _methodParameterTypes516 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName517 = "setOpened";

        _methodParameterTypes517 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName518 = "isArchived";

        _methodParameterTypes518 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName519 = "setArchived";
