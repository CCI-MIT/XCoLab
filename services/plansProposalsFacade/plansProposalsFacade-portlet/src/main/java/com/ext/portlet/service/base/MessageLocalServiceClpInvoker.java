...
public class MessageLocalServiceClpInvoker {
    ...
    public MessageLocalServiceClpInvoker() {
        ...
        _methodName664 = "countSentMessage";

        _methodParameterTypes664 = new String[] { "long" };

        _methodName665 = "findSentMessages";

        _methodParameterTypes665 = new String[] { "long", "int", "int" };

        _methodName666 = "getRecipients";

        _methodParameterTypes666 = new String[] { "com.ext.portlet.model.Message" };

        _methodName667 = "hasReciever";

        _methodParameterTypes667 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName668 = "isOpened";

        _methodParameterTypes668 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName669 = "setOpened";

        _methodParameterTypes669 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName670 = "isArchived";

        _methodParameterTypes670 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName671 = "setArchived";
