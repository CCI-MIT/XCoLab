...
public class MessageLocalServiceClpInvoker {
    ...
    public MessageLocalServiceClpInvoker() {
        ...
        _methodName570 = "countSentMessage";

        _methodParameterTypes570 = new String[] { "long" };

        _methodName571 = "findSentMessages";

        _methodParameterTypes571 = new String[] { "long", "int", "int" };

        _methodName572 = "getRecipients";

        _methodParameterTypes572 = new String[] { "com.ext.portlet.model.Message" };

        _methodName573 = "hasReciever";

        _methodParameterTypes573 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName574 = "isOpened";

        _methodParameterTypes574 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName575 = "setOpened";

        _methodParameterTypes575 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName576 = "isArchived";

        _methodParameterTypes576 = new String[] {
                "com.ext.portlet.model.Message", "long"
            };

        _methodName577 = "setArchived";
