...
public class PlanAttributeModelImpl extends BaseModelImpl<PlanAttribute>
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_PlanAttribute (attributeId LONG not null primary key,planId LONG,attributeName VARCHAR(75) null,attributeValue VARCHAR(75) null)";
