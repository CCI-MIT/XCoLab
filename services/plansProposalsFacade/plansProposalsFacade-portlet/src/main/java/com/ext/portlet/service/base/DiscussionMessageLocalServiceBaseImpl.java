...
/**
 * Provides the base implementation for the discussion message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.DiscussionMessageLocalServiceImpl}.
 * </p>
 *
...
public abstract class DiscussionMessageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements DiscussionMessageLocalService,
        IdentifiableBean {
    ...
    private DiscussionMessageLocalServiceClpInvoker _clpInvoker = new DiscussionMessageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.DiscussionMessageLocalServiceUtil} to access the discussion message local service.
     */
    ...
    public DiscussionMessage addDiscussionMessage(
        ...
        return discussionMessagePersistence.update(discussionMessage);
    }
    ...
    @Override
    public DiscussionMessage deleteDiscussionMessage(long pk)
        throws PortalException, SystemException {
        return discussionMessagePersistence.remove(pk);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public DiscussionMessage deleteDiscussionMessage(
        DiscussionMessage discussionMessage) throws SystemException {
        return discussionMessagePersistence.remove(discussionMessage);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DiscussionMessage.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.DiscussionMessage",
