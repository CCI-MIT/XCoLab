...
import com.ext.portlet.service.ImpactDefaultSeriesLocalService;
...
/**
 * Provides the base implementation for the impact default series local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ImpactDefaultSeriesLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ImpactDefaultSeriesLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ImpactDefaultSeriesLocalService,
        IdentifiableBean {
    ...
    private ImpactDefaultSeriesLocalServiceClpInvoker _clpInvoker = new ImpactDefaultSeriesLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ImpactDefaultSeriesLocalServiceUtil} to access the impact default series local service.
     */
    ...
    @Override
    public ImpactDefaultSeries addImpactDefaultSeries(
        ImpactDefaultSeries impactDefaultSeries) throws SystemException {
        impactDefaultSeries.setNew(true);

        return impactDefaultSeriesPersistence.update(impactDefaultSeries);
    }
     ...
     */
    @Override
    public ImpactDefaultSeries createImpactDefaultSeries(
        ImpactDefaultSeriesPK impactDefaultSeriesPK) {
        return impactDefaultSeriesPersistence.create(impactDefaultSeriesPK);
    }
    ...
    @Override
    public ImpactDefaultSeries deleteImpactDefaultSeries(
        ImpactDefaultSeriesPK impactDefaultSeriesPK)
        throws PortalException, SystemException {
        return impactDefaultSeriesPersistence.remove(impactDefaultSeriesPK);
    }
    ...
    public ImpactDefaultSeries deleteImpactDefaultSeries(
        ImpactDefaultSeries impactDefaultSeries) throws SystemException {
        return impactDefaultSeriesPersistence.remove(impactDefaultSeries);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImpactDefaultSeries.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return impactDefaultSeriesPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactDefaultSeriesPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImpactDefaultSeries fetchImpactDefaultSeries(
        ImpactDefaultSeriesPK impactDefaultSeriesPK) throws SystemException {
        return impactDefaultSeriesPersistence.fetchByPrimaryKey(impactDefaultSeriesPK);
    }
     ...
     */
    @Override
    public ImpactDefaultSeries getImpactDefaultSeries(
        ImpactDefaultSeriesPK impactDefaultSeriesPK)
        throws PortalException, SystemException {
        return impactDefaultSeriesPersistence.findByPrimaryKey(impactDefaultSeriesPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return impactDefaultSeriesPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ImpactDefaultSeries> getImpactDefaultSerieses(int start, int end)
        throws SystemException {
        return impactDefaultSeriesPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImpactDefaultSeriesesCount() throws SystemException {
        return impactDefaultSeriesPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImpactDefaultSeries updateImpactDefaultSeries(
        ImpactDefaultSeries impactDefaultSeries) throws SystemException {
        return impactDefaultSeriesPersistence.update(impactDefaultSeries);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ImpactDefaultSeries",
            impactDefaultSeriesLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = impactDefaultSeriesPersistence.getDataSource();
