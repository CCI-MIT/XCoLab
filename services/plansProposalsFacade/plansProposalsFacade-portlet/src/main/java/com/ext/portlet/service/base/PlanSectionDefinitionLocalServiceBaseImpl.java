...
/**
 * Provides the base implementation for the plan section definition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanSectionDefinitionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanSectionDefinitionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanSectionDefinitionLocalService,
        IdentifiableBean {
    ...
    private PlanSectionDefinitionLocalServiceClpInvoker _clpInvoker = new PlanSectionDefinitionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanSectionDefinitionLocalServiceUtil} to access the plan section definition local service.
     */
    ...
    @Override
    public PlanSectionDefinition deletePlanSectionDefinition(long id)
        throws PortalException, SystemException {
        return planSectionDefinitionPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanSectionDefinition deletePlanSectionDefinition(
        PlanSectionDefinition planSectionDefinition) throws SystemException {
        return planSectionDefinitionPersistence.remove(planSectionDefinition);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanSectionDefinition.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanSectionDefinition",
