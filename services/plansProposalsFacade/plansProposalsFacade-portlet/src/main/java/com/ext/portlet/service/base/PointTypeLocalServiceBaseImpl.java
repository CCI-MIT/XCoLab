...
/**
 * Provides the base implementation for the point type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PointTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PointTypeLocalServiceImpl
 * @see com.ext.portlet.service.PointTypeLocalServiceUtil
 * @generated
 */
public abstract class PointTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PointTypeLocalService, IdentifiableBean {
    ...
    private PointTypeLocalServiceClpInvoker _clpInvoker = new PointTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PointTypeLocalServiceUtil} to access the point type local service.
     */
    ...
    public PointType addPointType(PointType pointType)
        ...
        return pointTypePersistence.update(pointType);
    }
     ...
     */
    @Override
    public PointType createPointType(long id) {
        return pointTypePersistence.create(id);
    }
    ...
    @Override
    public PointType deletePointType(long id)
        throws PortalException, SystemException {
        return pointTypePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PointType deletePointType(PointType pointType)
        throws SystemException {
        return pointTypePersistence.remove(pointType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PointType.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return pointTypePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointTypePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PointType fetchPointType(long id) throws SystemException {
        return pointTypePersistence.fetchByPrimaryKey(id);
    }
    ...
    public PointType getPointType(long id)
        throws PortalException, SystemException {
        return pointTypePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return pointTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<PointType> getPointTypes(int start, int end)
        throws SystemException {
        return pointTypePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPointTypesCount() throws SystemException {
        return pointTypePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PointType updatePointType(PointType pointType)
        throws SystemException {
        return pointTypePersistence.update(pointType);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PointType",
            pointTypeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = pointTypePersistence.getDataSource();
