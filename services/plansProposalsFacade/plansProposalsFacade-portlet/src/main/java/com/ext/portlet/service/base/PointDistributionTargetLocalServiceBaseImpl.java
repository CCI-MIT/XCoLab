...
/**
 * Provides the base implementation for the point distribution target local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PointDistributionTargetLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PointDistributionTargetLocalServiceImpl
 * @see com.ext.portlet.service.PointDistributionTargetLocalServiceUtil
 * @generated
 */
public abstract class PointDistributionTargetLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PointDistributionTargetLocalService,
        IdentifiableBean {
    ...
    private PointDistributionTargetLocalServiceClpInvoker _clpInvoker = new PointDistributionTargetLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PointDistributionTargetLocalServiceUtil} to access the point distribution target local service.
     */
    ...
    @Override
    public PointDistributionTarget addPointDistributionTarget(
        PointDistributionTarget pointDistributionTarget)
        throws SystemException {
        pointDistributionTarget.setNew(true);

        return pointDistributionTargetPersistence.update(pointDistributionTarget);
    }
     ...
     */
    @Override
    public PointDistributionTarget createPointDistributionTarget(long id) {
        return pointDistributionTargetPersistence.create(id);
    }
    ...
    @Override
    public PointDistributionTarget deletePointDistributionTarget(long id)
        throws PortalException, SystemException {
        return pointDistributionTargetPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PointDistributionTarget deletePointDistributionTarget(
        PointDistributionTarget pointDistributionTarget)
        throws SystemException {
        return pointDistributionTargetPersistence.remove(pointDistributionTarget);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PointDistributionTarget.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointDistributionTargetPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return pointDistributionTargetPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PointDistributionTarget fetchPointDistributionTarget(long id)
        throws SystemException {
        return pointDistributionTargetPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public PointDistributionTarget getPointDistributionTarget(long id)
        throws PortalException, SystemException {
        return pointDistributionTargetPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return pointDistributionTargetPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<PointDistributionTarget> getPointDistributionTargets(
        int start, int end) throws SystemException {
        return pointDistributionTargetPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPointDistributionTargetsCount() throws SystemException {
        return pointDistributionTargetPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PointDistributionTarget updatePointDistributionTarget(
        PointDistributionTarget pointDistributionTarget)
        throws SystemException {
        return pointDistributionTargetPersistence.update(pointDistributionTarget);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PointDistributionTarget",
            pointDistributionTargetLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = pointDistributionTargetPersistence.getDataSource();
