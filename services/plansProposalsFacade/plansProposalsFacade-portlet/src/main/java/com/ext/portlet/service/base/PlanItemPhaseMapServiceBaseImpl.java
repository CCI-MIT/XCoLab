...
import com.ext.portlet.service.PlanItemPhaseMapLocalService;
import com.ext.portlet.service.PlanItemPhaseMapService;
...
import com.ext.portlet.service.persistence.PlanItemPhaseMapPersistence;
...
/**
 * The base implementation of the plan item phase map remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanItemPhaseMapServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanItemPhaseMapServiceImpl
 * @see com.ext.portlet.service.PlanItemPhaseMapServiceUtil
 * @generated
 */
public abstract class PlanItemPhaseMapServiceBaseImpl extends PrincipalBean
    implements PlanItemPhaseMapService, IdentifiableBean {
    ...
    @BeanReference(type = PlanItemPhaseMapLocalService.class)
    protected PlanItemPhaseMapLocalService planItemPhaseMapLocalService;
    @BeanReference(type = PlanItemPhaseMapService.class)
    protected PlanItemPhaseMapService planItemPhaseMapService;
    @BeanReference(type = PlanItemPhaseMapPersistence.class)
    protected PlanItemPhaseMapPersistence planItemPhaseMapPersistence;
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanItemPhaseMapServiceUtil} to access the plan item phase map remote service.
     */
    ...
    /**
     * Returns the plan item phase map local service.
     *
     * @return the plan item phase map local service
     */
    public PlanItemPhaseMapLocalService getPlanItemPhaseMapLocalService() {
        return planItemPhaseMapLocalService;
    }

    /**
     * Sets the plan item phase map local service.
     *
     * @param planItemPhaseMapLocalService the plan item phase map local service
     */
    public void setPlanItemPhaseMapLocalService(
        PlanItemPhaseMapLocalService planItemPhaseMapLocalService) {
        this.planItemPhaseMapLocalService = planItemPhaseMapLocalService;
    }

    /**
     * Returns the plan item phase map remote service.
     *
     * @return the plan item phase map remote service
     */
    public PlanItemPhaseMapService getPlanItemPhaseMapService() {
        return planItemPhaseMapService;
    }

    /**
     * Sets the plan item phase map remote service.
     *
     * @param planItemPhaseMapService the plan item phase map remote service
     */
    public void setPlanItemPhaseMapService(
        PlanItemPhaseMapService planItemPhaseMapService) {
        this.planItemPhaseMapService = planItemPhaseMapService;
    }

    /**
     * Returns the plan item phase map persistence.
     *
     * @return the plan item phase map persistence
     */
    public PlanItemPhaseMapPersistence getPlanItemPhaseMapPersistence() {
        return planItemPhaseMapPersistence;
    }

    /**
     * Sets the plan item phase map persistence.
     *
     * @param planItemPhaseMapPersistence the plan item phase map persistence
     */
    public void setPlanItemPhaseMapPersistence(
        PlanItemPhaseMapPersistence planItemPhaseMapPersistence) {
        this.planItemPhaseMapPersistence = planItemPhaseMapPersistence;
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planItemPhaseMapPersistence.getDataSource();
