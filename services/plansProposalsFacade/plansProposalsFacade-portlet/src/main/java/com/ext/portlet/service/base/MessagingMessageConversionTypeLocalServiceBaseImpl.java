...
/**
 * The base implementation of the messaging message conversion type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessagingMessageConversionTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.MessagingMessageConversionTypeLocalServiceImpl
 * @see com.ext.portlet.service.MessagingMessageConversionTypeLocalServiceUtil
 * @generated
 */
public abstract class MessagingMessageConversionTypeLocalServiceBaseImpl
    implements MessagingMessageConversionTypeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(MessagingMessageConversionTypeLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessagingMessageConversionTypeLocalServiceUtil} to access the messaging message conversion type local service.
     */
    ...
    public MessagingMessageConversionType addMessagingMessageConversionType(
        ...
        messagingMessageConversionType = messagingMessageConversionTypePersistence.update(messagingMessageConversionType,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(messagingMessageConversionType);
    ...
    public void deleteMessagingMessageConversionType(long typeId)
        ...
        MessagingMessageConversionType messagingMessageConversionType = messagingMessageConversionTypePersistence.remove(typeId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(messagingMessageConversionType);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingMessageConversionTypePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public MessagingMessageConversionType fetchMessagingMessageConversionType(
        long typeId) throws SystemException {
        return messagingMessageConversionTypePersistence.fetchByPrimaryKey(typeId);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return messagingMessageConversionTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public MessagingMessageConversionType updateMessagingMessageConversionType(
        MessagingMessageConversionType messagingMessageConversionType)
        throws SystemException {
        return updateMessagingMessageConversionType(messagingMessageConversionType,
            true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MessagingMessageConversionType",
            messagingMessageConversionTypeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = messagingMessageConversionTypePersistence.getDataSource();
