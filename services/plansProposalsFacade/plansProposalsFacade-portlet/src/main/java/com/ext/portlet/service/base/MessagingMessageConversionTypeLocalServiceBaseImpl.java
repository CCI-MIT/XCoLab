...
/**
 * Provides the base implementation for the messaging message conversion type local service.
 *
 * <p>
...
public abstract class MessagingMessageConversionTypeLocalServiceBaseImpl
    ...
    private MessagingMessageConversionTypeLocalServiceClpInvoker _clpInvoker = new MessagingMessageConversionTypeLocalServiceClpInvoker();
    ...
    @Override
    public MessagingMessageConversionType deleteMessagingMessageConversionType(
        long typeId) throws PortalException, SystemException {
        return messagingMessageConversionTypePersistence.remove(typeId);
    }
    ...
    public MessagingMessageConversionType deleteMessagingMessageConversionType(
        MessagingMessageConversionType messagingMessageConversionType)
        throws SystemException {
        return messagingMessageConversionTypePersistence.remove(messagingMessageConversionType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MessagingMessageConversionType.class,
