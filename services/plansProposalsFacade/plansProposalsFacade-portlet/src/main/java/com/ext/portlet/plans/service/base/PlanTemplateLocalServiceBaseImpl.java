...
/**
 * The base implementation of the plan template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanTemplateLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanTemplateLocalServiceBaseImpl
    implements PlanTemplateLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanTemplateLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanTemplateLocalServiceUtil} to access the plan template local service.
     */
    ...
    public PlanTemplate addPlanTemplate(PlanTemplate planTemplate)
        ...
        planTemplate = planTemplatePersistence.update(planTemplate, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planTemplate);
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planTemplatePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanTemplate updatePlanTemplate(PlanTemplate planTemplate)
        throws SystemException {
        return updatePlanTemplate(planTemplate, true);
    }
    ...
    public PlanTemplate updatePlanTemplate(PlanTemplate planTemplate,
        ...
        planTemplate = planTemplatePersistence.update(planTemplate, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanTemplate",
            planTemplateLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanTemplate");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planTemplatePersistence.getDataSource();
