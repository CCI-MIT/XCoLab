...
public class PlanDescriptionLocalServiceClpInvoker {
    ...
    public PlanDescriptionLocalServiceClpInvoker() {
        ...
        _methodName546 = "createPlanDescription";

        _methodParameterTypes546 = new String[] {
                "com.ext.portlet.model.PlanItem", "java.lang.String"
            };

        _methodName547 = "createPlanDescription";

        _methodParameterTypes547 = new String[] {
                "com.ext.portlet.model.PlanItem", "java.lang.String", "boolean"
            };

        _methodName548 = "getCurrentForPlan";

        _methodParameterTypes548 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName549 = "getForPlan";

        _methodParameterTypes549 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName550 = "getAllForPlan";

        _methodParameterTypes550 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName551 = "createNewVersionForPlan";

        _methodParameterTypes551 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName552 = "createNewVersionForPlan";

        _methodParameterTypes552 = new String[] {
                "com.ext.portlet.model.PlanItem", "boolean"
            };

        _methodName553 = "createNewVersionForPlanFrom";
        ...
        _methodName555 = "getUpdateAuthor";
