...
public class PlanDescriptionLocalServiceClpInvoker {
    ...
    public PlanDescriptionLocalServiceClpInvoker() {
        ...
        _methodName558 = "createPlanDescription";

        _methodParameterTypes558 = new String[] {
                "com.ext.portlet.model.PlanItem", "java.lang.String"
            };

        _methodName559 = "createPlanDescription";

        _methodParameterTypes559 = new String[] {
                "com.ext.portlet.model.PlanItem", "java.lang.String", "boolean"
            };

        _methodName560 = "getCurrentForPlan";

        _methodParameterTypes560 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName561 = "getForPlan";

        _methodParameterTypes561 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName562 = "getAllForPlan";

        _methodParameterTypes562 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName563 = "createNewVersionForPlan";

        _methodParameterTypes563 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName564 = "createNewVersionForPlan";

        _methodParameterTypes564 = new String[] {
                "com.ext.portlet.model.PlanItem", "boolean"
            };

        _methodName565 = "createNewVersionForPlanFrom";
        ...
        _methodName567 = "getUpdateAuthor";
