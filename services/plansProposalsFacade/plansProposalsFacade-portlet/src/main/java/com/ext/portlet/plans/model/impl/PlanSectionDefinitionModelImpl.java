...
/**
 * The base model implementation for the PlanSectionDefinition service. Represents a row in the &quot;Plans_PlanSectionDefinition&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PlanSectionDefinitionModelImpl extends BaseModelImpl<PlanSectionDefinition>
     ...
     */
    public static final String TABLE_NAME = "Plans_PlanSectionDefinition";
    ...
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanSectionDefinition (id_ LONG not null primary key,adminTitle VARCHAR(75) null,title VARCHAR(75) null,defaultText VARCHAR(75) null,helpText VARCHAR(75) null,characterLimit INTEGER,focusAreaId LONG,locked BOOLEAN)";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanSectionDefinition";
