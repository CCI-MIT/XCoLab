...
/**
 * The base implementation of the plan team history local service.
 *
 * <p>
...
public abstract class PlanTeamHistoryLocalServiceBaseImpl
    implements PlanTeamHistoryLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanTeamHistoryLocalServiceBaseImpl.class);
    ...
    public PlanTeamHistory addPlanTeamHistory(PlanTeamHistory planTeamHistory)
        ...
        planTeamHistory = planTeamHistoryPersistence.update(planTeamHistory,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planTeamHistory);
    ...
    public void deletePlanTeamHistory(long id)
        ...
        if (indexer != null) {
            try {
                indexer.delete(planTeamHistory);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanTeamHistory updatePlanTeamHistory(
        ...
        return updatePlanTeamHistory(planTeamHistory, true);
    }
