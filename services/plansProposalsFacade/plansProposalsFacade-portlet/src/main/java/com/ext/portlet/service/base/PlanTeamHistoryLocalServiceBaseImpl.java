...
/**
 * Provides the base implementation for the plan team history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanTeamHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanTeamHistoryLocalServiceImpl
 * @see com.ext.portlet.service.PlanTeamHistoryLocalServiceUtil
 * @generated
 */
public abstract class PlanTeamHistoryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanTeamHistoryLocalService,
        IdentifiableBean {
    ...
    private PlanTeamHistoryLocalServiceClpInvoker _clpInvoker = new PlanTeamHistoryLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanTeamHistoryLocalServiceUtil} to access the plan team history local service.
     */
    ...
    public PlanTeamHistory addPlanTeamHistory(PlanTeamHistory planTeamHistory)
        ...
        return planTeamHistoryPersistence.update(planTeamHistory);
    }
    ...
    @Override
    public PlanTeamHistory deletePlanTeamHistory(long id)
        throws PortalException, SystemException {
        return planTeamHistoryPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanTeamHistory deletePlanTeamHistory(
        PlanTeamHistory planTeamHistory) throws SystemException {
        return planTeamHistoryPersistence.remove(planTeamHistory);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanTeamHistory.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planTeamHistoryPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanTeamHistory",
            planTeamHistoryLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planTeamHistoryPersistence.getDataSource();
