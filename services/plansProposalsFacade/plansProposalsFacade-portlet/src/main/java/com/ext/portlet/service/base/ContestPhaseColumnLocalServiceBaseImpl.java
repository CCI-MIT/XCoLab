...
/**
 * Provides the base implementation for the contest phase column local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestPhaseColumnLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContestPhaseColumnLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestPhaseColumnLocalService,
        IdentifiableBean {
    ...
    private ContestPhaseColumnLocalServiceClpInvoker _clpInvoker = new ContestPhaseColumnLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestPhaseColumnLocalServiceUtil} to access the contest phase column local service.
     */
    ...
    public ContestPhaseColumn addContestPhaseColumn(
        ...
        return contestPhaseColumnPersistence.update(contestPhaseColumn);
    }
    ...
    @Override
    public ContestPhaseColumn deleteContestPhaseColumn(long id)
        throws PortalException, SystemException {
        return contestPhaseColumnPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestPhaseColumn deleteContestPhaseColumn(
        ContestPhaseColumn contestPhaseColumn) throws SystemException {
        return contestPhaseColumnPersistence.remove(contestPhaseColumn);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestPhaseColumn.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestPhaseColumn",
