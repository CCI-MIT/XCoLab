...
/**
 * The base implementation of the plan column settings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanColumnSettingsLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanColumnSettingsLocalServiceBaseImpl
    implements PlanColumnSettingsLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanColumnSettingsLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanColumnSettingsLocalServiceUtil} to access the plan column settings local service.
     */
    ...
    public PlanColumnSettings addPlanColumnSettings(
        ...
        planColumnSettings = planColumnSettingsPersistence.update(planColumnSettings,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planColumnSettings);
    ...
    public void deletePlanColumnSettings(Long planColumnSettingsId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(planColumnSettings);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanColumnSettings updatePlanColumnSettings(
        PlanColumnSettings planColumnSettings) throws SystemException {
        return updatePlanColumnSettings(planColumnSettings, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanColumnSettings",
            planColumnSettingsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanColumnSettings");
    }
