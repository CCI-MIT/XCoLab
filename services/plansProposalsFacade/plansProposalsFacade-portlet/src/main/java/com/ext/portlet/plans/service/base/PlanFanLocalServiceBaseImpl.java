...
/**
 * The base implementation of the plan fan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanFanLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.plans.service.impl.PlanFanLocalServiceImpl
...
public abstract class PlanFanLocalServiceBaseImpl implements PlanFanLocalService,
    IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanFanLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanFanLocalServiceUtil} to access the plan fan local service.
     */
    ...
    public PlanFan addPlanFan(PlanFan planFan) throws SystemException {
        ...
        planFan = planFanPersistence.update(planFan, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planFan);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return planFanPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        ...
        return planFanPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanFan updatePlanFan(PlanFan planFan) throws SystemException {
        return updatePlanFan(planFan, true);
    }
    ...
    public PlanFan updatePlanFan(PlanFan planFan, boolean merge)
        ...
        planFan = planFanPersistence.update(planFan, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanFan",
            planFanLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanFan");
    }
