...
import com.ext.portlet.service.ContestTeamMemberRoleLocalService;
...
/**
 * Provides the base implementation for the contest team member role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestTeamMemberRoleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ContestTeamMemberRoleLocalServiceImpl
 * @see com.ext.portlet.service.ContestTeamMemberRoleLocalServiceUtil
 * @generated
 */
public abstract class ContestTeamMemberRoleLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestTeamMemberRoleLocalService,
        IdentifiableBean {
    ...
    private ContestTeamMemberRoleLocalServiceClpInvoker _clpInvoker = new ContestTeamMemberRoleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestTeamMemberRoleLocalServiceUtil} to access the contest team member role local service.
     */
    ...
    @Override
    public ContestTeamMemberRole addContestTeamMemberRole(
        ContestTeamMemberRole contestTeamMemberRole) throws SystemException {
        contestTeamMemberRole.setNew(true);

        return contestTeamMemberRolePersistence.update(contestTeamMemberRole);
    }
     ...
     */
    @Override
    public ContestTeamMemberRole createContestTeamMemberRole(long id) {
        return contestTeamMemberRolePersistence.create(id);
    }
    ...
    @Override
    public ContestTeamMemberRole deleteContestTeamMemberRole(long id)
        throws PortalException, SystemException {
        return contestTeamMemberRolePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestTeamMemberRole deleteContestTeamMemberRole(
        ContestTeamMemberRole contestTeamMemberRole) throws SystemException {
        return contestTeamMemberRolePersistence.remove(contestTeamMemberRole);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestTeamMemberRole.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return contestTeamMemberRolePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestTeamMemberRolePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ContestTeamMemberRole fetchContestTeamMemberRole(long id)
        throws SystemException {
        return contestTeamMemberRolePersistence.fetchByPrimaryKey(id);
    }
    ...
    public ContestTeamMemberRole getContestTeamMemberRole(long id)
        throws PortalException, SystemException {
        return contestTeamMemberRolePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestTeamMemberRolePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContestTeamMemberRole> getContestTeamMemberRoles(int start,
        int end) throws SystemException {
        return contestTeamMemberRolePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContestTeamMemberRolesCount() throws SystemException {
        return contestTeamMemberRolePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContestTeamMemberRole updateContestTeamMemberRole(
        ContestTeamMemberRole contestTeamMemberRole) throws SystemException {
        return contestTeamMemberRolePersistence.update(contestTeamMemberRole);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestTeamMemberRole",
            contestTeamMemberRoleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestTeamMemberRolePersistence.getDataSource();
