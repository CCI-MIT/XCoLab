...
/**
 * Provides the base implementation for the plan attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanAttributeLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanAttributeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanAttributeLocalService,
        IdentifiableBean {
    ...
    private PlanAttributeLocalServiceClpInvoker _clpInvoker = new PlanAttributeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanAttributeLocalServiceUtil} to access the plan attribute local service.
     */
    ...
    public PlanAttribute addPlanAttribute(PlanAttribute planAttribute)
        ...
        return planAttributePersistence.update(planAttribute);
    }
    ...
    @Override
    public PlanAttribute deletePlanAttribute(long attributeId)
        throws PortalException, SystemException {
        return planAttributePersistence.remove(attributeId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanAttribute deletePlanAttribute(PlanAttribute planAttribute)
        throws SystemException {
        return planAttributePersistence.remove(planAttribute);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanAttribute.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanAttribute",
