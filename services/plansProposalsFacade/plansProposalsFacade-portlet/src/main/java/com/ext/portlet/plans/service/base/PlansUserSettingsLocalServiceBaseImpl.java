...
/**
 * The base implementation of the plans user settings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlansUserSettingsLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlansUserSettingsLocalServiceBaseImpl
    implements PlansUserSettingsLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlansUserSettingsLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlansUserSettingsLocalServiceUtil} to access the plans user settings local service.
     */
    ...
    public PlansUserSettings addPlansUserSettings(
        ...
        plansUserSettings = plansUserSettingsPersistence.update(plansUserSettings,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(plansUserSettings);
    ...
    public void deletePlansUserSettings(Long planUserSettingsId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(plansUserSettings);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlansUserSettings updatePlansUserSettings(
        PlansUserSettings plansUserSettings) throws SystemException {
        return updatePlansUserSettings(plansUserSettings, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlansUserSettings",
            plansUserSettingsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlansUserSettings");
    }
