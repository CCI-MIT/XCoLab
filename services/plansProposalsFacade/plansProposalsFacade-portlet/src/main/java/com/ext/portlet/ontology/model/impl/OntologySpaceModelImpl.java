...
public class OntologySpaceModelImpl extends BaseModelImpl<OntologySpace>
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_OntologySpace (id_ LONG not null primary key,name VARCHAR(75) null,description VARCHAR(75) null)";
