...
import com.ext.portlet.ontology.model.OntologySpaceModel;
...
/**
 * The base model implementation for the OntologySpace service. Represents a row in the &quot;ontology_OntologySpace&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.ext.portlet.ontology.model.OntologySpaceModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link OntologySpaceImpl}.
 * </p>
 *
...
public class OntologySpaceModelImpl extends BaseModelImpl<OntologySpace>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a ontology space model instance should use the {@link com.ext.portlet.ontology.model.OntologySpace} interface instead.
     */
    public static final String TABLE_NAME = "ontology_OntologySpace";
    public static final Object[][] TABLE_COLUMNS = {
            { "id_", Types.BIGINT },
            { "name", Types.VARCHAR },
            { "description", Types.VARCHAR }
        };
    public static final String TABLE_SQL_CREATE = "create table ontology_OntologySpace (id_ LONG not null primary key,name VARCHAR(75) null,description VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table ontology_OntologySpace";
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.ext.portlet.ontology.model.OntologySpace"),
            true);
