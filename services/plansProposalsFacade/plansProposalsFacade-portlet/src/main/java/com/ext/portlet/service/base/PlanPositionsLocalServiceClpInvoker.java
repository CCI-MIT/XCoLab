...
public class PlanPositionsLocalServiceClpInvoker {
    ...
    public PlanPositionsLocalServiceClpInvoker() {
        ...
        _methodName570 = "getCurrentForPlan";

        _methodParameterTypes570 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName571 = "createPlanPositions";

        _methodParameterTypes571 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName572 = "getAllForPlan";

        _methodParameterTypes572 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName573 = "createNewVersionForPlan";

        _methodParameterTypes573 = new String[] { "com.ext.portlet.model.PlanItem" };

        _methodName574 = "createNewVersionForPlan";

        _methodParameterTypes574 = new String[] {
                "com.ext.portlet.model.PlanItem", "boolean"
            };

        _methodName575 = "getPositionsIds";

        _methodParameterTypes575 = new String[] {
                "com.ext.portlet.model.PlanPositions"
            };

        _methodName576 = "store";

        _methodParameterTypes576 = new String[] {
                "com.ext.portlet.model.PlanPositions"
            };

        _methodName577 = "setPositionsIds";

        _methodParameterTypes577 = new String[] {
                "com.ext.portlet.model.PlanPositions", "java.util.List"
            };

        _methodName578 = "getUpdateAuthor";
