...
/**
 * The base implementation of the focus area local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.ontology.service.impl.FocusAreaLocalServiceImpl}.
 * </p>
 *
...
public abstract class FocusAreaLocalServiceBaseImpl
    implements FocusAreaLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(FocusAreaLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.ontology.service.FocusAreaLocalServiceUtil} to access the focus area local service.
     */
    ...
    public FocusArea addFocusArea(FocusArea focusArea)
        ...
        focusArea = focusAreaPersistence.update(focusArea, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(focusArea);
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return focusAreaPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public FocusArea updateFocusArea(FocusArea focusArea)
        throws SystemException {
        return updateFocusArea(focusArea, true);
    }
    ...
    public FocusArea updateFocusArea(FocusArea focusArea, boolean merge)
        ...
        focusArea = focusAreaPersistence.update(focusArea, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.ontology.model.FocusArea",
            focusAreaLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.ontology.model.FocusArea");
    }
