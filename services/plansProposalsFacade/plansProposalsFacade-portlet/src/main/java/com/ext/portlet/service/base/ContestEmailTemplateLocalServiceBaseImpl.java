...
/**
 * Provides the base implementation for the contest email template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestEmailTemplateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ContestEmailTemplateLocalServiceImpl
 * @see com.ext.portlet.service.ContestEmailTemplateLocalServiceUtil
 * @generated
 */
public abstract class ContestEmailTemplateLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestEmailTemplateLocalService,
        IdentifiableBean {
    ...
    private ContestEmailTemplateLocalServiceClpInvoker _clpInvoker = new ContestEmailTemplateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestEmailTemplateLocalServiceUtil} to access the contest email template local service.
     */
    ...
    @Override
    public ContestEmailTemplate addContestEmailTemplate(
        ContestEmailTemplate contestEmailTemplate) throws SystemException {
        contestEmailTemplate.setNew(true);

        return contestEmailTemplatePersistence.update(contestEmailTemplate);
    }
     ...
     */
    @Override
    public ContestEmailTemplate createContestEmailTemplate(String type) {
        return contestEmailTemplatePersistence.create(type);
    }
    ...
    @Override
    public ContestEmailTemplate deleteContestEmailTemplate(String type)
        throws PortalException, SystemException {
        return contestEmailTemplatePersistence.remove(type);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestEmailTemplate deleteContestEmailTemplate(
        ContestEmailTemplate contestEmailTemplate) throws SystemException {
        return contestEmailTemplatePersistence.remove(contestEmailTemplate);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestEmailTemplate.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return contestEmailTemplatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestEmailTemplatePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ContestEmailTemplate fetchContestEmailTemplate(String type)
        throws SystemException {
        return contestEmailTemplatePersistence.fetchByPrimaryKey(type);
    }
     ...
     */
    @Override
    public ContestEmailTemplate getContestEmailTemplate(String type)
        throws PortalException, SystemException {
        return contestEmailTemplatePersistence.findByPrimaryKey(type);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestEmailTemplatePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContestEmailTemplate> getContestEmailTemplates(int start,
        int end) throws SystemException {
        return contestEmailTemplatePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContestEmailTemplatesCount() throws SystemException {
        return contestEmailTemplatePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContestEmailTemplate updateContestEmailTemplate(
        ContestEmailTemplate contestEmailTemplate) throws SystemException {
        return contestEmailTemplatePersistence.update(contestEmailTemplate);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestEmailTemplate",
            contestEmailTemplateLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestEmailTemplatePersistence.getDataSource();
