...
/**
 * The base implementation of the messaging message conversion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessagingMessageConversionLocalServiceImpl}.
 * </p>
 *
...
public abstract class MessagingMessageConversionLocalServiceBaseImpl
    implements MessagingMessageConversionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(MessagingMessageConversionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessagingMessageConversionLocalServiceUtil} to access the messaging message conversion local service.
     */
    ...
    public MessagingMessageConversion addMessagingMessageConversion(
        ...
        messagingMessageConversion = messagingMessageConversionPersistence.update(messagingMessageConversion,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(messagingMessageConversion);
    ...
    public void deleteMessagingMessageConversion(long conversionId)
        ...
        MessagingMessageConversion messagingMessageConversion = messagingMessageConversionPersistence.remove(conversionId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(messagingMessageConversion);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingMessageConversionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public MessagingMessageConversion fetchMessagingMessageConversion(
        long conversionId) throws SystemException {
        return messagingMessageConversionPersistence.fetchByPrimaryKey(conversionId);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return messagingMessageConversionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public MessagingMessageConversion updateMessagingMessageConversion(
        MessagingMessageConversion messagingMessageConversion)
        throws SystemException {
        return updateMessagingMessageConversion(messagingMessageConversion, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MessagingMessageConversion",
            messagingMessageConversionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = messagingMessageConversionPersistence.getDataSource();
