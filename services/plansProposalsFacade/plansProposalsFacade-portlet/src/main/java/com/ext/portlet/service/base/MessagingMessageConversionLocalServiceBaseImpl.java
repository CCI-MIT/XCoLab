...
/**
 * Provides the base implementation for the messaging message conversion local service.
 *
 * <p>
...
public abstract class MessagingMessageConversionLocalServiceBaseImpl
    ...
    private MessagingMessageConversionLocalServiceClpInvoker _clpInvoker = new MessagingMessageConversionLocalServiceClpInvoker();
    ...
    @Override
    public MessagingMessageConversion deleteMessagingMessageConversion(
        long conversionId) throws PortalException, SystemException {
        return messagingMessageConversionPersistence.remove(conversionId);
    }
    ...
    public MessagingMessageConversion deleteMessagingMessageConversion(
        MessagingMessageConversion messagingMessageConversion)
        throws SystemException {
        return messagingMessageConversionPersistence.remove(messagingMessageConversion);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MessagingMessageConversion.class,
