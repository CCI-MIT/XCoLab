...
/**
 * Provides the base implementation for the plan related remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanRelatedServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanRelatedServiceImpl
 * @see com.ext.portlet.service.PlanRelatedServiceUtil
 * @generated
 */
public abstract class PlanRelatedServiceBaseImpl extends BaseServiceImpl
    implements PlanRelatedService, IdentifiableBean {
    ...
    private PlanRelatedServiceClpInvoker _clpInvoker = new PlanRelatedServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanRelatedServiceUtil} to access the plan related remote service.
     */
