...
/**
 * Provides the base implementation for the contest team member local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestTeamMemberLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContestTeamMemberLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestTeamMemberLocalService,
        IdentifiableBean {
    ...
    private ContestTeamMemberLocalServiceClpInvoker _clpInvoker = new ContestTeamMemberLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestTeamMemberLocalServiceUtil} to access the contest team member local service.
     */
    ...
    public ContestTeamMember addContestTeamMember(
        ...
        return contestTeamMemberPersistence.update(contestTeamMember);
    }
    ...
    @Override
    public ContestTeamMember deleteContestTeamMember(long id)
        throws PortalException, SystemException {
        return contestTeamMemberPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestTeamMember deleteContestTeamMember(
        ContestTeamMember contestTeamMember) throws SystemException {
        return contestTeamMemberPersistence.remove(contestTeamMember);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestTeamMember.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestTeamMember",
