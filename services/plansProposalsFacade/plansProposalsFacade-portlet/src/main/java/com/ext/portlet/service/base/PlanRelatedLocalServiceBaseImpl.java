...
/**
 * Provides the base implementation for the plan related local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanRelatedLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanRelatedLocalServiceImpl
 * @see com.ext.portlet.service.PlanRelatedLocalServiceUtil
 * @generated
 */
public abstract class PlanRelatedLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanRelatedLocalService,
        IdentifiableBean {
    ...
    private PlanRelatedLocalServiceClpInvoker _clpInvoker = new PlanRelatedLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanRelatedLocalServiceUtil} to access the plan related local service.
     */
    ...
    public PlanRelated addPlanRelated(PlanRelated planRelated)
        ...
        return planRelatedPersistence.update(planRelated);
    }
    ...
    @Override
    public PlanRelated deletePlanRelated(PlanRelatedPK planRelatedPK)
        throws PortalException, SystemException {
        return planRelatedPersistence.remove(planRelatedPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanRelated deletePlanRelated(PlanRelated planRelated)
        throws SystemException {
        return planRelatedPersistence.remove(planRelated);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanRelated.class,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planRelatedPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PlanRelated fetchPlanRelated(PlanRelatedPK planRelatedPK)
        throws SystemException {
        return planRelatedPersistence.fetchByPrimaryKey(planRelatedPK);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planRelatedPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanRelated",
            planRelatedLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planRelatedPersistence.getDataSource();
