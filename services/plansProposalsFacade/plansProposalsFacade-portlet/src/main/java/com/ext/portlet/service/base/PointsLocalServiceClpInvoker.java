...
public class PointsLocalServiceClpInvoker {
    ...
    public PointsLocalServiceClpInvoker() {
        ...
        _methodName632 = "getUserMaterializedPoints";

        _methodParameterTypes632 = new String[] { "long" };

        _methodName633 = "getUserHypotheticalPoints";

        _methodParameterTypes633 = new String[] { "long" };

        _methodName634 = "distributePoints";

        _methodParameterTypes634 = new String[] { "long" };

        _methodName635 = "previewMaterializedPoints";
