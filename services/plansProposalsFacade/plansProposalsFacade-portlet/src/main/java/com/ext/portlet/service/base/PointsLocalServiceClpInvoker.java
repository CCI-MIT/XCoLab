...
public class PointsLocalServiceClpInvoker {
    ...
    public PointsLocalServiceClpInvoker() {
        ...
        _methodName494 = "getUserMaterializedPoints";

        _methodParameterTypes494 = new String[] { "long" };

        _methodName495 = "getUserHypotheticalPoints";

        _methodParameterTypes495 = new String[] { "long" };

        _methodName496 = "getProposalMaterializedPoints";

        _methodParameterTypes496 = new String[] { "long" };

        _methodName497 = "getProposalHypotheticalPoints";

        _methodParameterTypes497 = new String[] { "long" };

        _methodName498 = "distributePoints";

        _methodParameterTypes498 = new String[] { "long" };

        _methodName499 = "previewMaterializedPoints";

        _methodParameterTypes499 = new String[] { "long" };

        _methodName502 = "getLinkingProposals";

        _methodParameterTypes502 = new String[] { "long" };

        _methodName503 = "getLinkingProposalsForUser";
