...
public class PointsLocalServiceClpInvoker {
    ...
    public PointsLocalServiceClpInvoker() {
        ...
        _methodName626 = "getUserMaterializedPoints";

        _methodParameterTypes626 = new String[] { "long" };

        _methodName627 = "getUserHypotheticalPoints";

        _methodParameterTypes627 = new String[] { "long" };

        _methodName628 = "distributePoints";

        _methodParameterTypes628 = new String[] { "long" };

        _methodName629 = "previewMaterializedPoints";
