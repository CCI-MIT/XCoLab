...
import com.ext.portlet.service.ProposalReferenceLocalService;
...
/**
 * Provides the base implementation for the proposal reference local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalReferenceLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalReferenceLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalReferenceLocalService,
        IdentifiableBean {
    ...
    private ProposalReferenceLocalServiceClpInvoker _clpInvoker = new ProposalReferenceLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalReferenceLocalServiceUtil} to access the proposal reference local service.
     */
    ...
    @Override
    public ProposalReference addProposalReference(
        ProposalReference proposalReference) throws SystemException {
        proposalReference.setNew(true);

        return proposalReferencePersistence.update(proposalReference);
    }
     ...
     */
    @Override
    public ProposalReference createProposalReference(
        ProposalReferencePK proposalReferencePK) {
        return proposalReferencePersistence.create(proposalReferencePK);
    }
    ...
    @Override
    public ProposalReference deleteProposalReference(
        ProposalReferencePK proposalReferencePK)
        throws PortalException, SystemException {
        return proposalReferencePersistence.remove(proposalReferencePK);
    }
    ...
    public ProposalReference deleteProposalReference(
        ProposalReference proposalReference) throws SystemException {
        return proposalReferencePersistence.remove(proposalReference);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalReference.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return proposalReferencePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalReferencePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProposalReference fetchProposalReference(
        ProposalReferencePK proposalReferencePK) throws SystemException {
        return proposalReferencePersistence.fetchByPrimaryKey(proposalReferencePK);
    }
     ...
     */
    @Override
    public ProposalReference getProposalReference(
        ProposalReferencePK proposalReferencePK)
        throws PortalException, SystemException {
        return proposalReferencePersistence.findByPrimaryKey(proposalReferencePK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalReferencePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalReference> getProposalReferences(int start, int end)
        throws SystemException {
        return proposalReferencePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalReferencesCount() throws SystemException {
        return proposalReferencePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalReference updateProposalReference(
        ProposalReference proposalReference) throws SystemException {
        return proposalReferencePersistence.update(proposalReference);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalReference",
            proposalReferenceLocalService);
    }
