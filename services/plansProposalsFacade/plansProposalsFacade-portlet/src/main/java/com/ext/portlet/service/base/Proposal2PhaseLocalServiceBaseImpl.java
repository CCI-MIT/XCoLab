...
/**
 * Provides the base implementation for the proposal2 phase local service.
 *
 * <p>
...
public abstract class Proposal2PhaseLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements Proposal2PhaseLocalService,
        IdentifiableBean {
    ...
    private Proposal2PhaseLocalServiceClpInvoker _clpInvoker = new Proposal2PhaseLocalServiceClpInvoker();
    ...
    public Proposal2Phase addProposal2Phase(Proposal2Phase proposal2Phase)
        ...
        return proposal2PhasePersistence.update(proposal2Phase);
    }
    ...
    @Override
    public Proposal2Phase deleteProposal2Phase(
        Proposal2PhasePK proposal2PhasePK)
        throws PortalException, SystemException {
        return proposal2PhasePersistence.remove(proposal2PhasePK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Proposal2Phase deleteProposal2Phase(Proposal2Phase proposal2Phase)
        throws SystemException {
        return proposal2PhasePersistence.remove(proposal2Phase);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Proposal2Phase.class,
