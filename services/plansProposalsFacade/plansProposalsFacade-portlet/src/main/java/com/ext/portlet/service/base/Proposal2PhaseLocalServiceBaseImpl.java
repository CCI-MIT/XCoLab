...
/**
 * The base implementation of the proposal2 phase local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.Proposal2PhaseLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class Proposal2PhaseLocalServiceBaseImpl
    implements Proposal2PhaseLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(Proposal2PhaseLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.Proposal2PhaseLocalServiceUtil} to access the proposal2 phase local service.
     */
     ...
     */
    public Proposal2Phase addProposal2Phase(Proposal2Phase proposal2Phase)
        throws SystemException {
        proposal2Phase.setNew(true);

        proposal2Phase = proposal2PhasePersistence.update(proposal2Phase, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(proposal2Phase);
     ...
     */
    public Proposal2Phase createProposal2Phase(
        Proposal2PhasePK proposal2PhasePK) {
        return proposal2PhasePersistence.create(proposal2PhasePK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposal2Phase(Proposal2PhasePK proposal2PhasePK)
        throws PortalException, SystemException {
        Proposal2Phase proposal2Phase = proposal2PhasePersistence.remove(proposal2PhasePK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposal2Phase);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteProposal2Phase(Proposal2Phase proposal2Phase)
        throws SystemException {
        proposal2PhasePersistence.remove(proposal2Phase);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposal2PhasePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposal2PhasePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Proposal2Phase fetchProposal2Phase(Proposal2PhasePK proposal2PhasePK)
        throws SystemException {
        return proposal2PhasePersistence.fetchByPrimaryKey(proposal2PhasePK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Proposal2Phase getProposal2Phase(Proposal2PhasePK proposal2PhasePK)
        throws PortalException, SystemException {
        return proposal2PhasePersistence.findByPrimaryKey(proposal2PhasePK);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposal2PhasePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Proposal2Phase> getProposal2Phases(int start, int end)
        throws SystemException {
        return proposal2PhasePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getProposal2PhasesCount() throws SystemException {
        return proposal2PhasePersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Proposal2Phase updateProposal2Phase(Proposal2Phase proposal2Phase)
        throws SystemException {
        return updateProposal2Phase(proposal2Phase, true);
    }
    ...
    public Proposal2Phase updateProposal2Phase(Proposal2Phase proposal2Phase,
        ...
        proposal2Phase = proposal2PhasePersistence.update(proposal2Phase, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Proposal2Phase",
            proposal2PhaseLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposal2PhasePersistence.getDataSource();
