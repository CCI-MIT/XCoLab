...
/**
 * The base implementation of the plan type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.plans.service.impl.PlanTypeLocalServiceImpl
 * @see com.ext.portlet.plans.service.PlanTypeLocalServiceUtil
 * @generated
 */
public abstract class PlanTypeLocalServiceBaseImpl
    implements PlanTypeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanTypeLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanTypeLocalServiceUtil} to access the plan type local service.
     */
    ...
    public PlanType addPlanType(PlanType planType) throws SystemException {
        ...
        planType = planTypePersistence.update(planType, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planType);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return planTypePersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanType updatePlanType(PlanType planType) throws SystemException {
        return updatePlanType(planType, true);
    }
    ...
    public PlanType updatePlanType(PlanType planType, boolean merge)
        ...
        planType = planTypePersistence.update(planType, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanType",
            planTypeLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanType");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planTypePersistence.getDataSource();
