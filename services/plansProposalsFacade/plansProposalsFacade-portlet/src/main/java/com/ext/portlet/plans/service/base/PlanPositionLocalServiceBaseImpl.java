...
/**
 * The base implementation of the plan position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanPositionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanPositionLocalServiceBaseImpl
    implements PlanPositionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanPositionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanPositionLocalServiceUtil} to access the plan position local service.
     */
    ...
    public PlanPosition addPlanPosition(PlanPosition planPosition)
        ...
        planPosition = planPositionPersistence.update(planPosition, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planPosition);
    ...
    public void deletePlanPosition(PlanPositionPK planPositionPK)
        ...
        PlanPosition planPosition = planPositionPersistence.remove(planPositionPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planPosition);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PlanPosition updatePlanPosition(PlanPosition planPosition)
        throws SystemException {
        return updatePlanPosition(planPosition, true);
    }
    ...
    public PlanPosition updatePlanPosition(PlanPosition planPosition,
        ...
        planPosition = planPositionPersistence.update(planPosition, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanPosition",
            planPositionLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanPosition");
    }
