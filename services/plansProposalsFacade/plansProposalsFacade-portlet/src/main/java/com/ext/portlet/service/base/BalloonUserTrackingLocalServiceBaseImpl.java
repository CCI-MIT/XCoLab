...
import com.ext.portlet.service.BalloonUserTrackingLocalService;
...
/**
 * Provides the base implementation for the balloon user tracking local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.BalloonUserTrackingLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BalloonUserTrackingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements BalloonUserTrackingLocalService,
        IdentifiableBean {
    ...
    private BalloonUserTrackingLocalServiceClpInvoker _clpInvoker = new BalloonUserTrackingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.BalloonUserTrackingLocalServiceUtil} to access the balloon user tracking local service.
     */
    ...
    @Override
    public BalloonUserTracking addBalloonUserTracking(
        BalloonUserTracking balloonUserTracking) throws SystemException {
        balloonUserTracking.setNew(true);

        return balloonUserTrackingPersistence.update(balloonUserTracking);
    }
     ...
     */
    @Override
    public BalloonUserTracking createBalloonUserTracking(String uuid) {
        return balloonUserTrackingPersistence.create(uuid);
    }
    ...
    @Override
    public BalloonUserTracking deleteBalloonUserTracking(String uuid)
        throws PortalException, SystemException {
        return balloonUserTrackingPersistence.remove(uuid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public BalloonUserTracking deleteBalloonUserTracking(
        BalloonUserTracking balloonUserTracking) throws SystemException {
        return balloonUserTrackingPersistence.remove(balloonUserTracking);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(BalloonUserTracking.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return balloonUserTrackingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonUserTrackingPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public BalloonUserTracking fetchBalloonUserTracking(String uuid)
        throws SystemException {
        return balloonUserTrackingPersistence.fetchByPrimaryKey(uuid);
    }
     ...
     */
    @Override
    public BalloonUserTracking getBalloonUserTracking(String uuid)
        throws PortalException, SystemException {
        return balloonUserTrackingPersistence.findByPrimaryKey(uuid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return balloonUserTrackingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<BalloonUserTracking> getBalloonUserTrackings(int start, int end)
        throws SystemException {
        return balloonUserTrackingPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBalloonUserTrackingsCount() throws SystemException {
        return balloonUserTrackingPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public BalloonUserTracking updateBalloonUserTracking(
        BalloonUserTracking balloonUserTracking) throws SystemException {
        return balloonUserTrackingPersistence.update(balloonUserTracking);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.BalloonUserTracking",
            balloonUserTrackingLocalService);
    }
