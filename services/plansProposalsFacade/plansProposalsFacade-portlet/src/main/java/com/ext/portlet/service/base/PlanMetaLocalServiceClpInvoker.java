...
public class PlanMetaLocalServiceClpInvoker {
    ...
    public PlanMetaLocalServiceClpInvoker() {
        ...
        _methodParameterTypes575 = new String[] { "com.ext.portlet.model.PlanMeta" };

        _methodName576 = "vote";

        _methodParameterTypes576 = new String[] { "com.ext.portlet.model.PlanMeta" };

        _methodName577 = "unvote";

        _methodParameterTypes577 = new String[] { "com.ext.portlet.model.PlanMeta" };
    }
