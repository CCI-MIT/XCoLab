...
public class PlanMetaLocalServiceClpInvoker {
    ...
    public PlanMetaLocalServiceClpInvoker() {
        ...
        _methodParameterTypes599 = new String[] { "com.ext.portlet.model.PlanMeta" };

        _methodName600 = "vote";

        _methodParameterTypes600 = new String[] { "com.ext.portlet.model.PlanMeta" };

        _methodName601 = "unvote";
