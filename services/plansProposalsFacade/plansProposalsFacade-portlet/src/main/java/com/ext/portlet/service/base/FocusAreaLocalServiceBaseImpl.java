...
/**
 * Provides the base implementation for the focus area local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.FocusAreaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FocusAreaLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    private FocusAreaLocalServiceClpInvoker _clpInvoker = new FocusAreaLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.FocusAreaLocalServiceUtil} to access the focus area local service.
     */
    ...
    public FocusArea addFocusArea(FocusArea focusArea)
        ...
        return focusAreaPersistence.update(focusArea);
    }
    ...
    @Override
    public FocusArea deleteFocusArea(long id)
        throws PortalException, SystemException {
        return focusAreaPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FocusArea deleteFocusArea(FocusArea focusArea)
        throws SystemException {
        return focusAreaPersistence.remove(focusArea);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FocusArea.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.FocusArea",
