...
import com.ext.portlet.service.User_LocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.User_LocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class User_LocalServiceBaseImpl extends BaseLocalServiceImpl
    implements User_LocalService, IdentifiableBean {
    ...
    private User_LocalServiceClpInvoker _clpInvoker = new User_LocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.User_LocalServiceUtil} to access the user_ local service.
     */
    ...
    @Override
    public User_ addUser_(User_ user_) throws SystemException {
        user_.setNew(true);
    ...
    @Override
    public User_ deleteUser_(long userId)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public User_ deleteUser_(User_ user_) throws SystemException {
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(User_.class,
    ...
    @Override
    public User_ fetchUser_(long userId) throws SystemException {
     ...
     */
    @Override
    public User_ getUser_(long userId) throws PortalException, SystemException {
     ...
     */
    @Override
    public List<User_> getUser_s(int start, int end) throws SystemException {
     ...
     */
    @Override
    public int getUser_sCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public User_ updateUser_(User_ user_) throws SystemException {
        return user_Persistence.update(user_);
    }
    ...
    public void addRole_User_(long roleId, long userId)
        throws SystemException {
        role_Persistence.addUser_(roleId, userId);
    }
     ...
     */
    @Override
    public void addRole_User_(long roleId, User_ user_)
        throws SystemException {
        role_Persistence.addUser_(roleId, user_);
    }
    ...
    public void addRole_User_s(long roleId, long[] userIds)
        throws SystemException {
        role_Persistence.addUser_s(roleId, userIds);
    }
     ...
     */
    @Override
    public void addRole_User_s(long roleId, List<User_> User_s)
        throws SystemException {
        role_Persistence.addUser_s(roleId, User_s);
    }
     ...
     */
    @Override
    public void clearRole_User_s(long roleId) throws SystemException {
        role_Persistence.clearUser_s(roleId);
    }
    ...
    public void deleteRole_User_(long roleId, long userId)
        throws SystemException {
        role_Persistence.removeUser_(roleId, userId);
    }
     ...
     */
    @Override
    public void deleteRole_User_(long roleId, User_ user_)
        throws SystemException {
        role_Persistence.removeUser_(roleId, user_);
    }
    ...
    public void deleteRole_User_s(long roleId, long[] userIds)
        throws SystemException {
        role_Persistence.removeUser_s(roleId, userIds);
    }
     ...
     */
    @Override
    public void deleteRole_User_s(long roleId, List<User_> User_s)
        throws SystemException {
        role_Persistence.removeUser_s(roleId, User_s);
    }
     ...
     */
    @Override
    public List<User_> getRole_User_s(long roleId) throws SystemException {
        return role_Persistence.getUser_s(roleId);
    }
     ...
     */
    @Override
    public List<User_> getRole_User_s(long roleId, int start, int end)
        throws SystemException {
        return role_Persistence.getUser_s(roleId, start, end);
    }
    ...
    public List<User_> getRole_User_s(long roleId, int start, int end,
        OrderByComparator orderByComparator) throws SystemException {
        return role_Persistence.getUser_s(roleId, start, end, orderByComparator);
    }
     ...
     */
    @Override
    public int getRole_User_sCount(long roleId) throws SystemException {
        return role_Persistence.getUser_sSize(roleId);
    }
    ...
    public boolean hasRole_User_(long roleId, long userId)
        throws SystemException {
        return role_Persistence.containsUser_(roleId, userId);
    }
     ...
     */
    @Override
    public boolean hasRole_User_s(long roleId) throws SystemException {
        return role_Persistence.containsUser_s(roleId);
    }
    ...
    public void setRole_User_s(long roleId, long[] userIds)
        throws SystemException {
        role_Persistence.setUser_s(roleId, userIds);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.User_",
            user_LocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.User_");
    }
