...
/**
 * Provides the base implementation for the model position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelPositionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ModelPositionLocalServiceImpl
...
public abstract class ModelPositionLocalServiceBaseImpl
    ...
    private ModelPositionLocalServiceClpInvoker _clpInvoker = new ModelPositionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelPositionLocalServiceUtil} to access the model position local service.
     */
    ...
    @Override
    public ModelPosition deleteModelPosition(long id)
        throws PortalException, SystemException {
        return modelPositionPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ModelPosition deleteModelPosition(ModelPosition modelPosition)
        throws SystemException {
        return modelPositionPersistence.remove(modelPosition);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ModelPosition.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return modelPositionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ModelPosition",
            modelPositionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = modelPositionPersistence.getDataSource();
