...
/**
 * The base implementation of the model position local service.
 *
 * <p>
...
public abstract class ModelPositionLocalServiceBaseImpl
    implements ModelPositionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ModelPositionLocalServiceBaseImpl.class);
    ...
    public ModelPosition addModelPosition(ModelPosition modelPosition)
        ...
        modelPosition = modelPositionPersistence.update(modelPosition, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(modelPosition);
    ...
    public ModelPosition updateModelPosition(ModelPosition modelPosition)
        throws SystemException {
        return updateModelPosition(modelPosition, true);
    }
    ...
    public ModelPosition updateModelPosition(ModelPosition modelPosition,
        ...
        modelPosition = modelPositionPersistence.update(modelPosition, merge);
