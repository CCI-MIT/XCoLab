 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.StaffMemberLocalServiceImpl}.
 * </p>
 *
...
public abstract class StaffMemberLocalServiceBaseImpl
    ...
    private StaffMemberLocalServiceClpInvoker _clpInvoker = new StaffMemberLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.StaffMemberLocalServiceUtil} to access the staff member local service.
     */
     ...
     */
    @Override
    public StaffMember createStaffMember(long id) {
        return staffMemberPersistence.create(id);
    }
    ...
    @Override
    public StaffMember deleteStaffMember(long id)
        throws PortalException, SystemException {
        return staffMemberPersistence.remove(id);
    }
    ...
    @Override
    public StaffMember fetchStaffMember(long id) throws SystemException {
        return staffMemberPersistence.fetchByPrimaryKey(id);
    }
    ...
    public StaffMember getStaffMember(long id)
        throws PortalException, SystemException {
        return staffMemberPersistence.findByPrimaryKey(id);
    }
     ...
     */
    @Override
    public int getStaffMembersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.StaffMember",
