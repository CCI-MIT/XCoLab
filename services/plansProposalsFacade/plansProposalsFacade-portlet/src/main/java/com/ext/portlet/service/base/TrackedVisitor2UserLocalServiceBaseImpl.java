...
import com.ext.portlet.service.TrackedVisitor2UserLocalService;
...
/**
 * Provides the base implementation for the tracked visitor2 user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.TrackedVisitor2UserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TrackedVisitor2UserLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements TrackedVisitor2UserLocalService,
        IdentifiableBean {
    ...
    private TrackedVisitor2UserLocalServiceClpInvoker _clpInvoker = new TrackedVisitor2UserLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.TrackedVisitor2UserLocalServiceUtil} to access the tracked visitor2 user local service.
     */
    ...
    @Override
    public TrackedVisitor2User addTrackedVisitor2User(
        TrackedVisitor2User trackedVisitor2User) throws SystemException {
        trackedVisitor2User.setNew(true);

        return trackedVisitor2UserPersistence.update(trackedVisitor2User);
    }
     ...
     */
    @Override
    public TrackedVisitor2User createTrackedVisitor2User(long id) {
        return trackedVisitor2UserPersistence.create(id);
    }
    ...
    @Override
    public TrackedVisitor2User deleteTrackedVisitor2User(long id)
        throws PortalException, SystemException {
        return trackedVisitor2UserPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public TrackedVisitor2User deleteTrackedVisitor2User(
        TrackedVisitor2User trackedVisitor2User) throws SystemException {
        return trackedVisitor2UserPersistence.remove(trackedVisitor2User);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(TrackedVisitor2User.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return trackedVisitor2UserPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return trackedVisitor2UserPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public TrackedVisitor2User fetchTrackedVisitor2User(long id)
        throws SystemException {
        return trackedVisitor2UserPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public TrackedVisitor2User getTrackedVisitor2User(long id)
        throws PortalException, SystemException {
        return trackedVisitor2UserPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return trackedVisitor2UserPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<TrackedVisitor2User> getTrackedVisitor2Users(int start, int end)
        throws SystemException {
        return trackedVisitor2UserPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getTrackedVisitor2UsersCount() throws SystemException {
        return trackedVisitor2UserPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public TrackedVisitor2User updateTrackedVisitor2User(
        TrackedVisitor2User trackedVisitor2User) throws SystemException {
        return trackedVisitor2UserPersistence.update(trackedVisitor2User);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.TrackedVisitor2User",
            trackedVisitor2UserLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = trackedVisitor2UserPersistence.getDataSource();
