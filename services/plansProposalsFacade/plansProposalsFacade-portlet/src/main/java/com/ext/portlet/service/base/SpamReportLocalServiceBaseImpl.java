...
import com.ext.portlet.service.SpamReportLocalService;
...
/**
 * Provides the base implementation for the spam report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.SpamReportLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SpamReportLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements SpamReportLocalService,
        IdentifiableBean {
    ...
    private SpamReportLocalServiceClpInvoker _clpInvoker = new SpamReportLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.SpamReportLocalServiceUtil} to access the spam report local service.
     */
    ...
    @Override
    public SpamReport addSpamReport(SpamReport spamReport)
        throws SystemException {
        spamReport.setNew(true);

        return spamReportPersistence.update(spamReport);
    }
     ...
     */
    @Override
    public SpamReport createSpamReport(long id_) {
        return spamReportPersistence.create(id_);
    }
    ...
    @Override
    public SpamReport deleteSpamReport(long id_)
        throws PortalException, SystemException {
        return spamReportPersistence.remove(id_);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public SpamReport deleteSpamReport(SpamReport spamReport)
        throws SystemException {
        return spamReportPersistence.remove(spamReport);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(SpamReport.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return spamReportPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return spamReportPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return spamReportPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public SpamReport fetchSpamReport(long id_) throws SystemException {
        return spamReportPersistence.fetchByPrimaryKey(id_);
    }
     ...
     */
    @Override
    public SpamReport getSpamReport(long id_)
        throws PortalException, SystemException {
        return spamReportPersistence.findByPrimaryKey(id_);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return spamReportPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<SpamReport> getSpamReports(int start, int end)
        throws SystemException {
        return spamReportPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getSpamReportsCount() throws SystemException {
        return spamReportPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public SpamReport updateSpamReport(SpamReport spamReport)
        throws SystemException {
        return spamReportPersistence.update(spamReport);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.SpamReport",
            spamReportLocalService);
    }
