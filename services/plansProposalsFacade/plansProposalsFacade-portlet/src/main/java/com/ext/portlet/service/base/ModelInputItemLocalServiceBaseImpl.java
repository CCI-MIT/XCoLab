...
/**
 * Provides the base implementation for the model input item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelInputItemLocalServiceImpl}.
 * </p>
 *
...
public abstract class ModelInputItemLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ModelInputItemLocalService,
        IdentifiableBean {
    ...
    private ModelInputItemLocalServiceClpInvoker _clpInvoker = new ModelInputItemLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelInputItemLocalServiceUtil} to access the model input item local service.
     */
    ...
    public ModelInputItem addModelInputItem(ModelInputItem modelInputItem)
        ...
        return modelInputItemPersistence.update(modelInputItem);
    }
    ...
    @Override
    public ModelInputItem deleteModelInputItem(long modelInputItemPK)
        throws PortalException, SystemException {
        return modelInputItemPersistence.remove(modelInputItemPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ModelInputItem deleteModelInputItem(ModelInputItem modelInputItem)
        throws SystemException {
        return modelInputItemPersistence.remove(modelInputItem);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ModelInputItem.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return modelInputItemPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ModelInputItem",
            modelInputItemLocalService);
    }
