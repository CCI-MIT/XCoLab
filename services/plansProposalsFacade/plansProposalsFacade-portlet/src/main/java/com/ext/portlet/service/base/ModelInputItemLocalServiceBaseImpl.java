...
/**
 * The base implementation of the model input item local service.
 *
 * <p>
...
public abstract class ModelInputItemLocalServiceBaseImpl
    implements ModelInputItemLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ModelInputItemLocalServiceBaseImpl.class);
    ...
    public ModelInputItem addModelInputItem(ModelInputItem modelInputItem)
        ...
        modelInputItem = modelInputItemPersistence.update(modelInputItem, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(modelInputItem);
    ...
    public ModelInputItem updateModelInputItem(ModelInputItem modelInputItem)
        throws SystemException {
        return updateModelInputItem(modelInputItem, true);
    }
    ...
    public ModelInputItem updateModelInputItem(ModelInputItem modelInputItem,
        ...
        modelInputItem = modelInputItemPersistence.update(modelInputItem, merge);
