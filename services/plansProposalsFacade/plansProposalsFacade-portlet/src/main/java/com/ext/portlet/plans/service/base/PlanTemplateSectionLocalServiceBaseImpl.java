...
/**
 * The base implementation of the plan template section local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanTemplateSectionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanTemplateSectionLocalServiceBaseImpl
    implements PlanTemplateSectionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanTemplateSectionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanTemplateSectionLocalServiceUtil} to access the plan template section local service.
     */
    ...
    public PlanTemplateSection addPlanTemplateSection(
        ...
        planTemplateSection = planTemplateSectionPersistence.update(planTemplateSection,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planTemplateSection);
    ...
    public void deletePlanTemplateSection(
        ...
        PlanTemplateSection planTemplateSection = planTemplateSectionPersistence.remove(planTemplateSectionPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planTemplateSection);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planTemplateSectionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public PlanTemplateSection fetchPlanTemplateSection(
        PlanTemplateSectionPK planTemplateSectionPK) throws SystemException {
        return planTemplateSectionPersistence.fetchByPrimaryKey(planTemplateSectionPK);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planTemplateSectionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanTemplateSection updatePlanTemplateSection(
        PlanTemplateSection planTemplateSection) throws SystemException {
        return updatePlanTemplateSection(planTemplateSection, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanTemplateSection",
            planTemplateSectionLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanTemplateSection");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planTemplateSectionPersistence.getDataSource();
