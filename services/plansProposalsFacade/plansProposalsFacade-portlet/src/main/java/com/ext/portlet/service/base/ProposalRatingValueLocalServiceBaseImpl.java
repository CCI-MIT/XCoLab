...
import com.ext.portlet.service.ProposalRatingValueLocalService;
...
/**
 * Provides the base implementation for the proposal rating value local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalRatingValueLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalRatingValueLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalRatingValueLocalService,
        IdentifiableBean {
    ...
    private ProposalRatingValueLocalServiceClpInvoker _clpInvoker = new ProposalRatingValueLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalRatingValueLocalServiceUtil} to access the proposal rating value local service.
     */
    ...
    @Override
    public ProposalRatingValue addProposalRatingValue(
        ProposalRatingValue proposalRatingValue) throws SystemException {
        proposalRatingValue.setNew(true);

        return proposalRatingValuePersistence.update(proposalRatingValue);
    }
     ...
     */
    @Override
    public ProposalRatingValue createProposalRatingValue(
        ProposalRatingValuePK proposalRatingValuePK) {
        return proposalRatingValuePersistence.create(proposalRatingValuePK);
    }
    ...
    @Override
    public ProposalRatingValue deleteProposalRatingValue(
        ProposalRatingValuePK proposalRatingValuePK)
        throws PortalException, SystemException {
        return proposalRatingValuePersistence.remove(proposalRatingValuePK);
    }
    ...
    public ProposalRatingValue deleteProposalRatingValue(
        ProposalRatingValue proposalRatingValue) throws SystemException {
        return proposalRatingValuePersistence.remove(proposalRatingValue);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalRatingValue.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return proposalRatingValuePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalRatingValuePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProposalRatingValue fetchProposalRatingValue(
        ProposalRatingValuePK proposalRatingValuePK) throws SystemException {
        return proposalRatingValuePersistence.fetchByPrimaryKey(proposalRatingValuePK);
    }
     ...
     */
    @Override
    public ProposalRatingValue getProposalRatingValue(
        ProposalRatingValuePK proposalRatingValuePK)
        throws PortalException, SystemException {
        return proposalRatingValuePersistence.findByPrimaryKey(proposalRatingValuePK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalRatingValuePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalRatingValue> getProposalRatingValues(int start, int end)
        throws SystemException {
        return proposalRatingValuePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalRatingValuesCount() throws SystemException {
        return proposalRatingValuePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalRatingValue updateProposalRatingValue(
        ProposalRatingValue proposalRatingValue) throws SystemException {
        return proposalRatingValuePersistence.update(proposalRatingValue);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalRatingValue",
            proposalRatingValueLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalRatingValuePersistence.getDataSource();
