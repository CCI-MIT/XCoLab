...
public abstract class ProposalRatingValueLocalServiceBaseImpl
     ...
     */
    @Override
    public ProposalRatingValue createProposalRatingValue(long id) {
        return proposalRatingValuePersistence.create(id);
    }
    ...
    @Override
    public ProposalRatingValue deleteProposalRatingValue(long id)
        throws PortalException, SystemException {
        return proposalRatingValuePersistence.remove(id);
    }
    ...
    @Override
    public ProposalRatingValue fetchProposalRatingValue(long id)
        throws SystemException {
        return proposalRatingValuePersistence.fetchByPrimaryKey(id);
    }
    ...
    public ProposalRatingValue getProposalRatingValue(long id)
        throws PortalException, SystemException {
        return proposalRatingValuePersistence.findByPrimaryKey(id);
    }
