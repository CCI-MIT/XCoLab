...
import com.ext.portlet.service.Users_RolesLocalService;
...
/**
 * Provides the base implementation for the users_ roles local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.Users_RolesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.Users_RolesLocalServiceImpl
 * @see com.ext.portlet.service.Users_RolesLocalServiceUtil
 * @generated
 */
public abstract class Users_RolesLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements Users_RolesLocalService,
        IdentifiableBean {
    ...
    private Users_RolesLocalServiceClpInvoker _clpInvoker = new Users_RolesLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.Users_RolesLocalServiceUtil} to access the users_ roles local service.
     */
    ...
    @Override
    public Users_Roles addUsers_Roles(Users_Roles users_Roles)
        throws SystemException {
        users_Roles.setNew(true);

        return users_RolesPersistence.update(users_Roles);
    }
     ...
     */
    @Override
    public Users_Roles createUsers_Roles(Users_RolesPK users_RolesPK) {
        return users_RolesPersistence.create(users_RolesPK);
    }
    ...
    @Override
    public Users_Roles deleteUsers_Roles(Users_RolesPK users_RolesPK)
        throws PortalException, SystemException {
        return users_RolesPersistence.remove(users_RolesPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Users_Roles deleteUsers_Roles(Users_Roles users_Roles)
        throws SystemException {
        return users_RolesPersistence.remove(users_Roles);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Users_Roles.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return users_RolesPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return users_RolesPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return users_RolesPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Users_Roles fetchUsers_Roles(Users_RolesPK users_RolesPK)
        throws SystemException {
        return users_RolesPersistence.fetchByPrimaryKey(users_RolesPK);
    }
     ...
     */
    @Override
    public Users_Roles getUsers_Roles(Users_RolesPK users_RolesPK)
        throws PortalException, SystemException {
        return users_RolesPersistence.findByPrimaryKey(users_RolesPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return users_RolesPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Users_Roles> getUsers_Roleses(int start, int end)
        throws SystemException {
        return users_RolesPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getUsers_RolesesCount() throws SystemException {
        return users_RolesPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Users_Roles updateUsers_Roles(Users_Roles users_Roles)
        throws SystemException {
        return users_RolesPersistence.update(users_Roles);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Users_Roles",
            users_RolesLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.Users_Roles");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = users_RolesPersistence.getDataSource();
