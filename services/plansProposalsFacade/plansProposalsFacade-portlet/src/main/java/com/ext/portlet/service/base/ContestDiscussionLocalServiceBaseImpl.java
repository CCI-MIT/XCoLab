...
/**
 * Provides the base implementation for the contest discussion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestDiscussionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContestDiscussionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestDiscussionLocalService,
        IdentifiableBean {
    ...
    private ContestDiscussionLocalServiceClpInvoker _clpInvoker = new ContestDiscussionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestDiscussionLocalServiceUtil} to access the contest discussion local service.
     */
    ...
    @Override
    public ContestDiscussion addContestDiscussion(
        ContestDiscussion contestDiscussion) throws SystemException {
        contestDiscussion.setNew(true);

        return contestDiscussionPersistence.update(contestDiscussion);
    }
     ...
     */
    @Override
    public ContestDiscussion createContestDiscussion(long DiscussionId) {
        return contestDiscussionPersistence.create(DiscussionId);
    }
    ...
    @Override
    public ContestDiscussion deleteContestDiscussion(long DiscussionId)
        throws PortalException, SystemException {
        return contestDiscussionPersistence.remove(DiscussionId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestDiscussion deleteContestDiscussion(
        ContestDiscussion contestDiscussion) throws SystemException {
        return contestDiscussionPersistence.remove(contestDiscussion);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestDiscussion.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return contestDiscussionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestDiscussionPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ContestDiscussion fetchContestDiscussion(long DiscussionId)
        throws SystemException {
        return contestDiscussionPersistence.fetchByPrimaryKey(DiscussionId);
    }
     ...
     */
    @Override
    public ContestDiscussion getContestDiscussion(long DiscussionId)
        throws PortalException, SystemException {
        return contestDiscussionPersistence.findByPrimaryKey(DiscussionId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestDiscussionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContestDiscussion> getContestDiscussions(int start, int end)
        throws SystemException {
        return contestDiscussionPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContestDiscussionsCount() throws SystemException {
        return contestDiscussionPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContestDiscussion updateContestDiscussion(
        ContestDiscussion contestDiscussion) throws SystemException {
        return contestDiscussionPersistence.update(contestDiscussion);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestDiscussion",
            contestDiscussionLocalService);
    }
