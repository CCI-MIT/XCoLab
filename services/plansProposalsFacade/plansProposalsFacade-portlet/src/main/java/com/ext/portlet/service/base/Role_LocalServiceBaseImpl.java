...
/**
 * Provides the base implementation for the role_ local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.Role_LocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.Role_LocalServiceImpl
 * @see com.ext.portlet.service.Role_LocalServiceUtil
 * @generated
 */
public abstract class Role_LocalServiceBaseImpl extends BaseLocalServiceImpl
    implements Role_LocalService, IdentifiableBean {
    ...
    private Role_LocalServiceClpInvoker _clpInvoker = new Role_LocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.Role_LocalServiceUtil} to access the role_ local service.
     */
    ...
    @Override
    public Role_ addRole_(Role_ role_) throws SystemException {
        role_.setNew(true);

        return role_Persistence.update(role_);
    }
     ...
     */
    @Override
    public Role_ createRole_(long roleId) {
        return role_Persistence.create(roleId);
    }
    ...
    @Override
    public Role_ deleteRole_(long roleId)
        throws PortalException, SystemException {
        return role_Persistence.remove(roleId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Role_ deleteRole_(Role_ role_) throws SystemException {
        return role_Persistence.remove(role_);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Role_.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return role_Persistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return role_Persistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return role_Persistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return role_Persistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Role_ fetchRole_(long roleId) throws SystemException {
        return role_Persistence.fetchByPrimaryKey(roleId);
    }
     ...
     */
    @Override
    public Role_ getRole_(long roleId) throws PortalException, SystemException {
        return role_Persistence.findByPrimaryKey(roleId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return role_Persistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Role_> getRole_s(int start, int end) throws SystemException {
        return role_Persistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getRole_sCount() throws SystemException {
        return role_Persistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Role_ updateRole_(Role_ role_) throws SystemException {
        return role_Persistence.update(role_);
    }
    ...
    public void addUser_Role_(long userId, long roleId)
        throws SystemException {
        user_Persistence.addRole_(userId, roleId);
    }
     ...
     */
    @Override
    public void addUser_Role_(long userId, Role_ role_)
        throws SystemException {
        user_Persistence.addRole_(userId, role_);
    }
    ...
    public void addUser_Role_s(long userId, long[] roleIds)
        throws SystemException {
        user_Persistence.addRole_s(userId, roleIds);
    }
     ...
     */
    @Override
    public void addUser_Role_s(long userId, List<Role_> Role_s)
        throws SystemException {
        user_Persistence.addRole_s(userId, Role_s);
    }
     ...
     */
    @Override
    public void clearUser_Role_s(long userId) throws SystemException {
        user_Persistence.clearRole_s(userId);
    }
    ...
    public void deleteUser_Role_(long userId, long roleId)
        throws SystemException {
        user_Persistence.removeRole_(userId, roleId);
    }
     ...
     */
    @Override
    public void deleteUser_Role_(long userId, Role_ role_)
        throws SystemException {
        user_Persistence.removeRole_(userId, role_);
    }
    ...
    public void deleteUser_Role_s(long userId, long[] roleIds)
        throws SystemException {
        user_Persistence.removeRole_s(userId, roleIds);
    }
     ...
     */
    @Override
    public void deleteUser_Role_s(long userId, List<Role_> Role_s)
        throws SystemException {
        user_Persistence.removeRole_s(userId, Role_s);
    }
     ...
     */
    @Override
    public List<Role_> getUser_Role_s(long userId) throws SystemException {
        return user_Persistence.getRole_s(userId);
    }
     ...
     */
    @Override
    public List<Role_> getUser_Role_s(long userId, int start, int end)
        throws SystemException {
        return user_Persistence.getRole_s(userId, start, end);
    }
    ...
    public List<Role_> getUser_Role_s(long userId, int start, int end,
        OrderByComparator orderByComparator) throws SystemException {
        return user_Persistence.getRole_s(userId, start, end, orderByComparator);
    }
     ...
     */
    @Override
    public int getUser_Role_sCount(long userId) throws SystemException {
        return user_Persistence.getRole_sSize(userId);
    }
    ...
    public boolean hasUser_Role_(long userId, long roleId)
        throws SystemException {
        return user_Persistence.containsRole_(userId, roleId);
    }
     ...
     */
    @Override
    public boolean hasUser_Role_s(long userId) throws SystemException {
        return user_Persistence.containsRole_s(userId);
    }
    ...
    public void setUser_Role_s(long userId, long[] roleIds)
        throws SystemException {
        user_Persistence.setRole_s(userId, roleIds);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.Role_",
            role_LocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.Role_");
    }
