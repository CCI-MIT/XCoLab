...
/**
 * Provides the base implementation for the model runner local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelRunnerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ModelRunnerLocalServiceImpl
 * @see com.ext.portlet.service.ModelRunnerLocalServiceUtil
 * @generated
 */
public abstract class ModelRunnerLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ModelRunnerLocalService,
        IdentifiableBean {
    ...
    private ModelRunnerLocalServiceClpInvoker _clpInvoker = new ModelRunnerLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelRunnerLocalServiceUtil} to access the model runner local service.
     */
