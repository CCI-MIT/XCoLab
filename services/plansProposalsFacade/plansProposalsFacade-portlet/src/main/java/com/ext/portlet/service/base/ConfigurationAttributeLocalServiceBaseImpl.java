...
import com.ext.portlet.service.ConfigurationAttributeLocalService;
...
/**
 * Provides the base implementation for the configuration attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ConfigurationAttributeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ConfigurationAttributeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ConfigurationAttributeLocalService,
        IdentifiableBean {
    ...
    private ConfigurationAttributeLocalServiceClpInvoker _clpInvoker = new ConfigurationAttributeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ConfigurationAttributeLocalServiceUtil} to access the configuration attribute local service.
     */
    ...
    @Override
    public ConfigurationAttribute addConfigurationAttribute(
        ConfigurationAttribute configurationAttribute)
        throws SystemException {
        configurationAttribute.setNew(true);

        return configurationAttributePersistence.update(configurationAttribute);
    }
    ...
    public ConfigurationAttribute createConfigurationAttribute(
        ...
        return configurationAttributePersistence.create(configurationAttributePK);
    }
    ...
    @Override
    public ConfigurationAttribute deleteConfigurationAttribute(
        ConfigurationAttributePK configurationAttributePK)
        throws PortalException, SystemException {
        return configurationAttributePersistence.remove(configurationAttributePK);
    }
    ...
    public ConfigurationAttribute deleteConfigurationAttribute(
        ConfigurationAttribute configurationAttribute)
        throws SystemException {
        return configurationAttributePersistence.remove(configurationAttribute);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ConfigurationAttribute.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return configurationAttributePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return configurationAttributePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ConfigurationAttribute fetchConfigurationAttribute(
        ConfigurationAttributePK configurationAttributePK)
        throws SystemException {
        return configurationAttributePersistence.fetchByPrimaryKey(configurationAttributePK);
    }
     ...
     */
    @Override
    public ConfigurationAttribute getConfigurationAttribute(
        ConfigurationAttributePK configurationAttributePK)
        throws PortalException, SystemException {
        return configurationAttributePersistence.findByPrimaryKey(configurationAttributePK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return configurationAttributePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ConfigurationAttribute> getConfigurationAttributes(int start,
        int end) throws SystemException {
        return configurationAttributePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getConfigurationAttributesCount() throws SystemException {
        return configurationAttributePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ConfigurationAttribute updateConfigurationAttribute(
        ConfigurationAttribute configurationAttribute)
        throws SystemException {
        return configurationAttributePersistence.update(configurationAttribute);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ConfigurationAttribute",
            configurationAttributeLocalService);
    }
