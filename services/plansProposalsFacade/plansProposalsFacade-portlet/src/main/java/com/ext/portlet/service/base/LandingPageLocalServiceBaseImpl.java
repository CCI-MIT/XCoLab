...
/**
 * Provides the base implementation for the landing page local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.LandingPageLocalServiceImpl}.
 * </p>
 *
...
public abstract class LandingPageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LandingPageLocalService,
        IdentifiableBean {
    ...
    private LandingPageLocalServiceClpInvoker _clpInvoker = new LandingPageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.LandingPageLocalServiceUtil} to access the landing page local service.
     */
    ...
    public LandingPage addLandingPage(LandingPage landingPage)
        ...
        return landingPagePersistence.update(landingPage);
    }
    ...
    @Override
    public LandingPage deleteLandingPage(long id)
        throws PortalException, SystemException {
        return landingPagePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public LandingPage deleteLandingPage(LandingPage landingPage)
        throws SystemException {
        return landingPagePersistence.remove(landingPage);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LandingPage.class,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return landingPagePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LandingPage fetchLandingPage(long id) throws SystemException {
        return landingPagePersistence.fetchByPrimaryKey(id);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return landingPagePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.LandingPage",
            landingPageLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = landingPagePersistence.getDataSource();
