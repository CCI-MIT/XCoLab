...
public class ContestTeamMemberPersistenceImpl extends BasePersistenceImpl<ContestTeamMember>
    ...
    protected ContestTeamMember removeImpl(ContestTeamMember contestTeamMember)
        ...
        try {
            ...
            BatchSessionUtil.delete(session, contestTeamMember);
        } catch (Exception e) {
            throw processException(e);
        } finally {
            closeSession(session);
        ...
        if (isNew || !ContestTeamMemberModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((contestTeamMemberModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        Long.valueOf(contestTeamMemberModelImpl.getOriginalContestId())
                    };
                ...
                args = new Object[] {
                        Long.valueOf(contestTeamMemberModelImpl.getContestId())
                    };
     ...
     * @throws com.liferay.portal.NoSuchModelException if a contest team member with the primary key could not be found
     * @throws SystemException if a system exception occurred
     */
    @Override
        ...
        if (contestTeamMember == null) {
            ...
            try {
                ...
                if (contestTeamMember != null) {
                    ...
                    EntityCacheUtil.putResult(ContestTeamMemberModelImpl.ENTITY_CACHE_ENABLED,
                        ContestTeamMemberImpl.class, id, _nullContestTeamMember);
                }
    ...
    public List<ContestTeamMember> findAll(int start, int end,
        ...
        if (list == null) {
            ...
            if (orderByComparator != null) {
                ...
                sql = _SQL_SELECT_CONTESTTEAMMEMBER.concat(ContestTeamMemberModelImpl.ORDER_BY_JPQL);
            }
