...
/**
 * Provides the base implementation for the contest phase local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestPhaseLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContestPhaseLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestPhaseLocalService,
        IdentifiableBean {
    ...
    private ContestPhaseLocalServiceClpInvoker _clpInvoker = new ContestPhaseLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestPhaseLocalServiceUtil} to access the contest phase local service.
     */
    ...
    public ContestPhase addContestPhase(ContestPhase contestPhase)
        ...
        return contestPhasePersistence.update(contestPhase);
    }
    ...
    @Override
    public ContestPhase deleteContestPhase(long ContestPhasePK)
        throws PortalException, SystemException {
        return contestPhasePersistence.remove(ContestPhasePK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestPhase deleteContestPhase(ContestPhase contestPhase)
        throws SystemException {
        return contestPhasePersistence.remove(contestPhase);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestPhase.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestPhasePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestPhase",
            contestPhaseLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestPhasePersistence.getDataSource();
