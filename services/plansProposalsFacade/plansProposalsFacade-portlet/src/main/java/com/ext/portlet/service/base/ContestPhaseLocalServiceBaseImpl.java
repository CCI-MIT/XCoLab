...
/**
 * The base implementation of the contest phase local service.
 *
 * <p>
...
public abstract class ContestPhaseLocalServiceBaseImpl
    implements ContestPhaseLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ContestPhaseLocalServiceBaseImpl.class);
    ...
    public ContestPhase addContestPhase(ContestPhase contestPhase)
        ...
        contestPhase = contestPhasePersistence.update(contestPhase, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(contestPhase);
    ...
    public ContestPhase updateContestPhase(ContestPhase contestPhase)
        throws SystemException {
        return updateContestPhase(contestPhase, true);
    }
    ...
    public ContestPhase updateContestPhase(ContestPhase contestPhase,
        ...
        contestPhase = contestPhasePersistence.update(contestPhase, merge);
