...
import com.ext.portlet.service.ProposalRatingLocalService;
...
/**
 * Provides the base implementation for the proposal rating local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalRatingLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalRatingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalRatingLocalService,
        IdentifiableBean {
    ...
    private ProposalRatingLocalServiceClpInvoker _clpInvoker = new ProposalRatingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalRatingLocalServiceUtil} to access the proposal rating local service.
     */
    ...
    @Override
    public ProposalRating addProposalRating(ProposalRating proposalRating)
        throws SystemException {
        proposalRating.setNew(true);

        return proposalRatingPersistence.update(proposalRating);
    }
     ...
     */
    @Override
    public ProposalRating createProposalRating(long id) {
        return proposalRatingPersistence.create(id);
    }
    ...
    @Override
    public ProposalRating deleteProposalRating(long id)
        throws PortalException, SystemException {
        return proposalRatingPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProposalRating deleteProposalRating(ProposalRating proposalRating)
        throws SystemException {
        return proposalRatingPersistence.remove(proposalRating);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalRating.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalRatingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalRatingPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProposalRating fetchProposalRating(long id)
        throws SystemException {
        return proposalRatingPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public ProposalRating getProposalRating(long id)
        throws PortalException, SystemException {
        return proposalRatingPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalRatingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalRating> getProposalRatings(int start, int end)
        throws SystemException {
        return proposalRatingPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalRatingsCount() throws SystemException {
        return proposalRatingPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalRating updateProposalRating(ProposalRating proposalRating)
        throws SystemException {
        return proposalRatingPersistence.update(proposalRating);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalRating",
            proposalRatingLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalRatingPersistence.getDataSource();
