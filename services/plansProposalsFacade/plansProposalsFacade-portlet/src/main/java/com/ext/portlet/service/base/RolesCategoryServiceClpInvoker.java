 ...
 * @generated
 */
public class RolesCategoryServiceClpInvoker {
    ...
    public RolesCategoryServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName604.equals(name) &&
            ...
            return RolesCategoryServiceUtil.getBeanIdentifier();
        }

        if (_methodName605.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes605, parameterTypes)) {
            RolesCategoryServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
