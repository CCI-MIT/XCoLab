...
/**
 * Provides the base implementation for the contest debate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestDebateLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContestDebateLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestDebateLocalService,
        IdentifiableBean {
    ...
    private ContestDebateLocalServiceClpInvoker _clpInvoker = new ContestDebateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestDebateLocalServiceUtil} to access the contest debate local service.
     */
    ...
    public ContestDebate addContestDebate(ContestDebate contestDebate)
        ...
        return contestDebatePersistence.update(contestDebate);
    }
    ...
    @Override
    public ContestDebate deleteContestDebate(long id)
        throws PortalException, SystemException {
        return contestDebatePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestDebate deleteContestDebate(ContestDebate contestDebate)
        throws SystemException {
        return contestDebatePersistence.remove(contestDebate);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestDebate.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestDebate",
