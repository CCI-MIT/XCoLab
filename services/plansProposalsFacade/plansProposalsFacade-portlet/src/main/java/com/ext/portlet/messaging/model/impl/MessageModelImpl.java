...
public class MessageModelImpl extends BaseModelImpl<Message>
    ...
    public static final String TABLE_SQL_CREATE = "create table Messaging_Message (messageId LONG not null primary key,fromId LONG,repliesTo LONG,createDate DATE null,subject VARCHAR(75) null,content VARCHAR(75) null)";
    ...
    public static final String ORDER_BY_SQL = " ORDER BY Messaging_Message.createDate DESC";
