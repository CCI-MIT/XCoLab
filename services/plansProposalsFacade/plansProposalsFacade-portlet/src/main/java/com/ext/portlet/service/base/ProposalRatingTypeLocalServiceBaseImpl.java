...
import com.ext.portlet.service.ProposalRatingTypeLocalService;
...
/**
 * Provides the base implementation for the proposal rating type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalRatingTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.ProposalRatingTypeLocalServiceImpl
 * @see com.ext.portlet.service.ProposalRatingTypeLocalServiceUtil
 * @generated
 */
public abstract class ProposalRatingTypeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalRatingTypeLocalService,
        IdentifiableBean {
    ...
    private ProposalRatingTypeLocalServiceClpInvoker _clpInvoker = new ProposalRatingTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalRatingTypeLocalServiceUtil} to access the proposal rating type local service.
     */

    /**
     * Adds the proposal rating type to the database. Also notifies the appropriate model listeners.
     *
     * @param proposalRatingType the proposal rating type
     * @return the proposal rating type that was added
     * @throws SystemException if a system exception occurred
     */
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalRatingType addProposalRatingType(
        ProposalRatingType proposalRatingType) throws SystemException {
        proposalRatingType.setNew(true);

        return proposalRatingTypePersistence.update(proposalRatingType);
    }
     ...
     */
    @Override
    public ProposalRatingType createProposalRatingType(long ratingTypeId) {
        return proposalRatingTypePersistence.create(ratingTypeId);
    }
    ...
    @Override
    public ProposalRatingType deleteProposalRatingType(long ratingTypeId)
        throws PortalException, SystemException {
        return proposalRatingTypePersistence.remove(ratingTypeId);
    }

    /**
     * Deletes the proposal rating type from the database. Also notifies the appropriate model listeners.
     *
     * @param proposalRatingType the proposal rating type
     * @return the proposal rating type that was removed
     * @throws SystemException if a system exception occurred
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProposalRatingType deleteProposalRatingType(
        ProposalRatingType proposalRatingType) throws SystemException {
        return proposalRatingTypePersistence.remove(proposalRatingType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalRatingType.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return proposalRatingTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalRatingTypePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProposalRatingType fetchProposalRatingType(long ratingTypeId)
        throws SystemException {
        return proposalRatingTypePersistence.fetchByPrimaryKey(ratingTypeId);
    }
     ...
     */
    @Override
    public ProposalRatingType getProposalRatingType(long ratingTypeId)
        throws PortalException, SystemException {
        return proposalRatingTypePersistence.findByPrimaryKey(ratingTypeId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalRatingTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalRatingType> getProposalRatingTypes(int start, int end)
        throws SystemException {
        return proposalRatingTypePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalRatingTypesCount() throws SystemException {
        return proposalRatingTypePersistence.countAll();
    }

    /**
     * Updates the proposal rating type in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
     *
     * @param proposalRatingType the proposal rating type
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalRatingType updateProposalRatingType(
        ProposalRatingType proposalRatingType) throws SystemException {
        return proposalRatingTypePersistence.update(proposalRatingType);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalRatingType",
            proposalRatingTypeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalRatingTypePersistence.getDataSource();
