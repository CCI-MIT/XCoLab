...
public abstract class ProposalRatingTypeLocalServiceBaseImpl
     ...
     */
    @Override
    public ProposalRatingType createProposalRatingType(long id) {
        return proposalRatingTypePersistence.create(id);
    }
    ...
    @Override
    public ProposalRatingType deleteProposalRatingType(long id)
        throws PortalException, SystemException {
        return proposalRatingTypePersistence.remove(id);
    }
    ...
    @Override
    public ProposalRatingType fetchProposalRatingType(long id)
        throws SystemException {
        return proposalRatingTypePersistence.fetchByPrimaryKey(id);
    }
    ...
    public ProposalRatingType getProposalRatingType(long id)
        throws PortalException, SystemException {
        return proposalRatingTypePersistence.findByPrimaryKey(id);
    }
