 ...
 * @generated
 */
public class PlanPositionServiceClpInvoker {
    ...
    public PlanPositionServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName586.equals(name) &&
            ...
            return PlanPositionServiceUtil.getBeanIdentifier();
        }

        if (_methodName587.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes587, parameterTypes)) {
            PlanPositionServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
