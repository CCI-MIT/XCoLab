...
/**
 * Provides the base implementation for the message recipient status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessageRecipientStatusLocalServiceImpl}.
 * </p>
 *
...
public abstract class MessageRecipientStatusLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements MessageRecipientStatusLocalService,
        IdentifiableBean {
    ...
    private MessageRecipientStatusLocalServiceClpInvoker _clpInvoker = new MessageRecipientStatusLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessageRecipientStatusLocalServiceUtil} to access the message recipient status local service.
     */
    ...
    @Override
    public MessageRecipientStatus deleteMessageRecipientStatus(
        long messageRecipientId) throws PortalException, SystemException {
        return messageRecipientStatusPersistence.remove(messageRecipientId);
    }
    ...
    public MessageRecipientStatus deleteMessageRecipientStatus(
        MessageRecipientStatus messageRecipientStatus)
        throws SystemException {
        return messageRecipientStatusPersistence.remove(messageRecipientStatus);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MessageRecipientStatus.class,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return messageRecipientStatusPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        ...
        return messageRecipientStatusPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MessageRecipientStatus",
            messageRecipientStatusLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = messageRecipientStatusPersistence.getDataSource();
