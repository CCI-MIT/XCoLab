...
/**
 * The base implementation of the message recipient status local service.
 *
 * <p>
...
public abstract class MessageRecipientStatusLocalServiceBaseImpl
    implements MessageRecipientStatusLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(MessageRecipientStatusLocalServiceBaseImpl.class);
    ...
    public MessageRecipientStatus addMessageRecipientStatus(
        ...
        messageRecipientStatus = messageRecipientStatusPersistence.update(messageRecipientStatus,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(messageRecipientStatus);
    ...
    public void deleteMessageRecipientStatus(long messageRecipientId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(messageRecipientStatus);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public MessageRecipientStatus updateMessageRecipientStatus(
        MessageRecipientStatus messageRecipientStatus)
        throws SystemException {
        return updateMessageRecipientStatus(messageRecipientStatus, true);
    }
