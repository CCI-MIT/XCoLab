...
public class ProposalContestPhaseAttributeModelImpl extends BaseModelImpl<ProposalContestPhaseAttribute>
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_ProposalContestPhaseAttribute (id_ LONG not null primary key,proposalId LONG,contestPhaseId LONG,typeId LONG)";
    ...
    public Object clone() {
        ...
        proposalContestPhaseAttributeImpl.setTypeId(getTypeId());
    ...
    public CacheModel<ProposalContestPhaseAttribute> toCacheModel() {
        ...
        proposalContestPhaseAttributeCacheModel.typeId = getTypeId();
