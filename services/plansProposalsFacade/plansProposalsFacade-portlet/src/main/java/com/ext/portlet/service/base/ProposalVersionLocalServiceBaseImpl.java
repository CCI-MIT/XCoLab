...
/**
 * The base implementation of the proposal version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalVersionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalVersionLocalServiceBaseImpl
    implements ProposalVersionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalVersionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalVersionLocalServiceUtil} to access the proposal version local service.
     */
     ...
     */
    public ProposalVersion addProposalVersion(ProposalVersion proposalVersion)
        throws SystemException {
        proposalVersion.setNew(true);

        proposalVersion = proposalVersionPersistence.update(proposalVersion,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(proposalVersion);
     ...
     */
    public ProposalVersion createProposalVersion(
        ProposalVersionPK proposalVersionPK) {
        return proposalVersionPersistence.create(proposalVersionPK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalVersion(ProposalVersionPK proposalVersionPK)
        throws PortalException, SystemException {
        ProposalVersion proposalVersion = proposalVersionPersistence.remove(proposalVersionPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposalVersion);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalVersion(ProposalVersion proposalVersion)
        throws SystemException {
        proposalVersionPersistence.remove(proposalVersion);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalVersionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalVersionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ProposalVersion fetchProposalVersion(
        ProposalVersionPK proposalVersionPK) throws SystemException {
        return proposalVersionPersistence.fetchByPrimaryKey(proposalVersionPK);
    }
    ...
    public ProposalVersion getProposalVersion(
        ProposalVersionPK proposalVersionPK)
        throws PortalException, SystemException {
        return proposalVersionPersistence.findByPrimaryKey(proposalVersionPK);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalVersionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<ProposalVersion> getProposalVersions(int start, int end)
        throws SystemException {
        return proposalVersionPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getProposalVersionsCount() throws SystemException {
        return proposalVersionPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalVersion updateProposalVersion(
        ProposalVersion proposalVersion) throws SystemException {
        return updateProposalVersion(proposalVersion, true);
    }
     ...
     */
    public ProposalVersion updateProposalVersion(
        ProposalVersion proposalVersion, boolean merge)
        throws SystemException {
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalVersion",
            proposalVersionLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalVersionPersistence.getDataSource();
