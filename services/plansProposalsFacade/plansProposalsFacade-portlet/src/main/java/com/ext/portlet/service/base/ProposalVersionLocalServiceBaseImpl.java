...
/**
 * Provides the base implementation for the proposal version local service.
 *
 * <p>
...
public abstract class ProposalVersionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalVersionLocalService,
        IdentifiableBean {
    ...
    private ProposalVersionLocalServiceClpInvoker _clpInvoker = new ProposalVersionLocalServiceClpInvoker();
    ...
    public ProposalVersion addProposalVersion(ProposalVersion proposalVersion)
        ...
        return proposalVersionPersistence.update(proposalVersion);
    }
    ...
    @Override
    public ProposalVersion deleteProposalVersion(
        ProposalVersionPK proposalVersionPK)
        throws PortalException, SystemException {
        return proposalVersionPersistence.remove(proposalVersionPK);
    }
    ...
    public ProposalVersion deleteProposalVersion(
        ...
        return proposalVersionPersistence.remove(proposalVersion);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalVersion.class,
