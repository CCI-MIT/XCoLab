...
/**
 * The base implementation of the plan section definition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanSectionDefinitionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanSectionDefinitionLocalServiceBaseImpl
    implements PlanSectionDefinitionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanSectionDefinitionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanSectionDefinitionLocalServiceUtil} to access the plan section definition local service.
     */
    ...
    public PlanSectionDefinition addPlanSectionDefinition(
        ...
        planSectionDefinition = planSectionDefinitionPersistence.update(planSectionDefinition,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planSectionDefinition);
    ...
    public void deletePlanSectionDefinition(long id)
        ...
        PlanSectionDefinition planSectionDefinition = planSectionDefinitionPersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planSectionDefinition);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planSectionDefinitionPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public PlanSectionDefinition fetchPlanSectionDefinition(long id)
        throws SystemException {
        return planSectionDefinitionPersistence.fetchByPrimaryKey(id);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planSectionDefinitionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanSectionDefinition updatePlanSectionDefinition(
        PlanSectionDefinition planSectionDefinition) throws SystemException {
        return updatePlanSectionDefinition(planSectionDefinition, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanSectionDefinition",
            planSectionDefinitionLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanSectionDefinition");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planSectionDefinitionPersistence.getDataSource();
