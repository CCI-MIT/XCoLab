...
/**
 * Provides the base implementation for the proposal vote local service.
 *
 * <p>
...
public abstract class ProposalVoteLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalVoteLocalService,
        IdentifiableBean {
    ...
    private ProposalVoteLocalServiceClpInvoker _clpInvoker = new ProposalVoteLocalServiceClpInvoker();
    ...
    public ProposalVote addProposalVote(ProposalVote proposalVote)
        ...
        return proposalVotePersistence.update(proposalVote);
    }
    ...
    @Override
    public ProposalVote deleteProposalVote(ProposalVotePK proposalVotePK)
        throws PortalException, SystemException {
        return proposalVotePersistence.remove(proposalVotePK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProposalVote deleteProposalVote(ProposalVote proposalVote)
        throws SystemException {
        return proposalVotePersistence.remove(proposalVote);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalVote.class,
