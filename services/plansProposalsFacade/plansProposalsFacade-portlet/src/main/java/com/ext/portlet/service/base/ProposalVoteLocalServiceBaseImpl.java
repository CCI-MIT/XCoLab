...
/**
 * The base implementation of the proposal vote local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalVoteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalVoteLocalServiceBaseImpl
    implements ProposalVoteLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalVoteLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalVoteLocalServiceUtil} to access the proposal vote local service.
     */
     ...
     */
    public ProposalVote addProposalVote(ProposalVote proposalVote)
        throws SystemException {
        proposalVote.setNew(true);

        proposalVote = proposalVotePersistence.update(proposalVote, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(proposalVote);
     ...
     */
    public ProposalVote createProposalVote(ProposalVotePK proposalVotePK) {
        return proposalVotePersistence.create(proposalVotePK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalVote(ProposalVotePK proposalVotePK)
        throws PortalException, SystemException {
        ProposalVote proposalVote = proposalVotePersistence.remove(proposalVotePK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposalVote);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalVote(ProposalVote proposalVote)
        throws SystemException {
        proposalVotePersistence.remove(proposalVote);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalVotePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalVotePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ProposalVote fetchProposalVote(ProposalVotePK proposalVotePK)
        throws SystemException {
        return proposalVotePersistence.fetchByPrimaryKey(proposalVotePK);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalVote getProposalVote(ProposalVotePK proposalVotePK)
        throws PortalException, SystemException {
        return proposalVotePersistence.findByPrimaryKey(proposalVotePK);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalVotePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<ProposalVote> getProposalVotes(int start, int end)
        throws SystemException {
        return proposalVotePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getProposalVotesCount() throws SystemException {
        return proposalVotePersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalVote updateProposalVote(ProposalVote proposalVote)
        throws SystemException {
        return updateProposalVote(proposalVote, true);
    }
    ...
    public ProposalVote updateProposalVote(ProposalVote proposalVote,
        ...
        proposalVote = proposalVotePersistence.update(proposalVote, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalVote",
            proposalVoteLocalService);
    }
