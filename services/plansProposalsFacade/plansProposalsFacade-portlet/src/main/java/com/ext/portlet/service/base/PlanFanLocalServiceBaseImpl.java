...
/**
 * Provides the base implementation for the plan fan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanFanLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanFanLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PlanFanLocalService, IdentifiableBean {
    ...
    private PlanFanLocalServiceClpInvoker _clpInvoker = new PlanFanLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanFanLocalServiceUtil} to access the plan fan local service.
     */
    ...
    public PlanFan addPlanFan(PlanFan planFan) throws SystemException {
        ...
        return planFanPersistence.update(planFan);
    }
    ...
    @Override
    public PlanFan deletePlanFan(long id)
        throws PortalException, SystemException {
        return planFanPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanFan deletePlanFan(PlanFan planFan) throws SystemException {
        return planFanPersistence.remove(planFan);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanFan.class,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return planFanPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanFan",
            planFanLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.PlanFan");
    }
