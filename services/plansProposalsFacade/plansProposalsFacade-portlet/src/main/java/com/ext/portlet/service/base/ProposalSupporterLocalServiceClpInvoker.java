...
public class ProposalSupporterLocalServiceClpInvoker {
    ...
    public ProposalSupporterLocalServiceClpInvoker() {
        ...
        _methodName531 = "getProposals";

        _methodParameterTypes531 = new String[] { "long" };

        _methodName532 = "getSupportingUsersForProposal";

        _methodParameterTypes532 = new String[] { "long" };

        _methodName533 = "getProposalSupportersForProposals";

        _methodParameterTypes533 = new String[] { "java.util.List" };
    }
