...
public class ProposalSupporterLocalServiceClpInvoker {
    ...
    public ProposalSupporterLocalServiceClpInvoker() {
        ...
        _methodName495 = "getProposals";

        _methodParameterTypes495 = new String[] { "long" };

        _methodName496 = "getSupportingUsersForProposal";

        _methodParameterTypes496 = new String[] { "long" };

        _methodName497 = "getProposalSupportersForProposals";

        _methodParameterTypes497 = new String[] { "java.util.List" };
    }
