...
public class ProposalSupporterLocalServiceClpInvoker {
    ...
    public ProposalSupporterLocalServiceClpInvoker() {
        ...
        _methodName626 = "create";

        _methodParameterTypes626 = new String[] { "long", "long" };

        _methodName627 = "getProposals";

        _methodParameterTypes627 = new String[] { "long" };

        _methodName628 = "getSupportingUsersForProposal";

        _methodParameterTypes628 = new String[] { "long" };

        _methodName629 = "getProposalSupportersForProposals";

        _methodParameterTypes629 = new String[] { "java.util.List" };
    }
