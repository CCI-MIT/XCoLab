...
public class PointsDistributionConfigurationLocalServiceClpInvoker {
    ...
    public PointsDistributionConfigurationLocalServiceClpInvoker() {
        ...
        _methodName470 = "findByProposalIdPointTypeId";

        _methodParameterTypes470 = new String[] { "long", "long" };

        _methodName471 = "removeByProposalId";

        _methodParameterTypes471 = new String[] { "long" };

        _methodName472 = "getByPlanSectionDefinitionId";

        _methodParameterTypes472 = new String[] { "long" };

        _methodName473 = "addDistributionConfiguration";
        ...
        _methodName474 = "verifyDistributionConfigurationsForProposalId";
