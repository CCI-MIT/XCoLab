...
public class PointsDistributionConfigurationLocalServiceClpInvoker {
    ...
    public PointsDistributionConfigurationLocalServiceClpInvoker() {
        ...
        _methodName518 = "findByProposalIdPointTypeId";

        _methodParameterTypes518 = new String[] { "long", "long" };

        _methodName519 = "removeByProposalId";

        _methodParameterTypes519 = new String[] { "long" };

        _methodName520 = "getByPlanSectionDefinitionId";

        _methodParameterTypes520 = new String[] { "long" };

        _methodName521 = "addDistributionConfiguration";
        ...
        _methodName522 = "verifyDistributionConfigurationsForProposalId";
