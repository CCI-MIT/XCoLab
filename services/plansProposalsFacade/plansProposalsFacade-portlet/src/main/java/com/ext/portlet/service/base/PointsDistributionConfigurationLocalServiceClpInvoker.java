...
public class PointsDistributionConfigurationLocalServiceClpInvoker {
    ...
    public PointsDistributionConfigurationLocalServiceClpInvoker() {
        ...
        _methodName428 = "findByProposalIdPointTypeId";

        _methodParameterTypes428 = new String[] { "long", "long" };

        _methodName429 = "removeByProposalId";

        _methodParameterTypes429 = new String[] { "long" };

        _methodName430 = "getByPlanSectionDefinitionId";

        _methodParameterTypes430 = new String[] { "long" };

        _methodName431 = "addDistributionConfiguration";
        ...
        _methodName432 = "verifyDistributionConfigurationsForProposalId";
