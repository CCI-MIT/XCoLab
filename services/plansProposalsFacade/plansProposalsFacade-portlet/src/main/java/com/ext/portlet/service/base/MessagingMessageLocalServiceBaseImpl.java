...
/**
 * Provides the base implementation for the messaging message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessagingMessageLocalServiceImpl}.
 * </p>
 *
...
public abstract class MessagingMessageLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements MessagingMessageLocalService,
        IdentifiableBean {
    ...
    private MessagingMessageLocalServiceClpInvoker _clpInvoker = new MessagingMessageLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessagingMessageLocalServiceUtil} to access the messaging message local service.
     */
    ...
    public MessagingMessage addMessagingMessage(
        ...
        return messagingMessagePersistence.update(messagingMessage);
    }
    ...
    @Override
    public MessagingMessage deleteMessagingMessage(long messageId)
        throws PortalException, SystemException {
        return messagingMessagePersistence.remove(messageId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public MessagingMessage deleteMessagingMessage(
        MessagingMessage messagingMessage) throws SystemException {
        return messagingMessagePersistence.remove(messagingMessage);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MessagingMessage.class,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingMessagePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public MessagingMessage fetchMessagingMessage(long messageId)
        throws SystemException {
        return messagingMessagePersistence.fetchByPrimaryKey(messageId);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return messagingMessagePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MessagingMessage",
            messagingMessageLocalService);
    }
