...
/**
 * Provides the base implementation for the plan meta local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanMetaLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanMetaLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PlanMetaLocalService, IdentifiableBean {
    ...
    private PlanMetaLocalServiceClpInvoker _clpInvoker = new PlanMetaLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanMetaLocalServiceUtil} to access the plan meta local service.
     */
    ...
    public PlanMeta addPlanMeta(PlanMeta planMeta) throws SystemException {
        ...
        return planMetaPersistence.update(planMeta);
    }
    ...
    @Override
    public PlanMeta deletePlanMeta(long id)
        throws PortalException, SystemException {
        return planMetaPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanMeta deletePlanMeta(PlanMeta planMeta) throws SystemException {
        return planMetaPersistence.remove(planMeta);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanMeta.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return planMetaPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planMetaPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanMeta",
            planMetaLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.PlanMeta");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planMetaPersistence.getDataSource();
