...
/**
 * The base implementation of the plan meta local service.
 *
 * <p>
...
public abstract class PlanMetaLocalServiceBaseImpl
    ...
    private static Log _log = LogFactoryUtil.getLog(PlanMetaLocalServiceBaseImpl.class);
    ...
    public PlanMeta addPlanMeta(PlanMeta planMeta) throws SystemException {
        ...
        planMeta = planMetaPersistence.update(planMeta, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planMeta);
    ...
    public PlanMeta updatePlanMeta(PlanMeta planMeta) throws SystemException {
        return updatePlanMeta(planMeta, true);
    }
    ...
    public PlanMeta updatePlanMeta(PlanMeta planMeta, boolean merge)
        ...
        planMeta = planMetaPersistence.update(planMeta, merge);
