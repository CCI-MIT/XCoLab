...
/**
 * The base model implementation for the PlanTemplateSection service. Represents a row in the &quot;Plans_PlanTemplateSection&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PlanTemplateSectionModelImpl extends BaseModelImpl<PlanTemplateSection>
     ...
     */
    public static final String TABLE_NAME = "Plans_PlanTemplateSection";
    public static final Object[][] TABLE_COLUMNS = {
            { "planTemplateId", Types.BIGINT },
            { "planSectionId", Types.BIGINT },
            { "weight", Types.INTEGER }
        };
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanTemplateSection (planTemplateId LONG not null,planSectionId LONG not null,weight INTEGER,primary key (planTemplateId, planSectionId))";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanTemplateSection";
    public static final String ORDER_BY_JPQL = " ORDER BY planTemplateSection.weight ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Plans_PlanTemplateSection.weight ASC";
