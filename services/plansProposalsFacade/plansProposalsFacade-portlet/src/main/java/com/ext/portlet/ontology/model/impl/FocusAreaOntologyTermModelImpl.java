...
import com.ext.portlet.ontology.model.FocusAreaOntologyTermModel;
...
/**
 * The base model implementation for the FocusAreaOntologyTerm service. Represents a row in the &quot;ontology_FocusAreaOntologyTerm&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.ext.portlet.ontology.model.FocusAreaOntologyTermModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FocusAreaOntologyTermImpl}.
 * </p>
 *
...
public class FocusAreaOntologyTermModelImpl extends BaseModelImpl<FocusAreaOntologyTerm>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a focus area ontology term model instance should use the {@link com.ext.portlet.ontology.model.FocusAreaOntologyTerm} interface instead.
     */
    public static final String TABLE_NAME = "ontology_FocusAreaOntologyTerm";
    public static final Object[][] TABLE_COLUMNS = {
            { "focusAreaId", Types.BIGINT },
            { "ontologyTermId", Types.BIGINT }
        };
    public static final String TABLE_SQL_CREATE = "create table ontology_FocusAreaOntologyTerm (focusAreaId LONG not null,ontologyTermId LONG not null,primary key (focusAreaId, ontologyTermId))";
    public static final String TABLE_SQL_DROP = "drop table ontology_FocusAreaOntologyTerm";
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.ext.portlet.ontology.model.FocusAreaOntologyTerm"),
            true);
