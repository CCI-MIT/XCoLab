...
/**
 * Provides the base implementation for the messaging ignored recipients local service.
 *
 * <p>
...
public abstract class MessagingIgnoredRecipientsLocalServiceBaseImpl
    ...
    private MessagingIgnoredRecipientsLocalServiceClpInvoker _clpInvoker = new MessagingIgnoredRecipientsLocalServiceClpInvoker();
    ...
    @Override
    public MessagingIgnoredRecipients deleteMessagingIgnoredRecipients(
        long ignoredRecipientId) throws PortalException, SystemException {
        return messagingIgnoredRecipientsPersistence.remove(ignoredRecipientId);
    }
    ...
    public MessagingIgnoredRecipients deleteMessagingIgnoredRecipients(
        MessagingIgnoredRecipients messagingIgnoredRecipients)
        throws SystemException {
        return messagingIgnoredRecipientsPersistence.remove(messagingIgnoredRecipients);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MessagingIgnoredRecipients.class,
