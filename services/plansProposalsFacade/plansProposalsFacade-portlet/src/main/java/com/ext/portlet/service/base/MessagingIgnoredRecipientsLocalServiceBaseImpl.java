...
/**
 * The base implementation of the messaging ignored recipients local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessagingIgnoredRecipientsLocalServiceImpl}.
 * </p>
 *
...
public abstract class MessagingIgnoredRecipientsLocalServiceBaseImpl
    implements MessagingIgnoredRecipientsLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(MessagingIgnoredRecipientsLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessagingIgnoredRecipientsLocalServiceUtil} to access the messaging ignored recipients local service.
     */
    ...
    public MessagingIgnoredRecipients addMessagingIgnoredRecipients(
        ...
        messagingIgnoredRecipients = messagingIgnoredRecipientsPersistence.update(messagingIgnoredRecipients,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(messagingIgnoredRecipients);
    ...
    public void deleteMessagingIgnoredRecipients(long ignoredRecipientId)
        ...
        MessagingIgnoredRecipients messagingIgnoredRecipients = messagingIgnoredRecipientsPersistence.remove(ignoredRecipientId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(messagingIgnoredRecipients);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingIgnoredRecipientsPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public MessagingIgnoredRecipients fetchMessagingIgnoredRecipients(
        long ignoredRecipientId) throws SystemException {
        return messagingIgnoredRecipientsPersistence.fetchByPrimaryKey(ignoredRecipientId);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return messagingIgnoredRecipientsPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public MessagingIgnoredRecipients updateMessagingIgnoredRecipients(
        MessagingIgnoredRecipients messagingIgnoredRecipients)
        throws SystemException {
        return updateMessagingIgnoredRecipients(messagingIgnoredRecipients, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MessagingIgnoredRecipients",
            messagingIgnoredRecipientsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = messagingIgnoredRecipientsPersistence.getDataSource();
