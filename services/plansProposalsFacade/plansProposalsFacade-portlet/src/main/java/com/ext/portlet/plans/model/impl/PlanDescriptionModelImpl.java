...
/**
 * The base model implementation for the PlanDescription service. Represents a row in the &quot;Plans_PlanDescription&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PlanDescriptionModelImpl extends BaseModelImpl<PlanDescription>
     ...
     */
    public static final String TABLE_NAME = "Plans_PlanDescription";
    ...
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanDescription (id_ LONG not null primary key,planId LONG,name VARCHAR(75) null,description VARCHAR(75) null,version LONG,planVersion LONG,created DATE null,updateAuthorId LONG,image LONG,pitch VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanDescription";
    public static final String ORDER_BY_JPQL = " ORDER BY planDescription.id DESC";
    public static final String ORDER_BY_SQL = " ORDER BY Plans_PlanDescription.id_ DESC";
