...
/**
 * Provides the base implementation for the contest type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ContestTypeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContestTypeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContestTypeLocalService,
        IdentifiableBean {
    ...
    private ContestTypeLocalServiceClpInvoker _clpInvoker = new ContestTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ContestTypeLocalServiceUtil} to access the contest type local service.
     */
    ...
    @Override
    public ContestType addContestType(ContestType contestType)
        throws SystemException {
        contestType.setNew(true);

        return contestTypePersistence.update(contestType);
    }
     ...
     */
    @Override
    public ContestType createContestType(long id) {
        return contestTypePersistence.create(id);
    }
    ...
    @Override
    public ContestType deleteContestType(long id)
        throws PortalException, SystemException {
        return contestTypePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContestType deleteContestType(ContestType contestType)
        throws SystemException {
        return contestTypePersistence.remove(contestType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContestType.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return contestTypePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contestTypePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ContestType fetchContestType(long id) throws SystemException {
        return contestTypePersistence.fetchByPrimaryKey(id);
    }
    ...
    public ContestType getContestType(long id)
        throws PortalException, SystemException {
        return contestTypePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contestTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContestType> getContestTypes(int start, int end)
        throws SystemException {
        return contestTypePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContestTypesCount() throws SystemException {
        return contestTypePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContestType updateContestType(ContestType contestType)
        throws SystemException {
        return contestTypePersistence.update(contestType);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ContestType",
            contestTypeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contestTypePersistence.getDataSource();
