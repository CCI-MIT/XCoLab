...
import com.ext.portlet.service.MemberCategoryLocalService;
...
/**
 * Provides the base implementation for the member category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MemberCategoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class MemberCategoryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements MemberCategoryLocalService,
        IdentifiableBean {
    ...
    private MemberCategoryLocalServiceClpInvoker _clpInvoker = new MemberCategoryLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MemberCategoryLocalServiceUtil} to access the member category local service.
     */
    ...
    public MemberCategory addMemberCategory(MemberCategory memberCategory)
        ...
        return memberCategoryPersistence.update(memberCategory);
    }
     ...
     */
    @Override
    public MemberCategory createMemberCategory(long roleId) {
        return memberCategoryPersistence.create(roleId);
    }
    ...
    @Override
    public MemberCategory deleteMemberCategory(long roleId)
        throws PortalException, SystemException {
        return memberCategoryPersistence.remove(roleId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public MemberCategory deleteMemberCategory(MemberCategory memberCategory)
        throws SystemException {
        return memberCategoryPersistence.remove(memberCategory);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MemberCategory.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return memberCategoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return memberCategoryPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public MemberCategory fetchMemberCategory(long roleId)
        throws SystemException {
        return memberCategoryPersistence.fetchByPrimaryKey(roleId);
    }
    ...
    public MemberCategory getMemberCategory(long roleId)
        throws PortalException, SystemException {
        return memberCategoryPersistence.findByPrimaryKey(roleId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return memberCategoryPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<MemberCategory> getMemberCategories(int start, int end)
        throws SystemException {
        return memberCategoryPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getMemberCategoriesCount() throws SystemException {
        return memberCategoryPersistence.countAll();
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MemberCategory",
            memberCategoryLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = memberCategoryPersistence.getDataSource();
