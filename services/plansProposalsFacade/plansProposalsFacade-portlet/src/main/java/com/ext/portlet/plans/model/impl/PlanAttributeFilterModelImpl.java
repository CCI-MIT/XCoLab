...
public class PlanAttributeFilterModelImpl extends BaseModelImpl<PlanAttributeFilter>
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_PlanAttributeFilter (planAttributeFilterId LONG not null primary key,attributeName VARCHAR(75) null,planUserSettingsId LONG,max DOUBLE,min DOUBLE,stringVal VARCHAR(75) null)";
