...
import com.ext.portlet.plans.model.PlanAttributeFilterModel;
...
/**
 * The base model implementation for the PlanAttributeFilter service. Represents a row in the &quot;Plans_PlanAttributeFilter&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.ext.portlet.plans.model.PlanAttributeFilterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PlanAttributeFilterImpl}.
 * </p>
 *
...
public class PlanAttributeFilterModelImpl extends BaseModelImpl<PlanAttributeFilter>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a plan attribute filter model instance should use the {@link com.ext.portlet.plans.model.PlanAttributeFilter} interface instead.
     */
    public static final String TABLE_NAME = "Plans_PlanAttributeFilter";
    ...
    public static final String TABLE_SQL_CREATE = "create table Plans_PlanAttributeFilter (planAttributeFilterId LONG not null primary key,attributeName VARCHAR(75) null,planUserSettingsId LONG,max DOUBLE,min DOUBLE,stringVal VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table Plans_PlanAttributeFilter";
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.ext.portlet.plans.model.PlanAttributeFilter"),
            true);
