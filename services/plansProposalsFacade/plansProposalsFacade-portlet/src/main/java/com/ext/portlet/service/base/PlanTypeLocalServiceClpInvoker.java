...
public class PlanTypeLocalServiceClpInvoker {
    ...
    public PlanTypeLocalServiceClpInvoker() {
        ...
        _methodName558 = "getDefaultPlanType";

        _methodParameterTypes558 = new String[] {  };

        _methodName559 = "getColumnsByPlanTypeId";

        _methodParameterTypes559 = new String[] { "long" };

        _methodName560 = "getAttributesByPlanTypeId";

        _methodParameterTypes560 = new String[] { "long" };

        _methodName561 = "isRegionalType";

        _methodParameterTypes561 = new String[] { "long" };

        _methodName562 = "getAvailableModels";

        _methodParameterTypes562 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName563 = "getDefaultModel";

        _methodParameterTypes563 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName564 = "getColumns";

        _methodParameterTypes564 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName565 = "getAttributes";

        _methodParameterTypes565 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName566 = "isRegional";

        _methodParameterTypes566 = new String[] { "com.ext.portlet.model.PlanType" };
    }
