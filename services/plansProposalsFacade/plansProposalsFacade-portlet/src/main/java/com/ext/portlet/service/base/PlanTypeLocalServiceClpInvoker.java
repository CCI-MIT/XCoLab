...
public class PlanTypeLocalServiceClpInvoker {
    ...
    public PlanTypeLocalServiceClpInvoker() {
        ...
        _methodName484 = "getDefaultPlanType";

        _methodParameterTypes484 = new String[] {  };

        _methodName485 = "getColumnsByPlanTypeId";

        _methodParameterTypes485 = new String[] { "long" };

        _methodName486 = "getAttributesByPlanTypeId";

        _methodParameterTypes486 = new String[] { "long" };

        _methodName487 = "isRegionalType";

        _methodParameterTypes487 = new String[] { "long" };

        _methodName488 = "getAvailableModels";

        _methodParameterTypes488 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName489 = "getDefaultModel";

        _methodParameterTypes489 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName490 = "getColumns";

        _methodParameterTypes490 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName491 = "getAttributes";

        _methodParameterTypes491 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName492 = "isRegional";

        _methodParameterTypes492 = new String[] { "com.ext.portlet.model.PlanType" };
    }
