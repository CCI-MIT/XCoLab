...
public class PlanTypeLocalServiceClpInvoker {
    ...
    public PlanTypeLocalServiceClpInvoker() {
        ...
        _methodName570 = "getDefaultPlanType";

        _methodParameterTypes570 = new String[] {  };

        _methodName571 = "getColumnsByPlanTypeId";

        _methodParameterTypes571 = new String[] { "long" };

        _methodName572 = "getAttributesByPlanTypeId";

        _methodParameterTypes572 = new String[] { "long" };

        _methodName573 = "isRegionalType";

        _methodParameterTypes573 = new String[] { "long" };

        _methodName574 = "getAvailableModels";

        _methodParameterTypes574 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName575 = "getDefaultModel";

        _methodParameterTypes575 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName576 = "getColumns";

        _methodParameterTypes576 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName577 = "getAttributes";

        _methodParameterTypes577 = new String[] { "com.ext.portlet.model.PlanType" };

        _methodName578 = "isRegional";

        _methodParameterTypes578 = new String[] { "com.ext.portlet.model.PlanType" };
    }
