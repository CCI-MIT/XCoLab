...
/**
 * Provides the base implementation for the messaging message recipient local service.
 *
 * <p>
...
public abstract class MessagingMessageRecipientLocalServiceBaseImpl
    ...
    private MessagingMessageRecipientLocalServiceClpInvoker _clpInvoker = new MessagingMessageRecipientLocalServiceClpInvoker();
    ...
    @Override
    public MessagingMessageRecipient deleteMessagingMessageRecipient(
        long recipientId) throws PortalException, SystemException {
        return messagingMessageRecipientPersistence.remove(recipientId);
    }
    ...
    public MessagingMessageRecipient deleteMessagingMessageRecipient(
        MessagingMessageRecipient messagingMessageRecipient)
        throws SystemException {
        return messagingMessageRecipientPersistence.remove(messagingMessageRecipient);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MessagingMessageRecipient.class,
