...
/**
 * The base implementation of the messaging message recipient local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.MessagingMessageRecipientLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.MessagingMessageRecipientLocalServiceImpl
 * @see com.ext.portlet.service.MessagingMessageRecipientLocalServiceUtil
 * @generated
 */
public abstract class MessagingMessageRecipientLocalServiceBaseImpl
    implements MessagingMessageRecipientLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(MessagingMessageRecipientLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.MessagingMessageRecipientLocalServiceUtil} to access the messaging message recipient local service.
     */
    ...
    public MessagingMessageRecipient addMessagingMessageRecipient(
        ...
        messagingMessageRecipient = messagingMessageRecipientPersistence.update(messagingMessageRecipient,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(messagingMessageRecipient);
    ...
    public void deleteMessagingMessageRecipient(long recipientId)
        ...
        MessagingMessageRecipient messagingMessageRecipient = messagingMessageRecipientPersistence.remove(recipientId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(messagingMessageRecipient);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return messagingMessageRecipientPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public MessagingMessageRecipient fetchMessagingMessageRecipient(
        long recipientId) throws SystemException {
        return messagingMessageRecipientPersistence.fetchByPrimaryKey(recipientId);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return messagingMessageRecipientPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public MessagingMessageRecipient updateMessagingMessageRecipient(
        MessagingMessageRecipient messagingMessageRecipient)
        throws SystemException {
        return updateMessagingMessageRecipient(messagingMessageRecipient, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.MessagingMessageRecipient",
            messagingMessageRecipientLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = messagingMessageRecipientPersistence.getDataSource();
