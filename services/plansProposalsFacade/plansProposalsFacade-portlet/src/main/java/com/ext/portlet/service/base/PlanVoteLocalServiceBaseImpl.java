...
/**
 * Provides the base implementation for the plan vote local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanVoteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanVoteLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PlanVoteLocalService, IdentifiableBean {
    ...
    private PlanVoteLocalServiceClpInvoker _clpInvoker = new PlanVoteLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanVoteLocalServiceUtil} to access the plan vote local service.
     */
    ...
    public PlanVote addPlanVote(PlanVote planVote) throws SystemException {
        ...
        return planVotePersistence.update(planVote);
    }
    ...
    @Override
    public PlanVote deletePlanVote(PlanVotePK planVotePK)
        throws PortalException, SystemException {
        return planVotePersistence.remove(planVotePK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanVote deletePlanVote(PlanVote planVote) throws SystemException {
        return planVotePersistence.remove(planVote);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanVote.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return planVotePersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planVotePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PlanVote fetchPlanVote(PlanVotePK planVotePK)
        throws SystemException {
        return planVotePersistence.fetchByPrimaryKey(planVotePK);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planVotePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanVote",
            planVoteLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.PlanVote");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planVotePersistence.getDataSource();
