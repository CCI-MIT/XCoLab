...
/**
 * Provides the base implementation for the ontology term local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.OntologyTermLocalServiceImpl}.
 * </p>
 *
...
public abstract class OntologyTermLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements OntologyTermLocalService,
        IdentifiableBean {
    ...
    private OntologyTermLocalServiceClpInvoker _clpInvoker = new OntologyTermLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.OntologyTermLocalServiceUtil} to access the ontology term local service.
     */
    ...
    public OntologyTerm addOntologyTerm(OntologyTerm ontologyTerm)
        ...
        return ontologyTermPersistence.update(ontologyTerm);
    }
    ...
    @Override
    public OntologyTerm deleteOntologyTerm(long id)
        throws PortalException, SystemException {
        return ontologyTermPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public OntologyTerm deleteOntologyTerm(OntologyTerm ontologyTerm)
        throws SystemException {
        return ontologyTermPersistence.remove(ontologyTerm);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(OntologyTerm.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.OntologyTerm",
