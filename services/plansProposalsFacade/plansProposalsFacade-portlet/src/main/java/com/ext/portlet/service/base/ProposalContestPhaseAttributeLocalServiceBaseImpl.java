...
/**
 * The base implementation of the proposal contest phase attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalContestPhaseAttributeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalContestPhaseAttributeLocalServiceBaseImpl
    implements ProposalContestPhaseAttributeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalContestPhaseAttributeLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalContestPhaseAttributeLocalServiceUtil} to access the proposal contest phase attribute local service.
     */
     ...
     */
    public ProposalContestPhaseAttribute addProposalContestPhaseAttribute(
        ProposalContestPhaseAttribute proposalContestPhaseAttribute)
        throws SystemException {
        proposalContestPhaseAttribute.setNew(true);

        proposalContestPhaseAttribute = proposalContestPhaseAttributePersistence.update(proposalContestPhaseAttribute,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(proposalContestPhaseAttribute);
    ...
    public ProposalContestPhaseAttribute createProposalContestPhaseAttribute(
        long id) {
        return proposalContestPhaseAttributePersistence.create(id);
    }
    ...
    public void deleteProposalContestPhaseAttribute(long id)
        ...
        ProposalContestPhaseAttribute proposalContestPhaseAttribute = proposalContestPhaseAttributePersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposalContestPhaseAttribute);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteProposalContestPhaseAttribute(
        ProposalContestPhaseAttribute proposalContestPhaseAttribute)
        throws SystemException {
        proposalContestPhaseAttributePersistence.remove(proposalContestPhaseAttribute);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalContestPhaseAttributePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalContestPhaseAttributePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ProposalContestPhaseAttribute fetchProposalContestPhaseAttribute(
        long id) throws SystemException {
        return proposalContestPhaseAttributePersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalContestPhaseAttribute getProposalContestPhaseAttribute(
        long id) throws PortalException, SystemException {
        return proposalContestPhaseAttributePersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalContestPhaseAttributePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<ProposalContestPhaseAttribute> getProposalContestPhaseAttributes(
        ...
        return proposalContestPhaseAttributePersistence.findAll(start, end);
    }
    ...
    public int getProposalContestPhaseAttributesCount()
        throws SystemException {
        return proposalContestPhaseAttributePersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ProposalContestPhaseAttribute updateProposalContestPhaseAttribute(
        ProposalContestPhaseAttribute proposalContestPhaseAttribute)
        throws SystemException {
        return updateProposalContestPhaseAttribute(proposalContestPhaseAttribute,
            true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalContestPhaseAttribute",
            proposalContestPhaseAttributeLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = proposalContestPhaseAttributePersistence.getDataSource();
