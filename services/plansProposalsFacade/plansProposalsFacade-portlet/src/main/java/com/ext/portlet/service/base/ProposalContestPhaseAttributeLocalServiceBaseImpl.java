...
/**
 * Provides the base implementation for the proposal contest phase attribute local service.
 *
 * <p>
...
public abstract class ProposalContestPhaseAttributeLocalServiceBaseImpl
    ...
    private ProposalContestPhaseAttributeLocalServiceClpInvoker _clpInvoker = new ProposalContestPhaseAttributeLocalServiceClpInvoker();
    ...
    public ProposalContestPhaseAttribute addProposalContestPhaseAttribute(
        ...
        return proposalContestPhaseAttributePersistence.update(proposalContestPhaseAttribute);
    }
    ...
    @Override
    public ProposalContestPhaseAttribute deleteProposalContestPhaseAttribute(
        long id) throws PortalException, SystemException {
        return proposalContestPhaseAttributePersistence.remove(id);
    }
    ...
    public ProposalContestPhaseAttribute deleteProposalContestPhaseAttribute(
        ProposalContestPhaseAttribute proposalContestPhaseAttribute)
        throws SystemException {
        return proposalContestPhaseAttributePersistence.remove(proposalContestPhaseAttribute);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalContestPhaseAttribute.class,
