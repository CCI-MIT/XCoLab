...
/**
 * The base implementation of the discussion category group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.discussions.service.impl.DiscussionCategoryGroupLocalServiceImpl}.
 * </p>
 *
...
public abstract class DiscussionCategoryGroupLocalServiceBaseImpl
    implements DiscussionCategoryGroupLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(DiscussionCategoryGroupLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.discussions.service.DiscussionCategoryGroupLocalServiceUtil} to access the discussion category group local service.
     */
    ...
    public DiscussionCategoryGroup addDiscussionCategoryGroup(
        ...
        discussionCategoryGroup = discussionCategoryGroupPersistence.update(discussionCategoryGroup,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(discussionCategoryGroup);
    ...
    public void deleteDiscussionCategoryGroup(long id)
        ...
        DiscussionCategoryGroup discussionCategoryGroup = discussionCategoryGroupPersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(discussionCategoryGroup);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return discussionCategoryGroupPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public DiscussionCategoryGroup fetchDiscussionCategoryGroup(long id)
        throws SystemException {
        return discussionCategoryGroupPersistence.fetchByPrimaryKey(id);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return discussionCategoryGroupPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public DiscussionCategoryGroup updateDiscussionCategoryGroup(
        DiscussionCategoryGroup discussionCategoryGroup)
        throws SystemException {
        return updateDiscussionCategoryGroup(discussionCategoryGroup, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.discussions.model.DiscussionCategoryGroup",
            discussionCategoryGroupLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.discussions.model.DiscussionCategoryGroup");
    }
