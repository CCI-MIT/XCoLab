...
/**
 * The base implementation of the plan positions local service.
 *
 * <p>
...
public abstract class PlanPositionsLocalServiceBaseImpl
    implements PlanPositionsLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanPositionsLocalServiceBaseImpl.class);
    ...
    public PlanPositions addPlanPositions(PlanPositions planPositions)
        ...
        planPositions = planPositionsPersistence.update(planPositions, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planPositions);
    ...
    public PlanPositions updatePlanPositions(PlanPositions planPositions)
        throws SystemException {
        return updatePlanPositions(planPositions, true);
    }
    ...
    public PlanPositions updatePlanPositions(PlanPositions planPositions,
        ...
        planPositions = planPositionsPersistence.update(planPositions, merge);
