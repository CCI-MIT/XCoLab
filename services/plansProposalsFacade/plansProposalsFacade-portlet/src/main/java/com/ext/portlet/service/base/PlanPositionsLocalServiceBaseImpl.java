...
/**
 * Provides the base implementation for the plan positions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanPositionsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanPositionsLocalServiceImpl
 * @see com.ext.portlet.service.PlanPositionsLocalServiceUtil
 * @generated
 */
public abstract class PlanPositionsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanPositionsLocalService,
        IdentifiableBean {
    ...
    private PlanPositionsLocalServiceClpInvoker _clpInvoker = new PlanPositionsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanPositionsLocalServiceUtil} to access the plan positions local service.
     */
    ...
    public PlanPositions addPlanPositions(PlanPositions planPositions)
        ...
        return planPositionsPersistence.update(planPositions);
    }
    ...
    @Override
    public PlanPositions deletePlanPositions(long id)
        throws PortalException, SystemException {
        return planPositionsPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanPositions deletePlanPositions(PlanPositions planPositions)
        throws SystemException {
        return planPositionsPersistence.remove(planPositions);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanPositions.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planPositionsPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanPositions",
            planPositionsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planPositionsPersistence.getDataSource();
