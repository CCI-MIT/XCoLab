...
/**
 * The base implementation of the proposal attribute type local service.
 *
 * <p>
...
public abstract class ProposalAttributeTypeLocalServiceBaseImpl
    implements ProposalAttributeTypeLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ProposalAttributeTypeLocalServiceBaseImpl.class);
    ...
    public ProposalAttributeType addProposalAttributeType(
        ...
        proposalAttributeType = proposalAttributeTypePersistence.update(proposalAttributeType,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(proposalAttributeType);
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteProposalAttributeType(String name)
        throws PortalException, SystemException {
        ProposalAttributeType proposalAttributeType = proposalAttributeTypePersistence.remove(name);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(proposalAttributeType);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteProposalAttributeType(
        ProposalAttributeType proposalAttributeType) throws SystemException {
        proposalAttributeTypePersistence.remove(proposalAttributeType);
    ...
    public ProposalAttributeType updateProposalAttributeType(
        ProposalAttributeType proposalAttributeType) throws SystemException {
        return updateProposalAttributeType(proposalAttributeType, true);
    }
