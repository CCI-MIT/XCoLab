...
/**
 * Provides the base implementation for the proposal attribute type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ProposalAttributeTypeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ProposalAttributeTypeLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProposalAttributeTypeLocalService,
        IdentifiableBean {
    ...
    private ProposalAttributeTypeLocalServiceClpInvoker _clpInvoker = new ProposalAttributeTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ProposalAttributeTypeLocalServiceUtil} to access the proposal attribute type local service.
     */
    ...
    @Override
    public ProposalAttributeType addProposalAttributeType(
        ProposalAttributeType proposalAttributeType) throws SystemException {
        proposalAttributeType.setNew(true);

        return proposalAttributeTypePersistence.update(proposalAttributeType);
    }
     ...
     */
    @Override
    public ProposalAttributeType createProposalAttributeType(String name) {
        return proposalAttributeTypePersistence.create(name);
    }
    ...
    @Override
    public ProposalAttributeType deleteProposalAttributeType(String name)
        throws PortalException, SystemException {
        return proposalAttributeTypePersistence.remove(name);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProposalAttributeType deleteProposalAttributeType(
        ProposalAttributeType proposalAttributeType) throws SystemException {
        return proposalAttributeTypePersistence.remove(proposalAttributeType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProposalAttributeType.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return proposalAttributeTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return proposalAttributeTypePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProposalAttributeType fetchProposalAttributeType(String name)
        throws SystemException {
        return proposalAttributeTypePersistence.fetchByPrimaryKey(name);
    }
     ...
     */
    @Override
    public ProposalAttributeType getProposalAttributeType(String name)
        throws PortalException, SystemException {
        return proposalAttributeTypePersistence.findByPrimaryKey(name);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return proposalAttributeTypePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProposalAttributeType> getProposalAttributeTypes(int start,
        int end) throws SystemException {
        return proposalAttributeTypePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProposalAttributeTypesCount() throws SystemException {
        return proposalAttributeTypePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProposalAttributeType updateProposalAttributeType(
        ProposalAttributeType proposalAttributeType) throws SystemException {
        return proposalAttributeTypePersistence.update(proposalAttributeType);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ProposalAttributeType",
            proposalAttributeTypeLocalService);
    }
