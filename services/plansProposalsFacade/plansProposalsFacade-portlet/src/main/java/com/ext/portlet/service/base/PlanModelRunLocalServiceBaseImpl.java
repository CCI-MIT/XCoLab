...
/**
 * Provides the base implementation for the plan model run local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanModelRunLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanModelRunLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanModelRunLocalService,
        IdentifiableBean {
    ...
    private PlanModelRunLocalServiceClpInvoker _clpInvoker = new PlanModelRunLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanModelRunLocalServiceUtil} to access the plan model run local service.
     */
    ...
    public PlanModelRun addPlanModelRun(PlanModelRun planModelRun)
        ...
        return planModelRunPersistence.update(planModelRun);
    }
    ...
    @Override
    public PlanModelRun deletePlanModelRun(long id)
        throws PortalException, SystemException {
        return planModelRunPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanModelRun deletePlanModelRun(PlanModelRun planModelRun)
        throws SystemException {
        return planModelRunPersistence.remove(planModelRun);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanModelRun.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanModelRun",
