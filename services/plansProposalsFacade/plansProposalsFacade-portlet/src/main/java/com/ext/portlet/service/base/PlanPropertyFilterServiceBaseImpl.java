...
/**
 * Provides the base implementation for the plan property filter remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanPropertyFilterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.PlanPropertyFilterServiceImpl
 * @see com.ext.portlet.service.PlanPropertyFilterServiceUtil
 * @generated
 */
public abstract class PlanPropertyFilterServiceBaseImpl extends BaseServiceImpl
    implements PlanPropertyFilterService, IdentifiableBean {
...
>>>>>>> First steps toward lr6.2 (proposals/plansProposalFacade deploy and seem to work)
    ...
    private PlanPropertyFilterServiceClpInvoker _clpInvoker = new PlanPropertyFilterServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanPropertyFilterServiceUtil} to access the plan property filter remote service.
     */
