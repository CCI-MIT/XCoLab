...
/**
 * The base implementation of the plan model run local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanModelRunLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanModelRunLocalServiceBaseImpl
    implements PlanModelRunLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanModelRunLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanModelRunLocalServiceUtil} to access the plan model run local service.
     */
    ...
    public PlanModelRun addPlanModelRun(PlanModelRun planModelRun)
        ...
        planModelRun = planModelRunPersistence.update(planModelRun, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(planModelRun);
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planModelRunPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanModelRun updatePlanModelRun(PlanModelRun planModelRun)
        throws SystemException {
        return updatePlanModelRun(planModelRun, true);
    }
    ...
    public PlanModelRun updatePlanModelRun(PlanModelRun planModelRun,
        ...
        planModelRun = planModelRunPersistence.update(planModelRun, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanModelRun",
            planModelRunLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanModelRun");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planModelRunPersistence.getDataSource();
