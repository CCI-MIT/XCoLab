...
/**
 * The base implementation of the plan section plan map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanSectionPlanMapLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanSectionPlanMapLocalServiceBaseImpl
    implements PlanSectionPlanMapLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanSectionPlanMapLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanSectionPlanMapLocalServiceUtil} to access the plan section plan map local service.
     */
    ...
    public PlanSectionPlanMap addPlanSectionPlanMap(
        ...
        planSectionPlanMap = planSectionPlanMapPersistence.update(planSectionPlanMap,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planSectionPlanMap);
    ...
    public void deletePlanSectionPlanMap(
        ...
        PlanSectionPlanMap planSectionPlanMap = planSectionPlanMapPersistence.remove(planSectionPlanMapPK);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(planSectionPlanMap);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return planSectionPlanMapPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public PlanSectionPlanMap fetchPlanSectionPlanMap(
        PlanSectionPlanMapPK planSectionPlanMapPK) throws SystemException {
        return planSectionPlanMapPersistence.fetchByPrimaryKey(planSectionPlanMapPK);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planSectionPlanMapPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanSectionPlanMap updatePlanSectionPlanMap(
        PlanSectionPlanMap planSectionPlanMap) throws SystemException {
        return updatePlanSectionPlanMap(planSectionPlanMap, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanSectionPlanMap",
            planSectionPlanMapLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanSectionPlanMap");
    }
