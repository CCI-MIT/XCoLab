...
/**
 * Provides the base implementation for the model output item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelOutputItemLocalServiceImpl}.
 * </p>
 *
...
public abstract class ModelOutputItemLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ModelOutputItemLocalService,
        IdentifiableBean {
    ...
    private ModelOutputItemLocalServiceClpInvoker _clpInvoker = new ModelOutputItemLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelOutputItemLocalServiceUtil} to access the model output item local service.
     */
    ...
    public ModelOutputItem addModelOutputItem(ModelOutputItem modelOutputItem)
        ...
        return modelOutputItemPersistence.update(modelOutputItem);
    }
    ...
    @Override
    public ModelOutputItem deleteModelOutputItem(long modelOutputItemModifierPK)
        throws PortalException, SystemException {
        return modelOutputItemPersistence.remove(modelOutputItemModifierPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ModelOutputItem deleteModelOutputItem(
        ModelOutputItem modelOutputItem) throws SystemException {
        return modelOutputItemPersistence.remove(modelOutputItem);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ModelOutputItem.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return modelOutputItemPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ModelOutputItem",
            modelOutputItemLocalService);
    }
