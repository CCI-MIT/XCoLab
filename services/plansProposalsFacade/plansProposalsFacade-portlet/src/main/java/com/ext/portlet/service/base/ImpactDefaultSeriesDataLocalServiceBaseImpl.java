...
import com.ext.portlet.service.ImpactDefaultSeriesDataLocalService;
...
/**
 * Provides the base implementation for the impact default series data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ImpactDefaultSeriesDataLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ImpactDefaultSeriesDataLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ImpactDefaultSeriesDataLocalService,
        IdentifiableBean {
    ...
    private ImpactDefaultSeriesDataLocalServiceClpInvoker _clpInvoker = new ImpactDefaultSeriesDataLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ImpactDefaultSeriesDataLocalServiceUtil} to access the impact default series data local service.
     */
    ...
    @Override
    public ImpactDefaultSeriesData addImpactDefaultSeriesData(
        ImpactDefaultSeriesData impactDefaultSeriesData)
        throws SystemException {
        impactDefaultSeriesData.setNew(true);

        return impactDefaultSeriesDataPersistence.update(impactDefaultSeriesData);
    }
     ...
     */
    @Override
    public ImpactDefaultSeriesData createImpactDefaultSeriesData(
        ImpactDefaultSeriesDataPK impactDefaultSeriesDataPK) {
        return impactDefaultSeriesDataPersistence.create(impactDefaultSeriesDataPK);
    }
    ...
    @Override
    public ImpactDefaultSeriesData deleteImpactDefaultSeriesData(
        ImpactDefaultSeriesDataPK impactDefaultSeriesDataPK)
        throws PortalException, SystemException {
        return impactDefaultSeriesDataPersistence.remove(impactDefaultSeriesDataPK);
    }
    ...
    public ImpactDefaultSeriesData deleteImpactDefaultSeriesData(
        ImpactDefaultSeriesData impactDefaultSeriesData)
        throws SystemException {
        return impactDefaultSeriesDataPersistence.remove(impactDefaultSeriesData);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImpactDefaultSeriesData.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactDefaultSeriesDataPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return impactDefaultSeriesDataPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImpactDefaultSeriesData fetchImpactDefaultSeriesData(
        ImpactDefaultSeriesDataPK impactDefaultSeriesDataPK)
        throws SystemException {
        return impactDefaultSeriesDataPersistence.fetchByPrimaryKey(impactDefaultSeriesDataPK);
    }
     ...
     */
    @Override
    public ImpactDefaultSeriesData getImpactDefaultSeriesData(
        ImpactDefaultSeriesDataPK impactDefaultSeriesDataPK)
        throws PortalException, SystemException {
        return impactDefaultSeriesDataPersistence.findByPrimaryKey(impactDefaultSeriesDataPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return impactDefaultSeriesDataPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<ImpactDefaultSeriesData> getImpactDefaultSeriesDatas(
        ...
        return impactDefaultSeriesDataPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImpactDefaultSeriesDatasCount() throws SystemException {
        return impactDefaultSeriesDataPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImpactDefaultSeriesData updateImpactDefaultSeriesData(
        ImpactDefaultSeriesData impactDefaultSeriesData)
        throws SystemException {
        return impactDefaultSeriesDataPersistence.update(impactDefaultSeriesData);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ImpactDefaultSeriesData",
            impactDefaultSeriesDataLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = impactDefaultSeriesDataPersistence.getDataSource();
