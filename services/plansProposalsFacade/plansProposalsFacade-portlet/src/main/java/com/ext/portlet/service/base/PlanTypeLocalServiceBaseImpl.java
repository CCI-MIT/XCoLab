...
/**
 * Provides the base implementation for the plan type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanTypeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PlanTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    private PlanTypeLocalServiceClpInvoker _clpInvoker = new PlanTypeLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanTypeLocalServiceUtil} to access the plan type local service.
     */
    ...
    public PlanType addPlanType(PlanType planType) throws SystemException {
        ...
        return planTypePersistence.update(planType);
    }
    ...
    @Override
    public PlanType deletePlanType(long planTypeId)
        throws PortalException, SystemException {
        return planTypePersistence.remove(planTypeId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanType deletePlanType(PlanType planType) throws SystemException {
        return planTypePersistence.remove(planType);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanType.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanType",
            planTypeLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.model.PlanType");
    }
