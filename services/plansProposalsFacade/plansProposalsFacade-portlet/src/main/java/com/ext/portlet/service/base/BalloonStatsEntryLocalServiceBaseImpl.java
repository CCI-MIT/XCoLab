...
/**
 * The base implementation of the balloon stats entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.BalloonStatsEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ext.portlet.service.impl.BalloonStatsEntryLocalServiceImpl
 * @see com.ext.portlet.service.BalloonStatsEntryLocalServiceUtil
 * @generated
 */
public abstract class BalloonStatsEntryLocalServiceBaseImpl
    implements BalloonStatsEntryLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(BalloonStatsEntryLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.BalloonStatsEntryLocalServiceUtil} to access the balloon stats entry local service.
     */
     ...
     */
    public BalloonStatsEntry addBalloonStatsEntry(
        BalloonStatsEntry balloonStatsEntry) throws SystemException {
        balloonStatsEntry.setNew(true);

        balloonStatsEntry = balloonStatsEntryPersistence.update(balloonStatsEntry,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(balloonStatsEntry);
     ...
     */
    public BalloonStatsEntry createBalloonStatsEntry(long id) {
        return balloonStatsEntryPersistence.create(id);
    }
    ...
    public void deleteBalloonStatsEntry(long id)
        ...
        BalloonStatsEntry balloonStatsEntry = balloonStatsEntryPersistence.remove(id);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(balloonStatsEntry);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteBalloonStatsEntry(BalloonStatsEntry balloonStatsEntry)
        throws SystemException {
        balloonStatsEntryPersistence.remove(balloonStatsEntry);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonStatsEntryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return balloonStatsEntryPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public BalloonStatsEntry fetchBalloonStatsEntry(long id)
        throws SystemException {
        return balloonStatsEntryPersistence.fetchByPrimaryKey(id);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public BalloonStatsEntry getBalloonStatsEntry(long id)
        throws PortalException, SystemException {
        return balloonStatsEntryPersistence.findByPrimaryKey(id);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return balloonStatsEntryPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<BalloonStatsEntry> getBalloonStatsEntries(int start, int end)
        throws SystemException {
        return balloonStatsEntryPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getBalloonStatsEntriesCount() throws SystemException {
        return balloonStatsEntryPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public BalloonStatsEntry updateBalloonStatsEntry(
        BalloonStatsEntry balloonStatsEntry) throws SystemException {
        return updateBalloonStatsEntry(balloonStatsEntry, true);
    }
     ...
     */
    public BalloonStatsEntry updateBalloonStatsEntry(
        BalloonStatsEntry balloonStatsEntry, boolean merge)
        throws SystemException {
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.BalloonStatsEntry",
            balloonStatsEntryLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = balloonStatsEntryPersistence.getDataSource();
