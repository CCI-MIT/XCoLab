...
/**
 * Provides the base implementation for the balloon stats entry local service.
 *
 * <p>
...
public abstract class BalloonStatsEntryLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements BalloonStatsEntryLocalService,
        IdentifiableBean {
    ...
    private BalloonStatsEntryLocalServiceClpInvoker _clpInvoker = new BalloonStatsEntryLocalServiceClpInvoker();
    ...
    public BalloonStatsEntry addBalloonStatsEntry(
        ...
        return balloonStatsEntryPersistence.update(balloonStatsEntry);
    }
    ...
    @Override
    public BalloonStatsEntry deleteBalloonStatsEntry(long id)
        throws PortalException, SystemException {
        return balloonStatsEntryPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public BalloonStatsEntry deleteBalloonStatsEntry(
        BalloonStatsEntry balloonStatsEntry) throws SystemException {
        return balloonStatsEntryPersistence.remove(balloonStatsEntry);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(BalloonStatsEntry.class,
