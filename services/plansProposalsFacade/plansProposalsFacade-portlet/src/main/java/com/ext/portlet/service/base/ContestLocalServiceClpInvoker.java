...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName508 = "getContestByActiveFlag";

        _methodParameterTypes508 = new String[] { "boolean" };

        _methodName509 = "createNewContest";

        _methodParameterTypes509 = new String[] {
                "java.lang.Long", "java.lang.String"
            };

        _methodName510 = "updateContestGroupsAndDiscussions";

        _methodParameterTypes510 = new String[] {  };

        _methodName512 = "findByActive";

        _methodParameterTypes512 = new String[] { "boolean" };

        _methodName513 = "findByActiveFeatured";

        _methodParameterTypes513 = new String[] { "boolean", "boolean" };

        _methodName514 = "findByActiveFlag";

        _methodParameterTypes514 = new String[] { "boolean", "int" };

        _methodName515 = "findByActiveFlagText";

        _methodParameterTypes515 = new String[] { "boolean", "java.lang.String" };

        _methodName516 = "getPhases";

        _methodParameterTypes516 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName517 = "getPlanType";

        _methodParameterTypes517 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName518 = "getActivePhases";

        _methodParameterTypes518 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName519 = "getActivePhase";

        _methodParameterTypes519 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName520 = "getActiveOrLastPhase";

        _methodParameterTypes520 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName521 = "isActive";

        _methodParameterTypes521 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName522 = "getDebatesIds";

        _methodParameterTypes522 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName523 = "getTotalVotes";

        _methodParameterTypes523 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName524 = "updateDefaultPlanDescription";
        ...
        _methodName549 = "getNumberOfProposalsForJudge";
