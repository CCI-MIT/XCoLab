...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName512 = "getContestByActiveFlag";

        _methodParameterTypes512 = new String[] { "boolean" };

        _methodName513 = "createNewContest";

        _methodParameterTypes513 = new String[] {
                "java.lang.Long", "java.lang.String"
            };

        _methodName514 = "updateContestGroupsAndDiscussions";

        _methodParameterTypes514 = new String[] {  };

        _methodName516 = "getByContestUrlName";

        _methodParameterTypes516 = new String[] { "java.lang.String" };

        _methodName517 = "findByContestYear";

        _methodParameterTypes517 = new String[] { "long" };

        _methodName518 = "getByContestUrlNameContestYear";

        _methodParameterTypes518 = new String[] { "java.lang.String", "long" };

        _methodName519 = "findByActive";

        _methodParameterTypes519 = new String[] { "boolean" };

        _methodName520 = "findByActiveFeatured";

        _methodParameterTypes520 = new String[] { "boolean", "boolean" };

        _methodName521 = "findByActiveFlag";

        _methodParameterTypes521 = new String[] { "boolean", "int" };

        _methodName522 = "getAllPhases";

        _methodParameterTypes522 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName523 = "getVisiblePhases";

        _methodParameterTypes523 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName524 = "getActivePhases";

        _methodParameterTypes524 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName525 = "getActivePhase";

        _methodParameterTypes525 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName526 = "getActiveOrLastPhase";

        _methodParameterTypes526 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName527 = "isActive";

        _methodParameterTypes527 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName528 = "store";

        _methodParameterTypes528 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName529 = "getPlanTemplate";

        _methodParameterTypes529 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName530 = "getFocusArea";

        _methodParameterTypes530 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName531 = "getLogo";

        _methodParameterTypes531 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName532 = "getSponsorLogo";

        _methodParameterTypes532 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName533 = "getLogoPath";

        _methodParameterTypes533 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName534 = "getSponsorLogoPath";

        _methodParameterTypes534 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName535 = "getProposalsCount";

        _methodParameterTypes535 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName536 = "getDiscussionCategoryGroup";

        _methodParameterTypes536 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName537 = "getTotalCommentsCount";
        ...
        _methodName539 = "getProposalsCommentsCount";

        _methodParameterTypes539 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName540 = "getVotesCount";

        _methodParameterTypes540 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName541 = "getTotalComments";

        _methodParameterTypes541 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName542 = "getTeamMembers";

        _methodParameterTypes542 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName543 = "isSubscribed";

        _methodParameterTypes543 = new String[] { "long", "long" };

        _methodName544 = "subscribe";

        _methodParameterTypes544 = new String[] { "long", "long" };

        _methodName545 = "unsubscribe";

        _methodParameterTypes545 = new String[] { "long", "long" };

        _methodName546 = "getModelIds";

        _methodParameterTypes546 = new String[] { "long" };

        _methodName547 = "getModelIdsAndNames";

        _methodParameterTypes547 = new String[] { "long" };

        _methodName548 = "getDefaultModelId";

        _methodParameterTypes548 = new String[] { "long" };

        _methodName550 = "getContestsByActivePrivate";

        _methodParameterTypes550 = new String[] { "boolean", "boolean" };

        _methodName551 = "getContestsByActivePrivateType";

        _methodParameterTypes551 = new String[] { "boolean", "boolean", "long" };

        _methodName552 = "getContestsMatchingOntologyTerms";

        _methodParameterTypes552 = new String[] { "java.util.List" };

        _methodName553 = "getContestsMatchingTier";

        _methodParameterTypes553 = new String[] { "long" };

        _methodName554 = "getContestsMatchingTierInType";

        _methodParameterTypes554 = new String[] { "long", "long" };

        _methodName555 = "getContestsMatchingOntologyTermsAndTier";

        _methodParameterTypes555 = new String[] { "java.util.List", "long" };

        _methodName556 = "transferSupportsToVote";
        ...
        _methodName557 = "getProposalJudgeReviewCsv";
        ...
        _methodName559 = "getAdvisorsForContest";

        _methodParameterTypes559 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName560 = "getJudgesForContest";

        _methodParameterTypes560 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName561 = "getFellowsForContest";

        _methodParameterTypes561 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName562 = "getContestManagersForContest";

        _methodParameterTypes562 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName564 = "getContestLinkUrl";

        _methodParameterTypes564 = new String[] { "long" };

        _methodName565 = "getContestLinkUrl";

        _methodParameterTypes565 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName568 = "hasContestEnded";

        _methodParameterTypes568 = new String[] { "long" };

        _methodName569 = "hasContestEnded";

        _methodParameterTypes569 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName570 = "getWinnerProposal";

        _methodParameterTypes570 = new String[] { "long" };

        _methodName571 = "getPointsAccessibleForActivePhaseOfContest";

        _methodParameterTypes571 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName572 = "getContestImpactTemplateSeries";

        _methodParameterTypes572 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName573 = "getContestImpactIterations";

        _methodParameterTypes573 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName574 = "getContestImpactFocusAreaList";

        _methodParameterTypes574 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName575 = "getContestImpactFocusAreas";

        _methodParameterTypes575 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName576 = "getContestsByContestType";

        _methodParameterTypes576 = new String[] { "java.lang.Long" };

        _methodName577 = "getContestsByContestTypeIds";

        _methodParameterTypes577 = new String[] { "java.util.List" };

        _methodName578 = "countContestsByContestType";

        _methodParameterTypes578 = new String[] { "java.lang.Long" };

        _methodName579 = "getContestsByTierLevelAndOntologyTermIds";

        _methodParameterTypes579 = new String[] {
                "java.lang.Long", "java.util.List"
            };

        _methodName580 = "getContestsByContestScheduleId";

        _methodParameterTypes580 = new String[] { "java.lang.Long" };

        _methodName581 = "getContestsByPlanTemplateId";

        _methodParameterTypes581 = new String[] { "java.lang.Long" };

        _methodName582 = "getSubContestsByOntologySpaceId";

        _methodParameterTypes582 = new String[] {
                "com.ext.portlet.model.Contest", "java.lang.Long"
            };

        _methodName583 = "addContestYearSuffixToCompletedContests";

        _methodParameterTypes583 = new String[] {  };

        _methodName584 = "getPointsEnabledContests";

        _methodParameterTypes584 = new String[] { "boolean" };

        _methodName585 = "addContestYearSuffixToContest";

        _methodParameterTypes585 = new String[] {
                "com.ext.portlet.model.Contest", "boolean"
            };

        _methodName587 = "generateContestUrlName";
