...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName560 = "getProposalJudgeReviewCsv";
        ...
        _methodName572 = "getWinnerProposal";

        _methodParameterTypes572 = new String[] { "long" };

        _methodName573 = "getPointsAccessibleForActivePhaseOfContest";

        _methodParameterTypes573 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName574 = "getContestImpactTemplateSeries";

        _methodParameterTypes574 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName575 = "getContestImpactIterations";

        _methodParameterTypes575 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName576 = "getContestImpactFocusAreaList";

        _methodParameterTypes576 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName577 = "getContestImpactFocusAreas";

        _methodParameterTypes577 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName578 = "getContestsByContestType";

        _methodParameterTypes578 = new String[] { "java.lang.Long" };

        _methodName579 = "getContestsByContestTypeIds";

        _methodParameterTypes579 = new String[] { "java.util.List" };

        _methodName580 = "countContestsByContestType";

        _methodParameterTypes580 = new String[] { "java.lang.Long" };

        _methodName581 = "getContestsByTierLevelAndOntologyTermIds";

        _methodParameterTypes581 = new String[] {
                "java.lang.Long", "java.util.List"
            };

        _methodName582 = "getContestsByContestScheduleId";

        _methodParameterTypes582 = new String[] { "java.lang.Long" };

        _methodName583 = "getContestsByPlanTemplateId";

        _methodParameterTypes583 = new String[] { "java.lang.Long" };

        _methodName584 = "getSubContestsByOntologySpaceId";

        _methodParameterTypes584 = new String[] {
                "com.ext.portlet.model.Contest", "java.lang.Long"
            };

        _methodName585 = "addContestYearSuffixToCompletedContests";

        _methodParameterTypes585 = new String[] {  };

        _methodName586 = "getPointsEnabledContests";

        _methodParameterTypes586 = new String[] { "boolean" };

        _methodName587 = "addContestYearSuffixToContest";
