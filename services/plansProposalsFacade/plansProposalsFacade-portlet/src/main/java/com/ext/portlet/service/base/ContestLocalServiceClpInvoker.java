...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName555 = "getProposalJudgeReviewCsv";
        ...
        _methodName567 = "getWinnerProposal";

        _methodParameterTypes567 = new String[] { "long" };

        _methodName568 = "getPointsAccessibleForActivePhaseOfContest";

        _methodParameterTypes568 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName569 = "getContestImpactTemplateSeries";

        _methodParameterTypes569 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName570 = "getContestImpactIterations";

        _methodParameterTypes570 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName571 = "getContestImpactFocusAreaList";

        _methodParameterTypes571 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName572 = "getContestImpactFocusAreas";

        _methodParameterTypes572 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName573 = "getContestsByContestType";

        _methodParameterTypes573 = new String[] { "java.lang.Long" };

        _methodName574 = "getContestsByContestTypeIds";

        _methodParameterTypes574 = new String[] { "java.util.List" };

        _methodName575 = "countContestsByContestType";

        _methodParameterTypes575 = new String[] { "java.lang.Long" };

        _methodName576 = "getContestsByTierLevelAndOntologyTermIds";

        _methodParameterTypes576 = new String[] {
                "java.lang.Long", "java.util.List"
            };

        _methodName577 = "getContestsByContestScheduleId";

        _methodParameterTypes577 = new String[] { "java.lang.Long" };

        _methodName578 = "getContestsByPlanTemplateId";

        _methodParameterTypes578 = new String[] { "java.lang.Long" };

        _methodName579 = "getSubContestsByOntologySpaceId";

        _methodParameterTypes579 = new String[] {
                "com.ext.portlet.model.Contest", "java.lang.Long"
            };

        _methodName580 = "addContestYearSuffixToCompletedContests";

        _methodParameterTypes580 = new String[] {  };

        _methodName581 = "getPointsEnabledContests";

        _methodParameterTypes581 = new String[] { "boolean" };

        _methodName582 = "addContestYearSuffixToContest";
