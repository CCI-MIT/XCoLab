...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName556 = "getContestsByActivePrivateType";

        _methodParameterTypes556 = new String[] { "boolean", "boolean", "long" };

        _methodName557 = "getContestsMatchingOntologyTerms";

        _methodParameterTypes557 = new String[] { "java.util.List" };

        _methodName558 = "getContestsMatchingTier";

        _methodParameterTypes558 = new String[] { "long" };

        _methodName559 = "getContestsMatchingTierInType";

        _methodParameterTypes559 = new String[] { "long", "long" };

        _methodName560 = "getContestsMatchingOntologyTermsAndTier";

        _methodParameterTypes560 = new String[] { "java.util.List", "long" };

        _methodName561 = "transferSupportsToVote";
        ...
        _methodName562 = "getProposalJudgeReviewCsv";
