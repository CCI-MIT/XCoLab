...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName498 = "getContestByActiveFlag";

        _methodParameterTypes498 = new String[] { "boolean" };

        _methodName499 = "createNewContest";

        _methodParameterTypes499 = new String[] {
                "java.lang.Long", "java.lang.String"
            };

        _methodName500 = "updateContestGroupsAndDiscussions";

        _methodParameterTypes500 = new String[] {  };

        _methodName502 = "findByActive";

        _methodParameterTypes502 = new String[] { "boolean" };

        _methodName503 = "findByActiveFeatured";

        _methodParameterTypes503 = new String[] { "boolean", "boolean" };

        _methodName504 = "findByActiveFlag";

        _methodParameterTypes504 = new String[] { "boolean", "int" };

        _methodName505 = "findByActiveFlagText";

        _methodParameterTypes505 = new String[] { "boolean", "java.lang.String" };

        _methodName506 = "getAllPhases";

        _methodParameterTypes506 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName507 = "getVisiblePhases";

        _methodParameterTypes507 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName508 = "getPlanType";

        _methodParameterTypes508 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName509 = "getActivePhases";

        _methodParameterTypes509 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName510 = "getActivePhase";

        _methodParameterTypes510 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName511 = "getActiveOrLastPhase";

        _methodParameterTypes511 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName512 = "isActive";

        _methodParameterTypes512 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName513 = "getDebatesIds";

        _methodParameterTypes513 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName514 = "getTotalVotes";

        _methodParameterTypes514 = new String[] { "com.ext.portlet.model.Contest" };

        _methodName515 = "updateDefaultPlanDescription";
        ...
        _methodName534 = "getModelIds";

        _methodParameterTypes534 = new String[] { "long" };

        _methodName535 = "getModelIdsAndNames";

        _methodParameterTypes535 = new String[] { "long" };

        _methodName536 = "getDefaultModelId";

        _methodParameterTypes536 = new String[] { "long" };

        _methodName538 = "getContestsByActivePrivate";

        _methodParameterTypes538 = new String[] { "boolean", "boolean" };

        _methodName539 = "getContestsByActivePrivateType";

        _methodParameterTypes539 = new String[] { "boolean", "boolean", "long" };

        _methodName540 = "getContestsMatchingOntologyTerms";

        _methodParameterTypes540 = new String[] { "java.util.List" };

        _methodName541 = "getContestsMatchingTier";

        _methodParameterTypes541 = new String[] { "long" };

        _methodName542 = "getContestsMatchingTierInType";

        _methodParameterTypes542 = new String[] { "long", "long" };

        _methodName543 = "getContestsMatchingOntologyTermsAndTier";

        _methodParameterTypes543 = new String[] { "java.util.List", "long" };

        _methodName544 = "transferSupportsToVote";
        ...
        _methodName545 = "getProposalJudgeReviewCsv";
