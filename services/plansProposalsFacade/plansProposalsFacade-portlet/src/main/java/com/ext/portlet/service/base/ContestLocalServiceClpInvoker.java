...
public class ContestLocalServiceClpInvoker {
    ...
    public ContestLocalServiceClpInvoker() {
        ...
        _methodName530 = "unsubscribe";

        _methodParameterTypes530 = new String[] { "long", "long" };

        _methodName531 = "getModelIds";

        _methodParameterTypes531 = new String[] { "long" };

        _methodName532 = "getModelIdsAndNames";

        _methodParameterTypes532 = new String[] { "long" };

        _methodName533 = "getDefaultModelId";

        _methodParameterTypes533 = new String[] { "long" };

        _methodName535 = "getContestsByActivePrivate";

        _methodParameterTypes535 = new String[] { "boolean", "boolean" };

        _methodName536 = "getContestsByActivePrivateType";

        _methodParameterTypes536 = new String[] { "boolean", "boolean", "long" };

        _methodName537 = "getContestsMatchingOntologyTerms";

        _methodParameterTypes537 = new String[] { "java.util.List" };

        _methodName538 = "getContestsMatchingTier";

        _methodParameterTypes538 = new String[] { "long" };

        _methodName539 = "getContestsMatchingTierInType";

        _methodParameterTypes539 = new String[] { "long", "long" };

        _methodName540 = "getContestsMatchingOntologyTermsAndTier";

        _methodParameterTypes540 = new String[] { "java.util.List", "long" };

        _methodName541 = "transferSupportsToVote";
        ...
        _methodName542 = "getProposalJudgeReviewCsv";
