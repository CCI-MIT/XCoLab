...
/**
 * The base implementation of the plan description local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.plans.service.impl.PlanDescriptionLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanDescriptionLocalServiceBaseImpl
    implements PlanDescriptionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(PlanDescriptionLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.plans.service.PlanDescriptionLocalServiceUtil} to access the plan description local service.
     */
    ...
    public PlanDescription addPlanDescription(PlanDescription planDescription)
        ...
        planDescription = planDescriptionPersistence.update(planDescription,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(planDescription);
    ...
    public void deletePlanDescription(long id)
        ...
        if (indexer != null) {
            try {
                indexer.delete(planDescription);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return planDescriptionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public PlanDescription updatePlanDescription(
        ...
        return updatePlanDescription(planDescription, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.plans.model.PlanDescription",
            planDescriptionLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.ext.portlet.plans.model.PlanDescription");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = planDescriptionPersistence.getDataSource();
