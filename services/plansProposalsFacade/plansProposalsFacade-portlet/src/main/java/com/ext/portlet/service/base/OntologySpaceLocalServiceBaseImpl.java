...
/**
 * The base implementation of the ontology space local service.
 *
 * <p>
...
public abstract class OntologySpaceLocalServiceBaseImpl
    implements OntologySpaceLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(OntologySpaceLocalServiceBaseImpl.class);
    ...
    public OntologySpace addOntologySpace(OntologySpace ontologySpace)
        ...
        ontologySpace = ontologySpacePersistence.update(ontologySpace, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(ontologySpace);
    ...
    public OntologySpace updateOntologySpace(OntologySpace ontologySpace)
        throws SystemException {
        return updateOntologySpace(ontologySpace, true);
    }
    ...
    public OntologySpace updateOntologySpace(OntologySpace ontologySpace,
        ...
        ontologySpace = ontologySpacePersistence.update(ontologySpace, merge);
