...
/**
 * Provides the base implementation for the ontology space local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.OntologySpaceLocalServiceImpl}.
 * </p>
 *
...
public abstract class OntologySpaceLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements OntologySpaceLocalService,
        IdentifiableBean {
    ...
    private OntologySpaceLocalServiceClpInvoker _clpInvoker = new OntologySpaceLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.OntologySpaceLocalServiceUtil} to access the ontology space local service.
     */
    ...
    public OntologySpace addOntologySpace(OntologySpace ontologySpace)
        ...
        return ontologySpacePersistence.update(ontologySpace);
    }
    ...
    @Override
    public OntologySpace deleteOntologySpace(long id)
        throws PortalException, SystemException {
        return ontologySpacePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public OntologySpace deleteOntologySpace(OntologySpace ontologySpace)
        throws SystemException {
        return ontologySpacePersistence.remove(ontologySpace);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(OntologySpace.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ontologySpacePersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.OntologySpace",
            ontologySpaceLocalService);
    }
