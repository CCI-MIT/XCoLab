...
public class Proposal2PhaseLocalServiceClpInvoker {
    ...
    public Proposal2PhaseLocalServiceClpInvoker() {
        ...
        _methodName571 = "create";

        _methodParameterTypes571 = new String[] { "long", "long", "int", "int" };

        _methodName572 = "getByProposalIdContestPhaseId";

        _methodParameterTypes572 = new String[] { "long", "long" };

        _methodName573 = "getByProposalId";

        _methodParameterTypes573 = new String[] { "long" };

        _methodName574 = "getCurrentContestForProposal";

        _methodParameterTypes574 = new String[] { "long" };

        _methodName575 = "getForVersion";

        _methodParameterTypes575 = new String[] {
                "com.ext.portlet.model.ProposalVersion"
            };

        _methodName576 = "getContestPhasesForProposal";

        _methodParameterTypes576 = new String[] { "long" };

        _methodName577 = "getActiveContestPhasesForProposal";
