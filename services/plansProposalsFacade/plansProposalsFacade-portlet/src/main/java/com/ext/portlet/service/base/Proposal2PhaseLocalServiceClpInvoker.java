...
public class Proposal2PhaseLocalServiceClpInvoker {
    ...
    public Proposal2PhaseLocalServiceClpInvoker() {
        ...
        _methodName559 = "create";

        _methodParameterTypes559 = new String[] { "long", "long", "int", "int" };

        _methodName560 = "getByProposalIdContestPhaseId";

        _methodParameterTypes560 = new String[] { "long", "long" };

        _methodName561 = "getByProposalId";

        _methodParameterTypes561 = new String[] { "long" };

        _methodName562 = "getCurrentContestForProposal";

        _methodParameterTypes562 = new String[] { "long" };

        _methodName563 = "getForVersion";

        _methodParameterTypes563 = new String[] {
                "com.ext.portlet.model.ProposalVersion"
            };

        _methodName564 = "getContestPhasesForProposal";

        _methodParameterTypes564 = new String[] { "long" };

        _methodName565 = "getActiveContestPhasesForProposal";
