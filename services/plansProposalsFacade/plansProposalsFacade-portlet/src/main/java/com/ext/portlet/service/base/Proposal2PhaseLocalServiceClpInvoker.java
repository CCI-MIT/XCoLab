...
public class Proposal2PhaseLocalServiceClpInvoker {
    ...
    public Proposal2PhaseLocalServiceClpInvoker() {
        ...
        _methodParameterTypes627 = new String[] { "long", "long", "int", "int" };

        _methodName628 = "getByProposalIdContestPhaseId";

        _methodParameterTypes628 = new String[] { "long", "long" };

        _methodName629 = "getByProposalId";

        _methodParameterTypes629 = new String[] { "long" };

        _methodName630 = "getCurrentContestForProposal";

        _methodParameterTypes630 = new String[] { "long" };

        _methodName631 = "getForVersion";

        _methodParameterTypes631 = new String[] {
                "com.ext.portlet.model.ProposalVersion"
            };

        _methodName632 = "getContestPhasesForProposal";

        _methodParameterTypes632 = new String[] { "long" };

        _methodName633 = "getActiveContestPhasesForProposal";
