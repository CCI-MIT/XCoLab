...
/**
 * Provides the base implementation for the plan template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.PlanTemplateLocalServiceImpl}.
 * </p>
 *
...
public abstract class PlanTemplateLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PlanTemplateLocalService,
        IdentifiableBean {
    ...
    private PlanTemplateLocalServiceClpInvoker _clpInvoker = new PlanTemplateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.PlanTemplateLocalServiceUtil} to access the plan template local service.
     */
    ...
    public PlanTemplate addPlanTemplate(PlanTemplate planTemplate)
        ...
        return planTemplatePersistence.update(planTemplate);
    }
    ...
    @Override
    public PlanTemplate deletePlanTemplate(long id)
        throws PortalException, SystemException {
        return planTemplatePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PlanTemplate deletePlanTemplate(PlanTemplate planTemplate)
        throws SystemException {
        return planTemplatePersistence.remove(planTemplate);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PlanTemplate.class,
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.PlanTemplate",
