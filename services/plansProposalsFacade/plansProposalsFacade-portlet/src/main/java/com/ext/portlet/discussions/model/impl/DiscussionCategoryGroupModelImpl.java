...
public class DiscussionCategoryGroupModelImpl extends BaseModelImpl<DiscussionCategoryGroup>
    ...
    public static final String TABLE_SQL_CREATE = "create table xcolab_DiscussionCategoryGroup (id_ LONG not null primary key,description VARCHAR(75) null,url VARCHAR(75) null,commentsThread LONG)";
