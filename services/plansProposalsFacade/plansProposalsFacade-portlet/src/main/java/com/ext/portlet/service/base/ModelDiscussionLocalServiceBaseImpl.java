...
/**
 * Provides the base implementation for the model discussion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ext.portlet.service.impl.ModelDiscussionLocalServiceImpl}.
 * </p>
 *
...
public abstract class ModelDiscussionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ModelDiscussionLocalService,
        IdentifiableBean {
    ...
    private ModelDiscussionLocalServiceClpInvoker _clpInvoker = new ModelDiscussionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.ext.portlet.service.ModelDiscussionLocalServiceUtil} to access the model discussion local service.
     */
    ...
    public ModelDiscussion addModelDiscussion(ModelDiscussion modelDiscussion)
        ...
        return modelDiscussionPersistence.update(modelDiscussion);
    }
    ...
    @Override
    public ModelDiscussion deleteModelDiscussion(long modelDiscussionId)
        throws PortalException, SystemException {
        return modelDiscussionPersistence.remove(modelDiscussionId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ModelDiscussion deleteModelDiscussion(
        ModelDiscussion modelDiscussion) throws SystemException {
        return modelDiscussionPersistence.remove(modelDiscussion);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ModelDiscussion.class,
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return modelDiscussionPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.ext.portlet.model.ModelDiscussion",
            modelDiscussionLocalService);
    }
