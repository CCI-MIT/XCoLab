...
/**
 * The base implementation of the model discussion local service.
 *
 * <p>
...
public abstract class ModelDiscussionLocalServiceBaseImpl
    implements ModelDiscussionLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ModelDiscussionLocalServiceBaseImpl.class);
    ...
    public ModelDiscussion addModelDiscussion(ModelDiscussion modelDiscussion)
        ...
        modelDiscussion = modelDiscussionPersistence.update(modelDiscussion,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(modelDiscussion);
    ...
    public void deleteModelDiscussion(long modelDiscussionId)
        ...
        if (indexer != null) {
            try {
                indexer.delete(modelDiscussion);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public ModelDiscussion updateModelDiscussion(
        ...
        return updateModelDiscussion(modelDiscussion, true);
    }
