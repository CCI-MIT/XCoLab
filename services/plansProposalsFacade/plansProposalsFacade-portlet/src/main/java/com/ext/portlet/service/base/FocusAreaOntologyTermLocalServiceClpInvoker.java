...
public class FocusAreaOntologyTermLocalServiceClpInvoker {
    ...
    public FocusAreaOntologyTermLocalServiceClpInvoker() {
        ...
        _methodName512 = "findTermsByFocusArea";

        _methodParameterTypes512 = new String[] { "java.lang.Long" };

        _methodName513 = "addAreaTerm";

        _methodParameterTypes513 = new String[] {
                "java.lang.Long", "java.lang.Long"
            };

        _methodName514 = "removeAreaTerm";
        ...
        _methodName516 = "getTerm";

        _methodParameterTypes516 = new String[] {
                "com.ext.portlet.model.FocusAreaOntologyTerm"
            };

        _methodName517 = "getArea";

        _methodParameterTypes517 = new String[] {
                "com.ext.portlet.model.FocusAreaOntologyTerm"
            };

        _methodName518 = "getFocusAreaOntologyTermIdsByFocusAreaAndSpaceId";
