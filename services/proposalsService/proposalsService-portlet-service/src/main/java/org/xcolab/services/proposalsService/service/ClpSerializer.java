...
import org.xcolab.services.proposalsService.model.FooClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "proposalsService-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "proposalsService-portlet";
            }
    ...
    public static Object translateInputFoo(BaseModel<?> oldModel) {
        ...
        try {
            ...
            try {
                Class<?> newModelClass = Class.forName("org.xcolab.services.proposalsService.model.impl.FooImpl",
                        true, _classLoader);
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "org.xcolab.services.proposalsService.model.impl.FooImpl")) {
