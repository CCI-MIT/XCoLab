...
After a careful review, the Judging team has chosen to not advance it to the next round of competition.
...
We welcome you to stay involved in the Climate CoLab community: support and comment on proposals that have been named Semi-Finalists and Finalists, and even volunteer to join one those teams if you have relevant expertise. Voting period will open in a few weeks, where you can help select the contest’s Popular Choice Winner.
...
If there are comments from the Judging team, they will be listed below.
